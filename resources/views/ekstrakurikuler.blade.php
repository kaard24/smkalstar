...
@section('content')
    ...
    <div class="relative bg-gray-900 py-24 overflow-hidden">
        <div class="absolute inset-0 opacity-20">
            <img src="{{ asset('images/b1.jpg') }}" class="w-full h-full object-cover" fetchpriority="high" decoding="async" alt="Header Ekstrakurikuler">
        </div>
        <div class="absolute inset-0 bg-gradient-to-t from-gray-900 via-gray-900/50 to-transparent"></div>
        <div class="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 class="text-4xl md:text-5xl font-bold text-white mb-4 font-heading">Ekstrakurikuler</h1>
            <p class="text-gray-300 text-lg max-w-2xl mx-auto font-light">Wadah pengembangan bakat dan minat siswa di luar jam pelajaran</p>
        </div>
    </div>
             ...
             <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
                 ...
                 <div class="bg-white rounded-3xl shadow-sm border border-gray-100 hover:shadow-2xl transition-all duration-300 p-4 pb-8 text-center group cursor-pointer flex flex-col items-center"
                     ...
                     <div class="w-full h-48 mb-6 overflow-hidden rounded-2xl relative shadow-sm">
                         ...
                         @else
                         <div class="w-full h-full bg-green-50 flex items-center justify-center text-primary group-hover:bg-primary group-hover:text-white transition duration-300">
