...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Header -->
        <div class="mb-8">
            <a href="{{ route('ppdb.profil') }}" class="inline-flex items-center text-sm text-gray-500 hover:text-primary mb-4">
            ...
            <p class="text-gray-600 mt-1">Perbarui data diri dan data orang tua Anda.</p>
        </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" value="{{ $calonSiswa->jk === 'L' ? 'Laki-laki' : 'Perempuan' }}" readonly
                            class="w-full px-4 py-3 border border-gray-200 rounded-xl bg-gray-50 text-gray-500">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" value="{{ $calonSiswa->tgl_lahir?->format('d F Y') ?? '-' }}" readonly
                            class="w-full px-4 py-3 border border-gray-200 rounded-xl bg-gray-50 text-gray-500">
                    </div>
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="pekerjaan" name="pekerjaan" 
                            value="{{ old('pekerjaan', $calonSiswa->orangTua?->pekerjaan) }}" required
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" value="{{ $calonSiswa->pendaftaran->jurusan->nama ?? '-' }}" readonly
                            class="w-full px-4 py-3 border border-gray-200 rounded-xl bg-gray-50 text-gray-500">
                        <p class="mt-1 text-xs text-gray-400">Hubungi admin untuk mengubah jurusan</p>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Gelombang</label>
                        <input type="text" value="{{ $calonSiswa->pendaftaran->gelombang ?? '-' }}" readonly
                            class="w-full px-4 py-3 border border-gray-200 rounded-xl bg-gray-50 text-gray-500">
                    </div>
                </div>
            </div>
