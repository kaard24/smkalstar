        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6">
            ...
            <div class="space-y-4 md:space-y-6">
                ...
                <div class="bg-gradient-to-br from-primary to-green-600 rounded-xl p-4 md:p-5 text-white">
                    ...
                    <a href="https://wa.me/6281234567890" target="_blank" class="inline-flex items-center gap-2 bg-white text-primary px-3 py-2 rounded-lg text-xs font-semibold hover:bg-green-50 transition">
