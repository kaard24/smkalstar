        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-2">
                <div>
                    ...
                    <p class="text-sm text-gray-600">Selamat datang, {{ $siswa->nama ?: 'Calon Siswa' }}!</p>
                </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 md:py-6">
        ...
        <div class="mb-4 md:mb-6 bg-white rounded-xl p-4 shadow-sm border border-gray-100">
            ...
            <div class="w-full bg-gray-200 rounded-full h-2.5">
                <div class="bg-primary h-2.5 rounded-full transition-all duration-500" style="width: {{ $completeness['percentage'] }}%"></div>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6">
            ...
            <div class="lg:col-span-2 space-y-4 md:space-y-6">
                    ...
                    <div class="p-4 md:p-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
                            <div>
                                ...
                                <p class="font-medium text-sm text-gray-900">{{ $siswa->nama ?: '-' }}</p>
                            </div>
                            <div>
                                <p class="text-xs text-gray-500">NISN</p>
                                <p class="font-medium text-sm text-gray-900">{{ $siswa->nisn }}</p>
                            </div>
                            <div>
                                <p class="text-xs text-gray-500">Jenis Kelamin</p>
                                <p class="font-medium text-sm text-gray-900">{{ $siswa->jk === 'L' ? 'Laki-laki' : ($siswa->jk === 'P' ? 'Perempuan' : '-') }}</p>
                            </div>
                            <div>
                                <p class="text-xs text-gray-500">Tanggal Lahir</p>
                                <p class="font-medium text-sm text-gray-900">{{ $siswa->tgl_lahir ? $siswa->tgl_lahir->format('d F Y') : '-' }}</p>
                            </div>
                            <div>
                                <p class="text-xs text-gray-500">No. WhatsApp</p>
                                <p class="font-medium text-sm text-gray-900">{{ $siswa->no_wa ?: '-' }}</p>
                            </div>
                            <div>
                                <p class="text-xs text-gray-500">Asal Sekolah</p>
                                <p class="font-medium text-sm text-gray-900">{{ $siswa->asal_sekolah ?: '-' }}</p>
                            </div>
                            <div class="md:col-span-2">
                                <p class="text-xs text-gray-500">Alamat</p>
                                <p class="font-medium text-sm text-gray-900">{{ $siswa->alamat ?: '-' }}</p>
                            </div>
                            ...
                            <div class="md:col-span-2 pt-2 border-t border-gray-100">
                                ...
                                <p class="font-medium text-sm text-primary">{{ $pendaftaran->jurusan->nama }}</p>
                            </div>
                            @endif
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div class="p-4 md:p-6">
                        <h3 class="font-semibold text-sm md:text-base text-gray-900">{{ $pengumuman->judul }}</h3>
                        <p class="text-xs text-gray-500 mt-1">{{ $pengumuman->created_at->format('d M Y') }}</p>
            ...
            <div class="space-y-4 md:space-y-6">
                    ...
                    <div class="p-4 md:p-6">
                        <div class="space-y-4">
                            ...
                            <div class="flex gap-3">
                                ...
                                <div class="pb-4">
                                    <p class="font-medium text-xs md:text-sm text-gray-900">{{ $item['title'] }}</p>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div class="p-3 md:p-4 space-y-1">
                        <a href="{{ route('ppdb.lengkapi-data') }}" class="flex items-center gap-3 p-2.5 rounded-lg hover:bg-gray-50 transition">
                        ...
                        <a href="{{ route('ppdb.berkas') }}" class="flex items-center gap-3 p-2.5 rounded-lg hover:bg-gray-50 transition">
