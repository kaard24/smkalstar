...
@section('title', 'Upload Berkas - PPDB SMK Al-Hidayah Lestari')
        ...
        @if($progress['is_complete'])
            <div class="mt-6 bg-emerald-50 border border-emerald-200 rounded-xl p-5">
                <div class="flex flex-col sm:flex-row sm:items-center gap-4">
                    ...
                    <a href="{{ route('ppdb.status') }}" class="inline-flex items-center gap-2 px-5 py-2.5 bg-white text-emerald-600 rounded-lg font-medium hover:bg-emerald-100 transition-colors">
                        Lihat Status
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
