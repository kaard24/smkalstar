...
<div class="max-w-6xl mx-auto">
    <div class="flex justify-between items-center mb-8">
        ...
        <a href="{{ route('admin.fasilitas.create') }}" class="btn btn-primary shadow-md hover:shadow-lg">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-100 overflow-hidden group">
            ...
            <div class="p-4">
                ...
                <div class="flex gap-2 mt-3">
                    <a href="{{ route('admin.fasilitas.edit', $item) }}" class="btn btn-sm btn-warning flex-1">
