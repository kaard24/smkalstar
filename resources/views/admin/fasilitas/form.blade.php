...
<div class="max-w-2xl mx-auto">
    <div class="mb-8">
        <a href="{{ route('admin.fasilitas.index') }}" class="inline-flex items-center text-sm text-slate-500 hover:text-[#4276A3] mb-4">
            <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path>
            </svg>
            Kembali
        </a>
        <h1 class="text-2xl font-bold text-slate-800">{{ isset($fasilitas) ? 'Edit Fasilitas' : 'Tambah Fasilitas Baru' }}</h1>
    </div>
    ...
    <form action="{{ isset($fasilitas) ? route('admin.fasilitas.update', $fasilitas) : route('admin.fasilitas.store') }}" 
        ...
        <div class="flex justify-end gap-4">
            <a href="{{ route('admin.fasilitas.index') }}" class="btn btn-secondary btn-lg">
                Batal
            </a>
