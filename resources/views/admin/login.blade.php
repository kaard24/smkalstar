...
<head>
    ...
    <title>Login Panel - SMK Al-Hidayah Lestari</title>
    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
            ...
            <div class="bg-[#334155] px-6 py-6 text-center">
                ...
                <h1 class="text-xl font-semibold text-white">Panel Login</h1>
            ...
            <div class="p-6">
                ...
                <h2 class="text-base font-medium text-slate-800 mb-4 text-center">Masuk ke Akun</h2>
