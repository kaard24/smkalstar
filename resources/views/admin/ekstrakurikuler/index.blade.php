...
<div class="max-w-6xl mx-auto">
    <div class="flex justify-between items-center mb-8">
        <div>
            ...
            <p class="text-gray-600">Kelola data ekstrakurikuler sekolah</p>
        </div>
        <a href="{{ route('admin.ekstrakurikuler.create') }}" class="inline-flex items-center gap-2 px-4 py-2 bg-primary text-white rounded-lg font-medium hover:bg-secondary transition">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden group">
            <div class="relative h-48">
                ...
                <div class="absolute top-2 right-2">
                    @if($item->aktif)
                    <span class="px-2 py-1 bg-blue-500 text-white rounded-full text-xs font-bold">Aktif</span>
                    @else
            ...
            <div class="p-4">
                ...
                <div class="flex gap-2 mt-3">
                    <a href="{{ route('admin.ekstrakurikuler.edit', $item) }}" class="flex-1 text-center px-3 py-2 bg-primary/10 text-primary rounded-lg text-sm font-medium hover:bg-primary/20 transition">
                        Edit
                    </a>
