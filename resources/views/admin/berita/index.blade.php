                    ...
                    <tr>
                        <td>
                            <div class="flex items-center gap-4">
                                ...
                                <img src="{{ $item->gambar_utama }}" alt="{{ $item->judul }}" class="w-16 h-16 object-cover rounded-lg border border-slate-200" loading="lazy" decoding="async">
                                @else
                                ...
                                @endif
                                <div>
                                    <h4 class="font-medium text-slate-800">{{ Str::limit($item->judul, 50) }}</h4>
                                    <p class="text-xs text-slate-500 mt-1">{{ Str::limit(strip_tags($item->isi), 80) }}</p>
                                </div>
                            </div>
                        </td>
