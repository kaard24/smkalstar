...
@section('content')
    <div class="mb-8">
        <h1 class="text-2xl font-bold text-gray-800">Input Nilai Tes Seleksi</h1>
        <p class="text-gray-600">Pilih siswa yang sudah terverifikasi untuk input nilai tes.</p>
    </div>
                ...
                <tr class="hover:bg-gray-50 transition">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        @elseif($item->status_pendaftaran == 'Diverifikasi')
                            <span class="px-2 py-1 bg-yellow-100 text-yellow-700 rounded-full text-xs font-bold">Diverifikasi</span>
                        @else
                            <span class="px-2 py-1 bg-gray-100 text-gray-700 rounded-full text-xs font-bold">{{ $item->status_pendaftaran }}</span>
                        @endif
                    </td>
