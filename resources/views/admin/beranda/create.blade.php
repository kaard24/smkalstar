...
@section('title', 'Tambah Section Beranda - Admin Panel')
        ...
        <form action="{{ route('admin.beranda.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <select id="tipe" name="tipe" required
                        ...
                        <option value="{{ $key }}" {{ old('tipe', request('tipe')) == $key ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
                </div>
            ...
            <div class="mt-4">
                ...
                <textarea id="konten" name="konten" rows="4"
                          ...
                          class="w-full px-3 py-2 text-sm border border-slate-300 rounded-md focus:outline-none focus:border-[#4276A3] focus:ring-1 focus:ring-[#4276A3]">{{ old('konten') }}</textarea>
            </div>
