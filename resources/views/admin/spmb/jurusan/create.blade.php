...
@section('title', 'Tambah Program Keahlian SPMB - Admin Panel')
...
<div class="max-w-4xl mx-auto">
    ...
    {{-- Form --}}
    <form action="{{ route('admin.spmb.jurusan.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        @csrf
            ...
            <div class="grid md:grid-cols-2 gap-4">
                <div>
                    ...
                    <select name="warna_border" class="w-full rounded-lg border-slate-300 focus:border-blue-500 focus:ring-blue-500">
                        <option value="border-blue-900" {{ old('warna_border') == 'border-blue-900' ? 'selected' : '' }}>Biru Tua (Blue-900)</option>
                        <option value="border-green-500" {{ old('warna_border') == 'border-green-500' ? 'selected' : '' }}>Hijau (Green-500)</option>
                        <option value="border-purple-500" {{ old('warna_border') == 'border-purple-500' ? 'selected' : '' }}>Ungu (Purple-500)</option>
                        <option value="border-cyan-500" {{ old('warna_border') == 'border-cyan-500' ? 'selected' : '' }}>Cyan (Cyan-500)</option>
                        <option value="border-orange-500" {{ old('warna_border') == 'border-orange-500' ? 'selected' : '' }}>Oranye (Orange-500)</option>
                        <option value="border-red-500" {{ old('warna_border') == 'border-red-500' ? 'selected' : '' }}>Merah (Red-500)</option>
                    </select>
                </div>
                <div>
                    ...
                    <select name="warna_bg" class="w-full rounded-lg border-slate-300 focus:border-blue-500 focus:ring-blue-500">
                        <option value="bg-blue-50" {{ old('warna_bg') == 'bg-blue-50' ? 'selected' : '' }}>Biru Muda (Blue-50)</option>
                        <option value="bg-green-50" {{ old('warna_bg') == 'bg-green-50' ? 'selected' : '' }}>Hijau Muda (Green-50)</option>
                        <option value="bg-purple-50" {{ old('warna_bg') == 'bg-purple-50' ? 'selected' : '' }}>Ungu Muda (Purple-50)</option>
                        <option value="bg-cyan-50" {{ old('warna_bg') == 'bg-cyan-50' ? 'selected' : '' }}>Cyan Muda (Cyan-50)</option>
                        <option value="bg-orange-50" {{ old('warna_bg') == 'bg-orange-50' ? 'selected' : '' }}>Oranye Muda (Orange-50)</option>
                        <option value="bg-red-50" {{ old('warna_bg') == 'bg-red-50' ? 'selected' : '' }}>Merah Muda (Red-50)</option>
                    </select>
                </div>
                <div>
                    ...
                    <select name="warna_text" class="w-full rounded-lg border-slate-300 focus:border-blue-500 focus:ring-blue-500">
                        <option value="text-blue-900" {{ old('warna_text') == 'text-blue-900' ? 'selected' : '' }}>Biru Tua (Blue-900)</option>
                        <option value="text-green-600" {{ old('warna_text') == 'text-green-600' ? 'selected' : '' }}>Hijau (Green-600)</option>
                        <option value="text-purple-600" {{ old('warna_text') == 'text-purple-600' ? 'selected' : '' }}>Ungu (Purple-600)</option>
                        <option value="text-cyan-600" {{ old('warna_text') == 'text-cyan-600' ? 'selected' : '' }}>Cyan (Cyan-600)</option>
                        <option value="text-orange-600" {{ old('warna_text') == 'text-orange-600' ? 'selected' : '' }}>Oranye (Orange-600)</option>
                        <option value="text-red-600" {{ old('warna_text') == 'text-red-600' ? 'selected' : '' }}>Merah (Red-600)</option>
                    </select>
                </div>
                <div>
                    ...
                    <select name="warna_hover" class="w-full rounded-lg border-slate-300 focus:border-blue-500 focus:ring-blue-500">
                        <option value="group-hover:bg-blue-900" {{ old('warna_hover') == 'group-hover:bg-blue-900' ? 'selected' : '' }}>Biru Tua (Blue-900)</option>
                        <option value="group-hover:bg-green-600" {{ old('warna_hover') == 'group-hover:bg-green-600' ? 'selected' : '' }}>Hijau (Green-600)</option>
                        <option value="group-hover:bg-purple-600" {{ old('warna_hover') == 'group-hover:bg-purple-600' ? 'selected' : '' }}>Ungu (Purple-600)</option>
                        <option value="group-hover:bg-cyan-600" {{ old('warna_hover') == 'group-hover:bg-cyan-600' ? 'selected' : '' }}>Cyan (Cyan-600)</option>
                        <option value="group-hover:bg-orange-600" {{ old('warna_hover') == 'group-hover:bg-orange-600' ? 'selected' : '' }}>Oranye (Orange-600)</option>
                        <option value="group-hover:bg-red-600" {{ old('warna_hover') == 'group-hover:bg-red-600' ? 'selected' : '' }}>Merah (Red-600)</option>
                    </select>
                </div>
            </div>
        </div>
