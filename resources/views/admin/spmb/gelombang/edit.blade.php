...
@section('title', 'Edit Gelombang - Admin Panel')
...
<div class="max-w-3xl mx-auto">
    ...
    <div class="mb-8">
        ...
        <h1 class="text-2xl font-bold text-slate-800">Edit {{ $gelombang->nama }}</h1>
    ...
    <form action="{{ route('admin.spmb.gelombang.update', $gelombang) }}" method="POST" class="space-y-6">
        @csrf
        @method('PUT')
            ...
            <div class="p-6 space-y-4">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" id="nama" name="nama" value="{{ old('nama', $gelombang->nama) }}" required
                    ...
                    <div>
                        ...
                        <input type="number" id="nomor" name="nomor" value="{{ old('nomor', $gelombang->nomor) }}" required min="1"
                ...
                <div>
                    ...
                    <input type="text" id="tahun_ajaran" name="tahun_ajaran" value="{{ old('tahun_ajaran', $gelombang->tahun_ajaran) }}" required
                           class="form-input @error('tahun_ajaran') border-rose-500 @enderror"
                           placeholder="2026/2027">
                </div>
                <div>
                    <label class="flex items-center cursor-pointer">
                        <input type="checkbox" name="aktif" value="1" {{ old('aktif', $gelombang->aktif) ? 'checked' : '' }}
            ...
            <div class="p-6 space-y-4">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="date" id="pendaftaran_start" name="pendaftaran_start" value="{{ old('pendaftaran_start', $gelombang->pendaftaran_start->format('Y-m-d')) }}" required
                    ...
                    <div>
                        ...
                        <input type="date" id="pendaftaran_end" name="pendaftaran_end" value="{{ old('pendaftaran_end', $gelombang->pendaftaran_end->format('Y-m-d')) }}" required
            ...
            <div class="p-6 space-y-4">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="date" id="tes_mulai" name="tes_mulai" value="{{ old('tes_mulai', $gelombang->tes_mulai->format('Y-m-d')) }}" required
                    ...
                    <div>
                        ...
                        <input type="date" id="tes_selesai" name="tes_selesai" value="{{ old('tes_selesai', $gelombang->tes_selesai->format('Y-m-d')) }}" required
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
            ...
            <div class="p-6">
                <div>
                    ...
                    <input type="date" id="pengumuman" name="pengumuman" value="{{ old('pengumuman', $gelombang->pengumuman->format('Y-m-d')) }}" required
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <select id="status" name="status" required class="form-input @error('status') border-rose-500 @enderror">
                            <option value="draft" {{ old('status', $gelombang->status) == 'draft' ? 'selected' : '' }}>Draft</option>
                            <option value="aktif" {{ old('status', $gelombang->status) == 'aktif' ? 'selected' : '' }}>Aktif</option>
                            <option value="selesai" {{ old('status', $gelombang->status) == 'selesai' ? 'selected' : '' }}>Selesai</option>
                        </select>
                    </div>
                    <div>
                        <label for="urutan" class="form-label">Urutan Tampil</label>
                        <input type="number" id="urutan" name="urutan" value="{{ old('urutan', $gelombang->urutan) }}" min="0"
