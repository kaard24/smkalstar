...
@section('title', 'Edit Visi & Misi - Admin Panel')
...
<div class="max-w-4xl mx-auto">
    ...
    <form action="{{ route('admin.profil-sekolah.update-visi-misi') }}" method="POST" class="space-y-6">
        @csrf
        @method('PUT')
        ...
        <div class="flex justify-end gap-4">
            <a href="{{ url('/profil') }}#visi-misi" target="_blank" class="px-6 py-3 border border-gray-300 text-gray-700 rounded-xl font-semibold hover:bg-gray-50 transition">
                Lihat Halaman
            </a>
