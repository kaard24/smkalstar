...
@section('content')
    ...
    <div class="card p-4 sm:p-6 mb-6">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
            <a href="{{ route('admin.pendaftar.index') }}" class="group flex flex-col items-center gap-2 sm:gap-3 p-4 sm:p-5 bg-slate-50 border border-slate-200 rounded-xl hover:border-[#4276A3] hover:shadow-sm transition text-center">
            ...
            <a href="{{ route('admin.fasilitas.index') }}" class="group flex flex-col items-center gap-2 sm:gap-3 p-4 sm:p-5 bg-slate-50 border border-slate-200 rounded-xl hover:border-slate-400 hover:shadow-sm transition text-center">
            ...
            <a href="{{ route('admin.berita.index') }}" class="group flex flex-col items-center gap-2 sm:gap-3 p-4 sm:p-5 bg-slate-50 border border-slate-200 rounded-xl hover:border-slate-400 hover:shadow-sm transition text-center">
                <div class="w-12 h-12 bg-slate-200 rounded-xl flex items-center justify-center group-hover:bg-slate-300 transition">
                    <svg class="w-6 h-6 text-slate-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('admin.profil-sekolah.sejarah') }}" class="group flex flex-col items-center gap-2 sm:gap-3 p-4 sm:p-5 bg-slate-50 border border-slate-200 rounded-xl hover:border-[#4276A3] hover:shadow-sm transition text-center">
                <div class="w-12 h-12 bg-[#4276A3]/10 rounded-xl flex items-center justify-center group-hover:bg-[#4276A3]/20 transition">
                    <svg class="w-6 h-6 text-[#4276A3]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/>
                    </svg>
