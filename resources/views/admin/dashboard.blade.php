...
@section('content')
    ...
    <div class="bg-primary rounded-lg shadow-sm p-6 mb-6 text-white">
        <div class="flex flex-col md:flex-row items-center gap-4 text-center md:text-left">
            ...
            <div>
                ...
                <p class="text-sm text-blue-100 mt-0.5">Kelola data sekolah dengan mudah dan cepat</p>
            </div>
        </div>
    </div>
    ...
    <div class="grid md:grid-cols-4 gap-4 mb-6">
        ...
        {{-- Siap Tes --}}
        <a href="{{ route('admin.pendaftar.index') }}" class="card p-4 hover:border-primary transition border-blue-200">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xl font-bold text-primary">{{ $siapTes }}</p>
                </div>
            </div>
        </a>
    </div>
    ...
    <div class="grid md:grid-cols-2 gap-4">
        ...
        <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
            ...
            <ul class="space-y-1.5 text-xs text-blue-800 list-disc list-inside">
