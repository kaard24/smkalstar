        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
            ...
            <div class="grid md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="kategori" value="{{ old('kategori', $jurusan->kategori) }}" 
                        class="w-full rounded-lg border-slate-300 focus:border-blue-500 focus:ring-blue-500"
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
            ...
            <div>
                <textarea name="peluang_karir" rows="4" 
                    class="w-full rounded-lg border-slate-300 focus:border-blue-500 focus:ring-blue-500"
                    placeholder="Peluang karir (satu per baris)...&#10;Contoh:&#10;Network Engineer&#10;System Administrator&#10;IT Support">{{ old('peluang_karir', is_array($jurusan->peluang_karir) ? implode("\n", $jurusan->peluang_karir) : $jurusan->peluang_karir) }}</textarea>
