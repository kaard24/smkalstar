...
@section('content')
    ...
    <div class="relative bg-gradient-to-br from-blue-50 via-sky-50 to-cyan-50 py-16 md:py-24 border-b border-blue-100 overflow-hidden">
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            ...
            <p class="text-gray-600 text-sm sm:text-base md:text-xl max-w-3xl mx-auto leading-relaxed">Dokumentasi momen-momen berharga dan kegiatan seru di SMK Al-Hidayah Lestari</p>
        </div>
    </div>
    ...
    <section class="py-12 md:py-16 bg-white">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            @else
            <div class="columns-1 sm:columns-2 md:columns-3 lg:columns-4 gap-3 sm:gap-4 space-y-3 sm:space-y-4">
    ...
    <div id="lightbox" class="fixed inset-0 z-50 hidden bg-black/90 flex items-center justify-center p-4" onclick="closeLightbox()">
        ...
        <div class="max-w-5xl max-h-[90vh] flex flex-col items-center" onclick="event.stopPropagation()">
            ...
            <p id="lightbox-caption" class="text-white text-center mt-4 text-sm sm:text-lg"></p>
        </div>
    </div>
