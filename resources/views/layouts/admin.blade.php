    ...
    <header class="bg-[#334155] border-b border-[#475569] sticky top-0 z-50">
            ...
            <div class="flex justify-between items-center h-16">
                ...
                <nav class="hidden lg:flex items-center gap-1">
                    ...
                    <a href="{{ route('admin.hero.index') }}" 
                       class="nav-item flex items-center gap-2 {{ request()->is('admin/hero*') ? 'bg-[#4276A3]/20 text-white border-l-2 border-[#4276A3]' : 'text-slate-300 hover:bg-white/5 hover:text-white' }}">
                        Beranda
                    </a>
        ...
        <div class="hidden lg:hidden bg-[#1E293B] border-t border-[#334155]" id="admin-mobile-menu">
            <div class="px-4 py-3 space-y-1">
                ...
                <a href="{{ route('admin.hero.index') }}" 
                   class="block px-4 py-2 rounded-lg text-sm font-medium {{ request()->is('admin/hero*') ? 'text-white bg-[#4276A3]/20 border-l-2 border-[#4276A3]' : 'text-slate-400 hover:bg-white/5 hover:text-white' }}">
                    Beranda
                </a>
