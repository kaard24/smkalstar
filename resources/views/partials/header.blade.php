        ...
        <div class="flex justify-between items-center h-14 md:h-16">
            ...
            <nav class="hidden md:flex space-x-1 items-center">
                ...
                <div class="pl-2 border-l border-gray-200 flex items-center ml-2">
                    <a href="{{ url('/ppdb/info') }}" class="px-3 py-2 text-primary font-semibold hover:text-secondary transition rounded-md hover:bg-sky-50 text-sm tracking-wide">Info SPMB</a>
                </div>
            </nav>
    ...
    <div class="hidden md:hidden bg-white border-t border-gray-100" id="mobile-menu">
        <div class="px-4 py-3">
            ...
            <div class="grid grid-cols-3 gap-2">
                ...
                <a href="{{ url('/jurusan') }}" class="flex flex-col items-center justify-center p-3 rounded-lg text-xs font-medium {{ request()->is('jurusan') ? 'bg-primary text-white' : 'text-gray-700 hover:bg-gray-50' }}">
                ...
                <a href="{{ url('/ppdb/info') }}" class="flex flex-col items-center justify-center p-3 rounded-lg text-xs font-bold {{ request()->is('ppdb*') ? 'bg-primary text-white' : 'text-primary bg-sky-50' }}">
            ...
            @else
                <div class="border-t border-gray-200 pt-3 mt-3 grid grid-cols-2 gap-2">
                    ...
                    <a href="{{ url('/ppdb/register') }}" class="flex items-center justify-center px-3 py-2 rounded-lg text-xs font-bold text-white bg-primary hover:bg-secondary">
                        Daftar
                    </a>
                </div>
            @endauth
