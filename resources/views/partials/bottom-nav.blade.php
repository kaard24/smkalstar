<div class="fixed bottom-0 left-0 z-50 w-full bg-white border-t border-gray-200 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)] md:hidden safe-area-pb">
    <div class="grid h-16 grid-cols-4 mx-auto font-medium">
        @auth('ppdb')
            {{-- Dashboard --}}
            <a href="{{ route('ppdb.dashboard') }}" class="inline-flex flex-col items-center justify-center px-2 hover:bg-gray-50 group {{ request()->routeIs('ppdb.dashboard') ? 'text-primary' : 'text-gray-500' }}">
            ...
            {{-- Status --}}
            <a href="{{ route('ppdb.status') }}" class="inline-flex flex-col items-center justify-center px-2 hover:bg-gray-50 group {{ request()->routeIs('ppdb.status') ? 'text-primary' : 'text-gray-500' }}">
            ...
            {{-- Berkas --}}
            <a href="{{ route('ppdb.berkas') }}" class="inline-flex flex-col items-center justify-center px-2 hover:bg-gray-50 group {{ request()->routeIs('ppdb.berkas') ? 'text-primary' : 'text-gray-500' }}">
            ...
            {{-- Profil --}}
            <a href="{{ route('ppdb.profil') }}" class="inline-flex flex-col items-center justify-center px-2 hover:bg-gray-50 group {{ request()->routeIs('ppdb.profil') ? 'text-primary' : 'text-gray-500' }}">
        ...
        @else
            {{-- Home --}}
            <a href="{{ url('/') }}" class="inline-flex flex-col items-center justify-center px-2 hover:bg-gray-50 group {{ request()->is('/') ? 'text-primary' : 'text-gray-500' }}">
            ...
            {{-- Jurusan --}}
            <a href="{{ url('/jurusan') }}" class="inline-flex flex-col items-center justify-center px-2 hover:bg-gray-50 group {{ request()->is('jurusan') ? 'text-primary' : 'text-gray-500' }}">
            ...
            {{-- Info PPDB --}}
            <a href="{{ url('/ppdb/info') }}" class="inline-flex flex-col items-center justify-center px-2 hover:bg-gray-50 group {{ request()->is('ppdb/info') ? 'text-primary' : 'text-gray-500' }}">
            ...
            {{-- Login/Daftar --}}
            <a href="{{ url('/login') }}" class="inline-flex flex-col items-center justify-center px-2 hover:bg-gray-50 group {{ request()->is('login') ? 'text-primary' : 'text-gray-500' }}">
