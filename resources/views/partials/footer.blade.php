        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
                <div class="flex items-center gap-2 mb-4">
                    <img class="h-8 w-8 rounded-full object-cover" src="{{ asset('images/logo.webp') }}" alt="Logo SMK Al-Hidayah Lestari" loading="lazy" decoding="async">
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm text-gray-400">
                    ...
                    <li class="flex items-start">
                        ...
                        <a href="https://wa.me/628812489572" target="_blank" class="hover:text-green-400 transition">Chat Pak Kaffa (WA)</a>
                    </li>
                </ul>
            </div>
        </div>
