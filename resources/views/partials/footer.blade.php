...
<img class="h-10 w-auto" src="{{ asset('images/logo.jpg') }}" alt="Logo SMK Al-Hidayah Lestari">
                    <span class="font-bold text-xl tracking-tight">SMK Al-Hidayah Lestari</span>
                </div>
                ...
                <div class="flex space-x-4">
                    ...
                    <a href="https://www.tiktok.com/@smkalstar?is_from_webapp=1&sender_device=pc" target="_blank" class="text-gray-400 hover:text-white transition">
                    ...
                    <a href="https://youtube.com/@smkal-hidayahlestari5604?si=mMMVyYtHKNom0jcT" target="_blank" class="text-gray-400 hover:text-red-600 transition">
                ...
                <ul class="space-y-3 text-sm text-gray-400">
                    <li class="flex items-start">
                        ...
                        <a href="https://maps.app.goo.gl/AWMEJJrR6kJmquZD7" target="_blank" class="hover:text-primary transition">
                            JL. KANA LESTARI BLOK K/I, RT.11/RW.7, Lb. Bulus, Kec. Cilandak, Kota Jakarta Selatan, Daerah Khusus Ibukota Jakarta 12440
                        </a>
                    </li>
                    ...
                    <li class="flex items-center">
                        ...
                        <span>info@smkalstar.sch.id</span>
                    </li>
                    <li class="flex items-center">
                        ...
                        <a href="https://wa.me/62812345678" target="_blank" class="hover:text-green-400 transition">Chat via WhatsApp</a>
                    </li>
                </ul>
            </div>
        </div>
