...
@section('content')
    ...
    <div class="relative bg-gray-900 py-24 overflow-hidden">
        ...
        <div class="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 class="text-4xl md:text-5xl font-bold text-white mb-4 font-heading">Kompetensi Keahlian</h1>
            <p class="text-gray-300 text-lg max-w-2xl mx-auto font-light">Pilihlah jurusan masa depan sesuai dengan minat dan bakatmu</p>
        </div>
    </div>
