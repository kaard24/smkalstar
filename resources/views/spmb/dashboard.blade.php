        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-xl border border-slate-200 overflow-hidden">
                    ...
                    <div class="p-2">
                        <a href="{{ $completeness['biodata'] ? route('spmb.profil.edit') : route('spmb.lengkapi-data') }}" class="flex items-center gap-3 p-3 rounded-lg hover:bg-slate-50 transition-colors group">
                            ...
                            <div class="flex-1 min-w-0">
                                <p class="text-sm font-medium text-slate-800">{{ $completeness['biodata'] ? 'Edit Profil' : 'Lengkapi Data' }}</p>
                                <p class="text-xs text-slate-500">{{ $completeness['biodata'] ? 'Perbarui biodata' : 'Isi biodata lengkap' }}</p>
                            </div>
                        </a>
