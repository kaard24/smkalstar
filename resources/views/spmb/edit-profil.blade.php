                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" id="nik" name="nik" maxlength="16" value="{{ old('nik', $calonSiswa->nik) }}" required
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" id="no_kk" name="no_kk" maxlength="16" value="{{ old('no_kk', $calonSiswa->no_kk) }}" required
