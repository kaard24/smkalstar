...
<?php $__env->startSection('title', 'SPMB - Admin Panel'); ?>
...
<div class="max-w-6xl mx-auto">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-4">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xl font-bold text-slate-800"><?php echo e($heroAktif); ?>/<?php echo e($totalHero); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-4">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xl font-bold text-slate-800"><?php echo e($jurusanAktif); ?>/<?php echo e($totalJurusan); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-4">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xl font-bold text-slate-800"><?php echo e($gelombangAktif); ?>/<?php echo e($totalGelombang); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-4">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-lg font-bold text-slate-800"><?php echo e($gelombang->first()?->tahun_ajaran ?? '-'); ?></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <a href="<?php echo e(route('admin.spmb.hero.index')); ?>" class="group bg-white rounded-xl shadow-sm border border-slate-200 p-6 hover:shadow-md transition-all hover:-translate-y-1">
        ...
        <a href="<?php echo e(route('admin.spmb.jurusan.index')); ?>" class="group bg-white rounded-xl shadow-sm border border-slate-200 p-6 hover:shadow-md transition-all hover:-translate-y-1">
            <div class="flex items-start justify-between mb-4">
        ...
        <a href="<?php echo e(route('admin.spmb.gelombang.index')); ?>" class="group bg-white rounded-xl shadow-sm border border-slate-200 p-6 hover:shadow-md transition-all hover:-translate-y-1">
            <div class="flex items-start justify-between mb-4">
        ...
        <a href="<?php echo e(route('admin.spmb.alur.index')); ?>" class="group bg-white rounded-xl shadow-sm border border-slate-200 p-6 hover:shadow-md transition-all hover:-translate-y-1">
            <div class="flex items-start justify-between mb-4">
        ...
        <a href="<?php echo e(route('admin.spmb.persyaratan.index')); ?>" class="group bg-white rounded-xl shadow-sm border border-slate-200 p-6 hover:shadow-md transition-all hover:-translate-y-1">
            <div class="flex items-start justify-between mb-4">
        ...
        <a href="<?php echo e(route('admin.spmb.biaya.index')); ?>" class="group bg-white rounded-xl shadow-sm border border-slate-200 p-6 hover:shadow-md transition-all hover:-translate-y-1">
            <div class="flex items-start justify-between mb-4">
        ...
        <a href="<?php echo e(route('admin.spmb.kontak.index')); ?>" class="group bg-white rounded-xl shadow-sm border border-slate-200 p-6 hover:shadow-md transition-all hover:-translate-y-1">
            <div class="flex items-start justify-between mb-4">
    ...
    <div class="grid lg:grid-cols-2 gap-8">
        ...
        <?php if($jurusan->isNotEmpty()): ?>
        <div>
            <div class="flex items-center justify-between mb-4">
                <h2 class="text-lg font-bold text-slate-800">Program Keahlian</h2>
                <a href="<?php echo e(route('admin.spmb.jurusan.index')); ?>" class="text-sm text-blue-600 hover:text-blue-700">Lihat Semua</a>
            </div>
            <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
                <div class="grid grid-cols-2 gap-4 p-4">
                    <?php $__currentLoopData = $jurusan->where('aktif', true)->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $j): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="flex items-center gap-3 p-3 rounded-lg border <?php echo e($j->warna_border); ?> bg-gray-50">
                        <div class="w-10 h-10 rounded-lg <?php echo e($j->warna_bg); ?> flex items-center justify-center flex-shrink-0">
                            <img src="<?php echo e($j->logo_url); ?>" alt="<?php echo e($j->nama); ?>" class="w-6 h-6 object-contain">
                        </div>
                        <div class="min-w-0">
                            <p class="text-xs font-bold text-slate-500"><?php echo e($j->kode); ?></p>
                            <p class="text-sm font-medium text-slate-800 truncate"><?php echo e($j->nama); ?></p>
                        </div>
                    </div>
        ...
        <?php if($gelombang->isNotEmpty()): ?>
        <div>
            <div class="flex items-center justify-between mb-4">
                <h2 class="text-lg font-bold text-slate-800">Gelombang Aktif</h2>
                <a href="<?php echo e(route('admin.spmb.gelombang.index')); ?>" class="text-sm text-blue-600 hover:text-blue-700">Lihat Semua</a>
            </div>
            <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
                <div class="divide-y divide-slate-100">
                    <?php $__currentLoopData = $gelombang->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="p-4 flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            <div class="w-10 h-10 rounded-xl <?php echo e($g->is_aktif ? 'bg-blue-100 text-blue-600' : 'bg-slate-100 text-slate-500'); ?> flex items-center justify-center font-bold text-sm">
                                <?php echo e($g->nomor); ?>

                            </div>
                            <div>
                                <p class="font-medium text-slate-800"><?php echo e($g->nama); ?></p>
                                <p class="text-xs text-slate-500"><?php echo e($g->tahun_ajaran); ?></p>
                            </div>
                        </div>
                        <?php
                            $colors = $g->status_color;
                        ?>
                        <span class="badge <?php echo e($colors['bg']); ?> <?php echo e($colors['text']); ?> text-xs">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\eka\.gemini\antigravity\scratch\smk-alstar\resources\views\admin\spmb\index.blade.php ENDPATH**/ ?>