                    ...
                    <div class="p-6">
                        <div class="grid md:grid-cols-2 gap-6">
                            <div class="space-y-1">
                                ...
                                <p class="font-bold text-primary text-base sm:text-lg"><?php echo e($calonSiswa->pendaftaran->jurusan->nama ?? '-'); ?></p>
                            </div>
                            <div class="space-y-1">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\eka\.gemini\antigravity\scratch\smk-alstar\resources\views/spmb/profil.blade.php ENDPATH**/ ?>