        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            ...
            <form action="<?php echo e(route('berita.index')); ?>" method="GET" class="mt-8 max-w-2xl mx-auto">
                <div class="relative flex flex-col sm:block">
                    ...
                    <button type="submit" 
                            class="mt-2 sm:mt-0 sm:absolute sm:right-2 sm:top-1/2 sm:-translate-y-1/2 bg-gradient-to-r from-cyan-500 to-blue-600 text-white px-5 sm:px-6 py-2.5 rounded-full font-medium hover:shadow-lg hover:scale-105 transition duration-200">
                        Cari
                    </button>
                </div>
