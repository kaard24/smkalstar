...
<?php $__env->startSection('title', isset($ekstrakurikuler) ? 'Edit Ekstrakurikuler' : 'Tambah Ekstrakurikuler' . ' - Admin Panel'); ?>

<?php $__env->startSection('content'); ?>
<div class="max-w-2xl mx-auto">
    <div class="mb-8">
        <a href="<?php echo e(route('admin.ekstrakurikuler.index')); ?>" class="inline-flex items-center text-sm text-slate-500 hover:text-[#4276A3] mb-4">
            <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path>
            </svg>
            Kembali
        </a>
        <h1 class="text-2xl font-bold text-slate-800"><?php echo e(isset($ekstrakurikuler) ? 'Edit Ekstrakurikuler' : 'Tambah Ekstrakurikuler Baru'); ?></h1>
    </div>
    ...
    <form action="<?php echo e(isset($ekstrakurikuler) ? route('admin.ekstrakurikuler.update', $ekstrakurikuler) : route('admin.ekstrakurikuler.store')); ?>" 
          method="POST" enctype="multipart/form-data" class="space-y-6">
        <?php echo csrf_field(); ?>
        <?php if(isset($ekstrakurikuler)): ?>
            <?php echo method_field('PUT'); ?>
        <?php endif; ?>

        <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
            <div class="px-6 py-4 border-b border-slate-200 bg-slate-50">
                <h2 class="font-semibold text-slate-800">Informasi Ekstrakurikuler</h2>
            </div>
            <div class="p-6 space-y-6">
                <div>
                    <label for="nama" class="block text-sm font-medium text-slate-700 mb-2">Nama Ekstrakurikuler <span class="text-[#991B1B]">*</span></label>
                    <input type="text" id="nama" name="nama" value="<?php echo e(old('nama', $ekstrakurikuler->nama ?? '')); ?>" required
                        class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-[#4276A3] focus:border-[#4276A3] transition"
                        placeholder="Contoh: Pramuka, Futsal, Band">
                </div>
                ...
                <div>
                    ...
                    <textarea id="deskripsi" name="deskripsi" rows="3"
                        ...
                        placeholder="Deskripsi singkat mengenai ekstrakurikuler ini"><?php echo e(old('deskripsi', $ekstrakurikuler->deskripsi ?? '')); ?></textarea>
                </div>

                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Galeri Gambar Ekstrakurikuler</label>
                    <?php if(isset($ekstrakurikuler) && !empty($ekstrakurikuler->gambar_urls)): ?>
                    <div class="grid grid-cols-2 md:grid-cols-3 gap-4 mb-4">
                        <?php $__currentLoopData = $ekstrakurikuler->gambar_urls; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="relative group" id="gambar-<?php echo e($index); ?>">
                            <img src="<?php echo e($url); ?>" alt="<?php echo e($ekstrakurikuler->nama); ?> <?php echo e($index + 1); ?>" class="w-full h-32 object-cover rounded-lg border" loading="lazy" decoding="async">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="number" id="urutan" name="urutan" value="<?php echo e(old('urutan', $ekstrakurikuler->urutan ?? 0)); ?>"
                            class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-primary focus:border-primary transition">
                    </div>
                    <div class="flex items-center pt-8">
                        <label class="flex items-center cursor-pointer">
                            <input type="checkbox" name="aktif" value="1" <?php echo e(old('aktif', $ekstrakurikuler->aktif ?? true) ? 'checked' : ''); ?>
        ...
        <div class="flex justify-end gap-4">
            <a href="<?php echo e(route('admin.ekstrakurikuler.index')); ?>" class="btn btn-secondary btn-lg">
                Batal
            </a>
            <button type="submit" class="btn btn-primary btn-lg shadow-sm hover:shadow-md">
                ...
                <?php echo e(isset($ekstrakurikuler) ? 'Simpan Perubahan' : 'Tambah Ekstrakurikuler'); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\eka\.gemini\antigravity\scratch\smk-alstar\resources\views/admin/ekstrakurikuler/form.blade.php ENDPATH**/ ?>