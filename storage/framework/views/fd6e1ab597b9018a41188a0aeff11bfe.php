<div class="info-program-item flex gap-3">
    <div class="flex-1">
        <input type="text" name="info_label[]" value="<?php echo e($label); ?>" 
    ...
    <div class="flex-1">
        <input type="text" name="info_value[]" value="<?php echo e($value); ?>" 
            class="w-full rounded-lg border-slate-300 focus:border-orange-500 focus:ring-orange-500 text-sm"
...
<?php /**PATH C:\Users\eka\.gemini\antigravity\scratch\smk-alstar\resources\views\kajur\jurusan\partials\info-item.blade.php ENDPATH**/ ?>