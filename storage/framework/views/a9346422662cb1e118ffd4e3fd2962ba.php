...
<div class="max-w-6xl mx-auto">
    <div class="flex justify-between items-center mb-8">
        <div>
            ...
            <p class="text-slate-600">Kelola data fasilitas sekolah</p>
        </div>
        <a href="<?php echo e(route('admin.fasilitas.create')); ?>" class="btn btn-primary shadow-md hover:shadow-lg">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-100 overflow-hidden group">
            ...
            <div class="p-4">
                ...
                <div class="flex gap-2 mt-3">
                    <a href="<?php echo e(route('admin.fasilitas.edit', $item)); ?>" class="btn btn-sm btn-warning flex-1">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\eka\.gemini\antigravity\scratch\smk-alstar\resources\views/admin/fasilitas/index.blade.php ENDPATH**/ ?>