        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
                            ...
                            <?php 
                                ...
                                $itemUrl = match($item['key']) {
                                    'biodata' => $completeness['biodata'] ? route('spmb.profil.edit') : route('spmb.lengkapi-data'),
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-xl border border-slate-200 overflow-hidden">
                    ...
                    <div class="p-2">
                        <a href="<?php echo e($completeness['biodata'] ? route('spmb.profil.edit') : route('spmb.lengkapi-data')); ?>" class="flex items-center gap-3 p-3 rounded-lg hover:bg-slate-50 transition-colors group">
                            ...
                            <div class="flex-1 min-w-0">
                                <p class="text-sm font-medium text-slate-800"><?php echo e($completeness['biodata'] ? 'Edit Profil' : 'Lengkapi Data'); ?></p>
                                <p class="text-xs text-slate-500"><?php echo e($completeness['biodata'] ? 'Perbarui biodata' : 'Isi biodata lengkap'); ?></p>
                            </div>
                        </a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\eka\.gemini\antigravity\scratch\smk-alstar\resources\views\spmb\dashboard.blade.php ENDPATH**/ ?>