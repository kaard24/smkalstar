...
<?php $__env->startSection('title', 'Status Pendaftaran - PPDB SMK Al-Hidayah Lestari'); ?>
            ...
            <div class="relative">
                ...
                <div class="space-y-4">
                    ...
                    <div class="relative flex gap-4">
                        ...
                        <div class="flex-1 pt-1">
                            <div class="flex items-center justify-between mb-1">
                                <h4 class="font-medium <?php echo e($biodataComplete ? 'text-slate-800' : 'text-slate-600'); ?>">Data Diri</h4>
                                <?php if($biodataComplete): ?>
                                    <span class="text-xs text-blue-600 bg-blue-50 px-2 py-0.5 rounded">Lengkap</span>
                                <?php else: ?>
                                    <a href="<?php echo e(route('ppdb.lengkapi-data')); ?>" class="text-xs text-white bg-blue-500 hover:bg-blue-600 px-3 py-1 rounded transition-colors">Lengkapi</a>
                                <?php endif; ?>
                            </div>
                            <p class="text-sm text-slate-500"><?php echo e($biodataComplete ? 'Data diri sudah lengkap' : 'Silakan lengkapi data diri'); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="relative flex gap-4">
                        ...
                        <div class="flex-1 pt-1">
                            ...
                            <p class="text-sm text-slate-500"><?php echo e($orangTuaComplete ? 'Data sudah lengkap' : 'Silakan lengkapi data'); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="relative flex gap-4">
                        ...
                        <div class="flex-1 pt-1">
                            <div class="flex items-center justify-between mb-1">
                                <h4 class="font-medium <?php echo e($jurusanComplete ? 'text-slate-800' : 'text-slate-600'); ?>">Pilihan Jurusan</h4>
                                <?php if($jurusanComplete): ?>
                                    <span class="text-xs text-blue-600 bg-blue-50 px-2 py-0.5 rounded">Terpilih</span>
                                <?php else: ?>
                                    <a href="<?php echo e(route('ppdb.lengkapi-data')); ?>" class="text-xs text-white bg-blue-500 hover:bg-blue-600 px-3 py-1 rounded transition-colors">Pilih</a>
                                <?php endif; ?>
                            </div>
                    ...
                    <div class="relative flex gap-4">
                        ...
                        <div class="flex-1 pt-1">
                            <div class="flex items-center justify-between mb-1">
                                <h4 class="font-medium <?php echo e($progress['is_complete'] ? 'text-slate-800' : 'text-slate-600'); ?>">Upload Berkas</h4>
                                <a href="<?php echo e(route('ppdb.berkas')); ?>" class="text-xs <?php echo e($progress['is_complete'] ? 'text-blue-600 bg-blue-50' : 'text-white bg-blue-500 hover:bg-blue-600'); ?> px-3 py-1 rounded transition-colors">
                                    <?php echo e($progress['is_complete'] ? 'Kelola' : ($progress['uploaded'] > 0 ? 'Lanjut' : 'Upload')); ?>

                                </a>
                            </div>
                            <p class="text-sm text-slate-500 mb-2"><?php echo e($progress['is_complete'] ? 'Semua berkas lengkap' : 'Upload dokumen yang diperlukan'); ?></p>
                            <div class="w-full bg-slate-100 rounded-full h-1.5">
                                <div class="bg-blue-500 h-1.5 rounded-full transition-all" style="width: <?php echo e(($progress['uploaded'] / $progress['total']) * 100); ?>%"></div>
                            </div>
                            <p class="text-xs text-slate-400 mt-1"><?php echo e($progress['uploaded']); ?> dari <?php echo e($progress['total']); ?> dokumen</p>
                        </div>
                    </div>
        ...
        <?php if($kelulusanStatus === 'Lulus' && $progress['is_complete']): ?>
            ...
            <div class="mt-6 bg-emerald-50 border border-emerald-200 rounded-xl p-5">
                <div class="flex flex-col sm:flex-row sm:items-center gap-4">
                    ...
                    <a href="<?php echo e(route('ppdb.pengumuman')); ?>" class="inline-flex items-center gap-2 px-5 py-2.5 bg-emerald-500 text-white rounded-lg font-medium hover:bg-emerald-600 transition-colors">
                        Lihat Pengumuman
        ...
        <?php elseif($kelulusanStatus === 'Lulus' && !$progress['is_complete']): ?>
            ...
            <div class="mt-6 bg-emerald-50 border border-emerald-200 rounded-xl p-5">
                <div class="flex flex-col sm:flex-row sm:items-center gap-4">
                    ...
                    <a href="<?php echo e(route('ppdb.berkas')); ?>" class="inline-flex items-center gap-2 px-5 py-2.5 bg-emerald-500 text-white rounded-lg font-medium hover:bg-emerald-600 transition-colors">
                        Lengkapi Berkas
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"/>
                        </svg>
        ...
        <?php elseif(!$progress['is_complete']): ?>
            ...
            <div class="mt-6 bg-amber-50 border border-amber-200 rounded-xl p-5">
                <div class="flex flex-col sm:flex-row sm:items-center gap-4">
                    ...
                    <a href="<?php echo e(route('ppdb.berkas')); ?>" class="inline-flex items-center gap-2 px-5 py-2.5 bg-amber-500 text-white rounded-lg font-medium hover:bg-amber-600 transition-colors">
                        Upload Berkas
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"/>
                        </svg>
        ...
        <?php elseif($overallProgress < 50): ?>
            <div class="mt-6 bg-slate-50 border border-slate-200 rounded-xl p-5">
                <div class="flex flex-col sm:flex-row sm:items-center gap-4">
                    ...
                    <a href="<?php echo e(route('ppdb.lengkapi-data')); ?>" class="inline-flex items-center gap-2 px-5 py-2.5 bg-blue-500 text-white rounded-lg font-medium hover:bg-blue-600 transition-colors">
                        Mulai
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
