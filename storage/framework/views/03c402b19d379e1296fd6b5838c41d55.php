            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="max-w-xl">
                    ...
                    <div class="lg:hidden mb-6">
                        <img src="<?php echo e(asset($hero->hero_image)); ?>" alt="SMK Al-Hidayah" class="w-full h-auto">
                    </div>
                    ...
                    <div class="flex flex-wrap gap-4">
                        <a href="<?php echo e(url($hero->button_primary_url)); ?>" class="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold px-8 py-4 rounded-xl transition-all shadow-lg hover:shadow-xl hover:-translate-y-0.5">
                            <?php echo e($hero->button_primary_text); ?>

                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"/></svg>
                        </a>
                        <a href="<?php echo e(url($hero->button_secondary_url)); ?>" class="inline-flex items-center gap-2 bg-white hover:bg-gray-50 text-slate-700 font-semibold px-8 py-4 rounded-xl border border-gray-200 transition-all">
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <a href="<?php echo e(url('/jurusan/' . strtolower($j['kode']))); ?>" class="group bg-white border border-gray-100 rounded-2xl p-6 hover:shadow-xl transition-all hover:-translate-y-1">
                    <div class="w-full aspect-square <?php echo e($j['bg']); ?> rounded-xl flex items-center justify-center mb-6 overflow-hidden">
                        <img src="<?php echo e(asset('images/logo/' . $logoFile)); ?>" alt="<?php echo e($j['kode']); ?>" class="w-3/4 h-3/4 object-contain group-hover:scale-110 transition-transform duration-300">
                    </div>
