            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="max-w-xl">
                    ...
                    <h1 class="text-4xl sm:text-5xl lg:text-6xl font-bold text-slate-900 leading-tight mb-6">
                        Mencetak Generasi 
                        <span class="text-blue-600">Unggul</span> & 
                        <span class="text-cyan-600">Berakhlak</span>
                    </h1>
                    
                    <p class="text-lg text-slate-600 mb-8 leading-relaxed">
                        SMK Al-Hidayah Lestari berkomitmen memberikan pendidikan berkualitas yang menggabungkan kompetensi keahlian dengan nilai-nilai keislaman.
                    </p>
