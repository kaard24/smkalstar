...
<?php $__env->startSection('title', 'Tambah Hero Section - Admin Panel'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <form action="<?php echo e(route('admin.hero.store')); ?>" method="POST" enctype="multipart/form-data" class="max-w-4xl">
        <?php echo csrf_field(); ?>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="space-y-4">
                ...
                <div class="bg-white rounded-xl border border-slate-200 p-4">
                    ...
                    <input type="text" name="badge_text" value="<?php echo e(old('badge_text', 'Pendaftaran 2026/2027 Dibuka')); ?>" required
                ...
                <div class="bg-white rounded-xl border border-slate-200 p-4 space-y-3">
                    ...
                    <div>
                        ...
                        <input type="text" name="title_line1" value="<?php echo e(old('title_line1', 'SPMB 2026/2027')); ?>" required
                               class="w-full px-3 py-2 text-sm border border-slate-300 rounded-md focus:outline-none focus:border-[#4276A3] focus:ring-1 focus:ring-[#4276A3]">
                    </div>
                    
                    <div>
                        <label class="block text-xs font-medium text-slate-600 mb-1">Highlight <span class="text-[#991B1B]">*</span></label>
                        <input type="text" name="title_highlight" value="<?php echo e(old('title_highlight', 'Telah')); ?>" required
                               class="w-full px-3 py-2 text-sm border border-slate-300 rounded-md focus:outline-none focus:border-[#4276A3] focus:ring-1 focus:ring-[#4276A3]">
                    ...
                    <div>
                        ...
                        <input type="text" name="title_line2" value="<?php echo e(old('title_line2', 'Dibuka!')); ?>" required
                               class="w-full px-3 py-2 text-sm border border-slate-300 rounded-md focus:outline-none focus:border-[#4276A3] focus:ring-1 focus:ring-[#4276A3]">
                ...
                <div class="bg-white rounded-xl border border-slate-200 p-4">
                    ...
                    <textarea name="description" rows="3" required
                              class="w-full px-3 py-2 text-sm border border-slate-300 rounded-md focus:outline-none focus:border-[#4276A3] focus:ring-1 focus:ring-[#4276A3]"><?php echo e(old('description', 'Daftarkan diri Anda sekarang dan jadilah bagian dari generasi unggul dan berakhlak di SMK Al-Hidayah Lestari.')); ?></textarea>
                </div>
            </div>
                ...
                <div class="bg-white rounded-xl border border-slate-200 p-4 space-y-3">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 gap-2">
                            <input type="text" name="button_primary_text" value="<?php echo e(old('button_primary_text', 'Daftar Sekarang')); ?>" required placeholder="Teks"
                                   class="w-full px-3 py-2 text-sm border border-slate-300 rounded-md focus:outline-none focus:border-[#4276A3] focus:ring-1 focus:ring-[#4276A3]">
                            <input type="text" name="button_primary_url" value="<?php echo e(old('button_primary_url', '/spmb/register')); ?>" required placeholder="URL"
                                   class="w-full px-3 py-2 text-sm border border-slate-300 rounded-md focus:outline-none focus:border-[#4276A3] focus:ring-1 focus:ring-[#4276A3]">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 gap-2">
                            <input type="text" name="button_secondary_text" value="<?php echo e(old('button_secondary_text', 'Info Lebih Lanjut')); ?>" required placeholder="Teks"
                                   class="w-full px-3 py-2 text-sm border border-slate-300 rounded-md focus:outline-none focus:border-[#4276A3] focus:ring-1 focus:ring-[#4276A3]">
                            <input type="text" name="button_secondary_url" value="<?php echo e(old('button_secondary_url', '/spmb/info')); ?>" required placeholder="URL"
                                   class="w-full px-3 py-2 text-sm border border-slate-300 rounded-md focus:outline-none focus:border-[#4276A3] focus:ring-1 focus:ring-[#4276A3]">
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\eka\.gemini\antigravity\scratch\smk-alstar\resources\views\admin\hero\create.blade.php ENDPATH**/ ?>