                ...
                <div class="lg:col-span-1 space-y-8">
                    ...
                    <div class="bg-gradient-to-br from-[#0EA5E9] to-[#1E3A5F] text-white rounded-3xl p-8 shadow-xl relative overflow-hidden group">
                        ...
                        <div class="space-y-4 mb-8 relative z-10">
                         ...
                         <a href="<?php echo e(url('/ppdb/register')); ?>" class="block w-full text-center bg-[#F97316] text-white font-bold py-4 rounded-xl hover:bg-orange-600 transition shadow-lg relative z-10 hover:shadow-xl transform group-hover:-translate-y-1 duration-300">
                            Daftar Sekarang
                        </a>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\eka\.gemini\antigravity\scratch\smk-alstar\resources\views/ppdb/info.blade.php ENDPATH**/ ?>