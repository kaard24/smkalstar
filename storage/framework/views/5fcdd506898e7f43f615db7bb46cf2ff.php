...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <form action="<?php echo e(route('ppdb.lengkapi-data.store')); ?>" method="POST" class="space-y-6">
            <?php echo csrf_field(); ?>
            
            <!-- Data Diri - Read Only (sudah diisi saat registrasi) -->
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-100 bg-sky-50">
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" value="<?php echo e($siswa->nisn); ?>" readonly
                    ...
                    <div>
                        ...
                        <input type="text" value="<?php echo e($siswa->nama); ?>" readonly
                            class="w-full px-4 py-3 border border-gray-200 rounded-xl bg-gray-50 text-gray-500">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" value="<?php echo e($siswa->tempat_lahir); ?>" readonly
                            class="w-full px-4 py-3 border border-gray-200 rounded-xl bg-gray-50 text-gray-500">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" value="<?php echo e($siswa->tgl_lahir?->format('d/m/Y')); ?>" readonly
                            class="w-full px-4 py-3 border border-gray-200 rounded-xl bg-gray-50 text-gray-500">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" value="<?php echo e($siswa->asal_sekolah); ?>" readonly
                            class="w-full px-4 py-3 border border-gray-200 rounded-xl bg-gray-50 text-gray-500">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" value="<?php echo e($siswa->no_wa); ?>" readonly
                            class="w-full px-4 py-3 border border-gray-200 rounded-xl bg-gray-50 text-gray-500">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" value="<?php echo e($siswa->pendaftaran?->jurusan?->nama ?? 'Belum dipilih'); ?>" readonly
                            class="w-full px-4 py-3 border border-gray-200 rounded-xl bg-gray-50 text-gray-500">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" value="<?php echo e($siswa->pendaftaran?->gelombang ?? 'Gelombang 1'); ?>" readonly
                            class="w-full px-4 py-3 border border-gray-200 rounded-xl bg-gray-50 text-gray-500">
                    </div>
                </div>
            </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" id="nik_ayah" name="nik_ayah" maxlength="16"
                                ...
                                placeholder="Masukkan 16 digit NIK"
                                class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-primary focus:border-primary transition <?php $__errorArgs = ['nik_ayah'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" id="nik_ibu" name="nik_ibu" maxlength="16"
                                ...
                                placeholder="Masukkan 16 digit NIK"
                                class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-primary focus:border-primary transition <?php $__errorArgs = ['nik_ibu'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" id="pekerjaan" name="pekerjaan" 
                                value="<?php echo e(old('pekerjaan', $siswa->orangTua?->pekerjaan)); ?>"
                                placeholder="Contoh: Wiraswasta, PNS, Petani"
                                class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-primary focus:border-primary transition <?php $__errorArgs = ['pekerjaan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="flex justify-end gap-4">
                <a href="<?php echo e(route('ppdb.dashboard')); ?>" 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\eka\.gemini\antigravity\scratch\smk-alstar\resources\views/ppdb/lengkapi-data.blade.php ENDPATH**/ ?>