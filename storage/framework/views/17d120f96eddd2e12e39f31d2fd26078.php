...
<?php $__env->startSection('title', 'Persyaratan SPMB - Admin Panel'); ?>
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-8 mb-8">
        ...
        <div class="bg-slate-50 rounded-2xl border border-slate-100 p-6">
            <ul class="space-y-4">
                <?php $__empty_1 = true; $__currentLoopData = $persyaratan->where('aktif', true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <li class="flex items-start gap-3">
                    <svg class="w-6 h-6 text-[#0EA5E9] flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
                    </svg>
                    <div>
                        <span class="text-slate-700 font-medium"><?php echo e($item->nama); ?></span>
                        <?php if($item->wajib): ?>
                        ...
                        <p class="text-sm text-slate-500 mt-1"><?php echo e($item->keterangan); ?></p>
                        <?php endif; ?>
                    </div>
                </li>
            ...
            <table class="data-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-sm text-slate-600 max-w-xs truncate"><?php echo e($item->keterangan ?? '-'); ?></td>
                        <td>
                            <?php if($item->wajib): ?>
                        ...
                        <td>
                            <div class="flex gap-1">
                                <button onclick="editPersyaratan(<?php echo e($item->id); ?>, '<?php echo e(addslashes($item->nama)); ?>', '<?php echo e(addslashes($item->keterangan ?? '')); ?>', <?php echo e($item->wajib ? 1 : 0); ?>, <?php echo e($item->aktif ? 1 : 0); ?>)" class="btn-icon btn-icon-sm btn-icon-edit">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                                    </svg>
                                </button>
                                <form action="<?php echo e(route('admin.spmb.persyaratan.destroy', $item)); ?>" method="POST" class="inline" onsubmit="return confirm('Hapus persyaratan ini?')">
                                    <?php echo csrf_field(); ?>
...
<div id="modal-tambah" class="hidden fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
    <div class="bg-white rounded-xl shadow-xl max-w-lg w-full">
        ...
        <form action="<?php echo e(route('admin.spmb.persyaratan.store')); ?>" method="POST" class="p-6 space-y-4">
            <?php echo csrf_field(); ?>
            <div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\eka\.gemini\antigravity\scratch\smk-alstar\resources\views\admin\spmb\persyaratan\index.blade.php ENDPATH**/ ?>