...
<?php $__env->startSection('title', 'Detail Pembayaran - Admin'); ?>
...
<div class="p-6">
    ...
    <div class="flex items-center justify-between mb-6">
        <div class="flex items-center gap-4">
            <a href="<?php echo e(route('admin.pembayaran.index')); ?>" class="p-2 hover:bg-slate-100 rounded-lg transition-colors">
        ...
        <div class="flex items-center gap-2">
            ...
            ?>
            <span class="px-4 py-2 text-sm font-semibold rounded-lg border <?php echo e($statusColors[$pembayaran->status]); ?>">
            ...
            <div class="p-4 space-y-4">
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <p class="font-medium text-slate-800"><?php echo e($pembayaran->calonSiswa->nisn); ?></p>
                    </div>
                    <div>
                        <p class="text-sm text-slate-500">Nama Lengkap</p>
                        <p class="font-medium text-slate-800"><?php echo e($pembayaran->calonSiswa->nama); ?></p>
                    </div>
                    <div>
                        <p class="text-sm text-slate-500">Jurusan Pilihan</p>
                        <p class="font-medium text-slate-800"><?php echo e($pembayaran->calonSiswa->pendaftaran?->jurusan?->nama ?? '-'); ?></p>
                    </div>
                    <div>
                        <p class="text-sm text-slate-500">No. WhatsApp</p>
                        <p class="font-medium text-slate-800"><?php echo e($pembayaran->calonSiswa->no_wa ?? '-'); ?></p>
                    </div>
                    <div class="col-span-2">
                        <p class="text-sm text-slate-500">Asal Sekolah</p>
                        <p class="font-medium text-slate-800"><?php echo e($pembayaran->calonSiswa->asal_sekolah ?? '-'); ?></p>
                    </div>
                </div>
                
                <div class="pt-4 border-t border-slate-100">
                    <a href="<?php echo e(route('admin.pendaftar.show', $pembayaran->calonSiswa->id)); ?>" 
        ...
        <div class="bg-white rounded-xl border border-slate-200 overflow-hidden">
            ...
            <div class="p-4 space-y-4">
                <div class="bg-emerald-50 border border-emerald-200 rounded-lg p-4">
                    ...
                    <p class="text-2xl font-bold text-emerald-800"><?php echo e($pembayaran->jumlah_formatted); ?></p>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <p class="font-medium text-slate-800"><?php echo e($pembayaran->status_label); ?></p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="font-medium text-slate-800"><?php echo e($pembayaran->verifiedBy?->nama ?? '-'); ?></p>
                    </div>
                    <?php endif; ?>
                </div>
                ...
                <div class="bg-slate-50 rounded-lg p-3">
                    ...
                    <p class="text-sm text-slate-800"><?php echo e($pembayaran->catatan_admin); ?></p>
                </div>
                <?php endif; ?>
            </div>
        </div>
    ...
    <div class="mt-6 bg-white rounded-xl border border-slate-200 overflow-hidden">
        <div class="p-4 border-b border-slate-100 bg-slate-50 flex items-center justify-between">
            ...
            <div class="flex items-center gap-2">
                <a href="<?php echo e(route('admin.pembayaran.preview', $pembayaran)); ?>" target="_blank"
                ...
                <a href="<?php echo e(route('admin.pembayaran.download', $pembayaran)); ?>"
        ...
        <div class="p-4">
            ...
            <div class="max-w-md mx-auto">
                <img src="<?php echo e($pembayaran->bukti_url); ?>" alt="Bukti Pembayaran" 
                    class="w-full rounded-lg border border-slate-200 cursor-pointer hover:shadow-lg transition-shadow"
                    onclick="window.open('<?php echo e($pembayaran->bukti_url); ?>', '_blank')">
            </div>
            <?php else: ?>
            <div class="max-w-md mx-auto bg-red-50 border border-red-200 rounded-lg p-8 text-center">
                ...
                <a href="<?php echo e($pembayaran->bukti_url); ?>" target="_blank"
    ...
    <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div class="bg-white rounded-xl border border-slate-200 p-6">
            ...
            <form action="<?php echo e(route('admin.pembayaran.verify', $pembayaran)); ?>" method="POST">
                <?php echo csrf_field(); ?>
