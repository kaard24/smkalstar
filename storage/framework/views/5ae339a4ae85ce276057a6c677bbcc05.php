...
<div class="min-h-screen bg-gray-50 flex items-center justify-center py-12 px-4" x-data="{ 
    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
            ...
            <form action="<?php echo e(route('login.submit')); ?>" method="POST" @submit="isLoading = true">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <p class="text-center text-gray-600 text-sm">
                Belum punya akun?
                <a href="<?php echo e(route('register')); ?>" class="text-primary font-semibold hover:underline ml-1">Daftar Sekarang</a>
            </p>
        </div>
    </div>
    ...
    <div x-show="showRegPopup" x-cloak class="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <div class="relative bg-white rounded-2xl shadow-2xl p-8 max-w-sm w-full text-center">
            ...
            <p class="text-gray-600 text-sm mb-2">Selamat datang, <strong><?php echo e(session('registered_nama_lengkap')); ?></strong>!</p>
