...
<?php $__env->startSection('title', 'Edit Section Beranda - Admin Panel'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card p-6 max-w-3xl">
        <form action="<?php echo e(route('admin.beranda.update', $beranda)); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <select id="tipe" name="tipe" required
                        ...
                        <option value="<?php echo e($key); ?>" <?php echo e(old('tipe', $beranda->tipe) == $key ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <input type="number" id="urutan" name="urutan" 
                           value="<?php echo e(old('urutan', $beranda->urutan)); ?>" required min="0"
            ...
            <div class="mt-4">
                ...
                <input type="text" id="judul" name="judul" 
                       value="<?php echo e(old('judul', $beranda->judul)); ?>" required
            ...
            <div class="mt-4">
                ...
                <input type="text" id="subjudul" name="subjudul" 
                       value="<?php echo e(old('subjudul', $beranda->subjudul)); ?>"
            ...
            <div class="mt-4">
                ...
                <textarea id="konten" name="konten" rows="4"
                          ...
                          class="w-full px-3 py-2 text-sm border border-slate-300 rounded-md focus:outline-none focus:border-[#4276A3] focus:ring-1 focus:ring-[#4276A3]"><?php echo e(old('konten', $beranda->konten)); ?></textarea>
            </div>
            ...
            <div class="mt-4">
                ...
                <?php if($beranda->gambar): ?>
                <div class="mb-3 aspect-video rounded-lg overflow-hidden bg-slate-100 max-w-sm">
                    <img src="<?php echo e($beranda->gambar_url); ?>" alt="<?php echo e($beranda->judul); ?>" class="w-full h-full object-cover">
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                ...
                <div>
                    ...
                    <input type="text" id="tombol_teks" name="tombol_teks" 
                           value="<?php echo e(old('tombol_teks', $beranda->tombol_teks)); ?>"
                ...
                <div>
                    ...
                    <input type="text" id="tombol_link" name="tombol_link" 
                           value="<?php echo e(old('tombol_link', $beranda->tombol_link)); ?>"
            ...
            <div class="mt-4">
                ...
                <input type="text" id="warna_latar" name="warna_latar" 
                       value="<?php echo e(old('warna_latar', $beranda->warna_latar)); ?>"
            ...
            <div class="mt-4 p-3 bg-slate-50 rounded-lg border border-slate-200">
                <label class="flex items-start gap-3 cursor-pointer">
                    <input type="checkbox" name="is_active" value="1" <?php echo e(old('is_active', $beranda->is_active) ? 'checked' : ''); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\eka\.gemini\antigravity\scratch\smk-alstar\resources\views\admin\beranda\edit.blade.php ENDPATH**/ ?>