    ...
    <section class="py-20 bg-gray-50" x-data="{
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                ...
                ?>
                <div class="group cursor-pointer bg-white rounded-3xl shadow-sm hover:shadow-2xl transition-all duration-300 border border-gray-100 overflow-hidden" @click="openLightbox(<?php echo e(json_encode($images)); ?>, '<?php echo e(addslashes($item->nama)); ?>')">
                    <div class="relative h-64 overflow-hidden">
                        ...
                        <div class="absolute bottom-0 left-0 right-0 p-6 transform translate-y-2 group-hover:translate-y-0 transition duration-300">
                            <h3 class="text-white font-bold text-xl mb-1 font-heading"><?php echo e($item->nama); ?></h3>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\user\.gemini\antigravity\scratch\smkalstar\smkalstar\resources\views/fasilitas.blade.php ENDPATH**/ ?>