...
<?php $__env->startSection('content'); ?>
    ...
    <div class="relative bg-gradient-to-br from-blue-50 via-sky-50 to-cyan-50 py-16 md:py-24 border-b border-blue-100 overflow-hidden">
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            ...
            <p class="text-gray-600 text-sm sm:text-base md:text-xl max-w-3xl mx-auto leading-relaxed">Wadah pengembangan bakat dan minat siswa di luar jam pelajaran untuk membentuk karakter yang unggul</p>
        </div>
    </div>
    ...
    <section class="py-12 sm:py-16 md:py-20 bg-gray-50" x-data="createLightboxData()" @keydown.escape.window="closeLightbox()" @keydown.arrow-right.window="nextImage()" @keydown.arrow-left.window="prevImage()">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
             ...
             <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
                 ...
                 <div class="bg-white rounded-3xl shadow-sm border border-gray-100 hover:shadow-2xl transition-all duration-300 p-4 pb-8 text-center group cursor-pointer flex flex-col items-center"
                      @click="openLightbox(<?php echo \Illuminate\Support\Js::from($images)->toHtml() ?>, <?php echo \Illuminate\Support\Js::from($item->nama)->toHtml() ?>)">
                     
                     <div class="w-full h-44 sm:h-48 mb-5 sm:mb-6 overflow-hidden rounded-2xl relative shadow-sm">
                     ...
                     <h3 class="font-bold text-gray-900 text-base sm:text-xl font-heading mb-2 group-hover:text-primary transition"><?php echo e($item->nama); ?></h3>
        ...
        <div x-show="lightboxOpen" 
            ...
            <div class="max-w-7xl max-h-[90vh] w-full flex flex-col items-center relative z-40 pointer-events-none">
                <div class="relative w-full h-full flex items-center justify-center pointer-events-auto" @touchstart.passive="onTouchStart($event)" @touchend.passive="onTouchEnd($event)">
