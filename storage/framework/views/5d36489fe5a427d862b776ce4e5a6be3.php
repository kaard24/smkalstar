...
<?php $__env->startSection('content'); ?>
    ...
    <div class="relative bg-gradient-to-br from-blue-50 via-sky-50 to-cyan-50 py-16 md:py-24 border-b border-blue-100 overflow-hidden">
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            ...
            <p class="text-gray-600 text-sm sm:text-base md:text-xl max-w-3xl mx-auto leading-relaxed">Jadwal lengkap pendaftaran, tes masuk, dan pengumuman hasil seleksi</p>
        </div>
    </div>
    ...
    <section class="py-12 bg-gradient-to-r from-blue-600 to-cyan-600 relative overflow-hidden">
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="text-center mb-8">
                <p class="text-blue-100 text-sm sm:text-lg mb-2"><?php echo e($nextEvent['label']); ?></p>
    ...
    <section class="py-20 bg-gray-50">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <!-- Timeline Cards -->
            <div class="space-y-8">
                <?php $__currentLoopData = $gelombang; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                        $pendaftaranStart = $g->pendaftaran_start;
                        $pendaftaranEnd = $g->pendaftaran_end;
                        $tesStart = $g->tes_mulai;
                    ...
                    <div class="bg-white rounded-3xl shadow-lg border <?php echo e($gelombangAktif ? 'border-blue-200 ring-2 ring-blue-100' : 'border-gray-100'); ?> overflow-hidden hover:shadow-xl transition duration-300" id="gelombang-<?php echo e($g->nomor); ?>">
                        <!-- Header Gelombang -->
                            ...
                            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                                <div class="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-500 text-sm mt-1">Tahun Ajaran <?php echo e($g->tahun_ajaran); ?></p>
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\eka\.gemini\antigravity\scratch\smk-alstar\resources\views\spmb\kalender.blade.php ENDPATH**/ ?>