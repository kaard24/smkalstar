...
<div class="max-w-6xl mx-auto">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div class="px-6 py-4 border-b border-gray-100 bg-gray-50 flex flex-wrap items-center justify-between gap-4">
                ...
                <div class="flex items-center gap-2">
                    <button onclick="openMemberModal(<?php echo e($section->id); ?>, '<?php echo e(addslashes($section->nama)); ?>')" class="px-3 py-1.5 bg-green-50 text-green-600 rounded-lg text-sm font-medium hover:bg-green-100 transition flex items-center gap-1">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path></svg>
                        Tambah Anggota
                    </button>
                    <button onclick="openEditSectionModal(<?php echo e($section->id); ?>, '<?php echo e(addslashes($section->nama)); ?>', <?php echo e($section->urutan); ?>)" class="p-2 text-blue-600 hover:bg-blue-50 rounded-lg transition">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div class="bg-gray-50 rounded-xl p-4 text-center relative group">
                        ...
                        <div class="absolute top-2 right-2 flex gap-1 opacity-0 group-hover:opacity-100 transition">
                            <button onclick="openEditMemberModal(<?php echo e($member->id); ?>, '<?php echo e(addslashes($member->nama)); ?>', '<?php echo e(addslashes($member->keterangan ?? '')); ?>', <?php echo e($member->urutan); ?>, '<?php echo e($member->foto_url ?? ''); ?>')" class="p-1.5 bg-white text-blue-600 hover:bg-blue-50 rounded-lg shadow-sm">
                        ...
                        <div class="w-24 h-24 mx-auto mb-3 rounded-full overflow-hidden bg-gray-200 flex items-center justify-center">
                            ...
                            <img src="<?php echo e($member->foto_url); ?>" alt="<?php echo e($member->nama); ?>" class="w-full h-full object-cover">
                            <?php else: ?>
    ...
    <div class="mt-6 flex justify-end">
        <a href="<?php echo e(url('/profil')); ?>#struktur-organisasi" target="_blank" class="px-6 py-3 border border-gray-300 text-gray-700 rounded-xl font-semibold hover:bg-gray-50 transition">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <div id="memberFotoPreview" class="mb-2 hidden">
                            <img id="memberFotoImg" src="" alt="Preview" class="w-20 h-20 rounded-full object-cover mx-auto">
                        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\user\.gemini\antigravity\scratch\smkalstar\smkalstar\resources\views/admin/profil-struktur.blade.php ENDPATH**/ ?>