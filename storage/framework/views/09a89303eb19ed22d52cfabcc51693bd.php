...
<?php $__env->startSection('title', 'Kontak SPMB - Admin Panel'); ?>
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-8 mb-8">
        ...
        <div class="space-y-4">
            <?php $__empty_1 = true; $__currentLoopData = $kontak->where('aktif', true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <a href="<?php echo e($item->whatsapp_link); ?>" target="_blank" class="flex items-center p-4 bg-slate-50 rounded-2xl hover:bg-green-50 group transition duration-300">
                ...
                <div class="min-w-0 flex-1">
                    <p class="text-sm text-slate-500 font-medium"><?php echo e($item->jabatan ?? 'Panitia'); ?></p>
                    <p class="font-bold text-slate-800 text-lg"><?php echo e($item->nama); ?></p>
                    <p class="text-slate-600"><?php echo e($item->whatsapp); ?></p>
                </div>
        ...
        <div class="overflow-x-auto">
            <table class="data-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="font-medium"><?php echo e($item->nama); ?></td>
                        <td class="text-slate-600"><?php echo e($item->jabatan ?? '-'); ?></td>
                        <td class="font-mono text-sm"><?php echo e($item->whatsapp); ?></td>
                        <td>
                        ...
                        <td>
                            <div class="flex gap-1">
                                <button onclick="editKontak(<?php echo e($item->id); ?>, '<?php echo e(addslashes($item->nama)); ?>', '<?php echo e(addslashes($item->jabatan ?? '')); ?>', '<?php echo e($item->telepon ?? ''); ?>', '<?php echo e($item->whatsapp); ?>', '<?php echo e($item->email ?? ''); ?>', <?php echo e($item->aktif ? 1 : 0); ?>)" class="btn-icon btn-icon-sm btn-icon-edit">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                                    </svg>
                                </button>
                                <form action="<?php echo e(route('admin.spmb.kontak.destroy', $item)); ?>" method="POST" class="inline" onsubmit="return confirm('Hapus kontak ini?')">
                                    <?php echo csrf_field(); ?>
...
<div id="modal-tambah" class="hidden fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
    <div class="bg-white rounded-xl shadow-xl max-w-lg w-full">
        ...
        <form action="<?php echo e(route('admin.spmb.kontak.store')); ?>" method="POST" class="p-6 space-y-4">
            <?php echo csrf_field(); ?>
            <div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\eka\.gemini\antigravity\scratch\smk-alstar\resources\views\admin\spmb\kontak\index.blade.php ENDPATH**/ ?>