                ...
                <?php $__currentLoopData = $jurusanList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $j): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <a href="<?php echo e(url('/jurusan/' . strtolower($j->kode))); ?>" 
                       class="flex items-center gap-1.5 sm:gap-2 px-2.5 sm:px-3 py-1.5 sm:py-2 rounded-lg sm:rounded-xl text-xs sm:text-sm font-medium whitespace-nowrap transition flex-shrink-0 <?php echo e($isActive ? $theme['bg'] . ' text-white' : 'text-gray-600 hover:bg-gray-100'); ?>">
                        <img src="<?php echo e($jLogoUrl); ?>" alt="<?php echo e($j->nama); ?>" class="w-4 h-4 sm:w-5 sm:h-5 rounded-full object-cover flex-shrink-0">
                    ...
                    <div class="bg-white rounded-2xl sm:rounded-3xl p-5 sm:p-6 md:p-8 shadow-sm">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="border border-gray-100 rounded-xl p-4 sm:p-5">
                                <h3 class="font-bold text-gray-900 text-sm sm:text-base"><?php echo e($kegiatan->judul); ?></h3>
                                <?php if($kegiatan->deskripsi): ?>
                                <p class="text-gray-600 text-sm mt-1"><?php echo e($kegiatan->deskripsi); ?></p>
                                <?php endif; ?>
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-4">
                                    ...
                                    <img src="<?php echo e($g->gambar_url); ?>" alt="<?php echo e($kegiatan->judul); ?>" class="w-full h-24 sm:h-32 object-cover rounded-lg border border-gray-100">
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                                <?php endif; ?>
                            </div>
