...
<?php $__env->startSection('title', 'Edit Kepala Jurusan - Admin Panel'); ?>
...
<div class="max-w-2xl mx-auto">
    ...
    <div class="mb-8">
        ...
        <h1 class="text-2xl font-bold text-slate-800">Edit Kepala Jurusan</h1>
        <p class="text-slate-600">Perbarui data akun kepala jurusan.</p>
    </div>

    
    <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
        <form action="<?php echo e(route('admin.kajur.update', $kajur)); ?>" method="POST" class="space-y-6">
            <?php echo csrf_field(); ?>
            <?php echo method_field('PUT'); ?>

            <div>
                <label class="block text-sm font-medium text-slate-700 mb-2">Nama Lengkap</label>
                <input type="text" name="nama" value="<?php echo e(old('nama', $kajur->nama)); ?>" 
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="text" name="username" value="<?php echo e(old('username', $kajur->username)); ?>" 
                    class="w-full rounded-lg border-slate-300 focus:border-[#4276A3] focus:ring-[#4276A3]"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <select name="jurusan_id" class="w-full rounded-lg border-slate-300 focus:border-[#4276A3] focus:ring-[#4276A3]" required>
                    ...
                    <option value="<?php echo e($j->id); ?>" <?php echo e(old('jurusan_id', $kajur->jurusan_id) == $j->id ? 'selected' : ''); ?>><?php echo e($j->nama); ?></option>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                <label class="flex items-center gap-3 cursor-pointer">
                    <input type="checkbox" name="aktif" value="1" <?php echo e(old('aktif', $kajur->aktif) ? 'checked' : ''); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\eka\.gemini\antigravity\scratch\smk-alstar\resources\views\admin\kajur\edit.blade.php ENDPATH**/ ?>