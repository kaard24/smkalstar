...
<?php $__env->startSection('title', 'Edit Program Keahlian - Panel Kepala Jurusan'); ?>
...
<div class="max-w-5xl mx-auto px-4 py-8">
    ...
    <div class="mb-6">        
        <div class="flex items-start gap-4">
            <?php if($jurusan->logo_url): ?>
            <img src="<?php echo e($jurusan->logo_url); ?>" alt="<?php echo e($jurusan->nama); ?>" class="w-16 h-16 object-contain bg-white rounded-xl shadow-sm border border-slate-200 p-2">
            <?php else: ?>
            ...
            <?php endif; ?>
            <div>
                <h1 class="text-2xl font-bold text-slate-800"><?php echo e($jurusan->nama); ?></h1>
                <p class="text-slate-500">Kode: <?php echo e($jurusan->kode); ?> • <?php echo e($jurusan->kegiatan->count()); ?> Kegiatan</p>
            </div>
        </div>
    </div>

    
    <form id="jurusanForm" action="<?php echo e(route('kajur.jurusan.update')); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
        <?php echo csrf_field(); ?>
            ...
            <div x-show="open" x-collapse class="p-6 border-t border-slate-100">
                <div class="grid md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input id="kode" type="text" name="kode" value="<?php echo e(old('kode', $jurusan->kode)); ?>" 
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input id="nama" type="text" name="nama" value="<?php echo e(old('nama', $jurusan->nama)); ?>" 
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="flex items-center gap-3">
                            <input id="urutan" type="number" name="urutan" value="<?php echo e(old('urutan', $jurusan->urutan)); ?>" min="0"
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <textarea id="deskripsi" name="deskripsi" rows="3" 
                            ...
                            placeholder="Deskripsi singkat tentang jurusan (tampil di hero & list)..."><?php echo e(old('deskripsi', $jurusan->deskripsi)); ?></textarea>
                    ...
                    <div>
                        ...
                        <textarea id="deskripsi_lengkap" name="deskripsi_lengkap" rows="6" 
                            class="w-full rounded-xl border-slate-300 focus:border-blue-500 focus:ring-blue-500 text-sm"
                            placeholder="Deskripsi lengkap tentang jurusan (tampil di halaman detail)..."><?php echo e(old('deskripsi_lengkap', $jurusan->deskripsi_lengkap)); ?></textarea>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden" x-data="{ open: true }">
            ...
            <div x-show="open" x-collapse class="p-6 border-t border-slate-100">
                <div class="grid md:grid-cols-2 gap-6">
                    ...
                    <div x-data="{ preview: '<?php echo e($jurusan->logo_url); ?>', hover: false }">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div x-data="{ preview: '<?php echo e($jurusan->gambar_url); ?>', hover: false }">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden" x-data="{ 
            ...
            kompetensiCount: <?php echo e($jurusan->kompetensiItems->count() > 0 ? $jurusan->kompetensiItems->count() : 1); ?>,
            mapelCount: <?php echo e($jurusan->mapelItems->count() > 0 ? $jurusan->mapelItems->count() : 1); ?>,
            karirCount: <?php echo e($jurusan->karirItems->count() > 0 ? $jurusan->karirItems->count() : 1); ?>
            ...
            <div class="p-6">
                ...
                <div x-show="activeTab === 'kompetensi'" class="space-y-4">
                    ...
                    <div id="kompetensi-container" class="space-y-3">
                        <?php if($jurusan->kompetensiItems->count() > 0): ?>
                            <?php $__currentLoopData = $jurusan->kompetensiItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php echo $__env->make('kajur.jurusan.partials.detail-item', ['tipe' => 'kompetensi', 'judul' => $item->judul, 'deskripsi' => $item->deskripsi, 'placeholder' => 'Judul kompetensi'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php else: ?>
                            <?php echo $__env->make('kajur.jurusan.partials.detail-item', ['tipe' => 'kompetensi', 'judul' => '', 'deskripsi' => '', 'placeholder' => 'Judul kompetensi'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div x-show="activeTab === 'mapel'" class="space-y-4" style="display: none;">
                    ...
                    <div id="mapel-container" class="space-y-3">
                        <?php if($jurusan->mapelItems->count() > 0): ?>
                            <?php $__currentLoopData = $jurusan->mapelItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php echo $__env->make('kajur.jurusan.partials.detail-item', ['tipe' => 'mapel', 'judul' => $item->judul, 'deskripsi' => $item->deskripsi, 'placeholder' => 'Judul mata pelajaran'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php else: ?>
                            <?php echo $__env->make('kajur.jurusan.partials.detail-item', ['tipe' => 'mapel', 'judul' => '', 'deskripsi' => '', 'placeholder' => 'Judul mata pelajaran'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div x-show="activeTab === 'karir'" class="space-y-4" style="display: none;">
                    ...
                    <div id="karir-container" class="space-y-3">
                        <?php if($jurusan->karirItems->count() > 0): ?>
                            <?php $__currentLoopData = $jurusan->karirItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php echo $__env->make('kajur.jurusan.partials.detail-item', ['tipe' => 'karir', 'judul' => $item->judul, 'deskripsi' => $item->deskripsi, 'placeholder' => 'Judul karir'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php else: ?>
                            <?php echo $__env->make('kajur.jurusan.partials.detail-item', ['tipe' => 'karir', 'judul' => '', 'deskripsi' => '', 'placeholder' => 'Judul karir'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden" x-data="{ open: false }">
            ...
            <div x-show="open" x-collapse class="p-6 border-t border-slate-100">
                <div id="info-program-container" class="space-y-3">
                    <?php if($jurusan->infoProgram->count() > 0): ?>
                        <?php $__currentLoopData = $jurusan->infoProgram; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php echo $__env->make('kajur.jurusan.partials.info-item', ['label' => $info->label, 'value' => $info->value], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php else: ?>
                        <?php echo $__env->make('kajur.jurusan.partials.info-item', ['label' => 'Durasi', 'value' => '3 Tahun'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        <?php echo $__env->make('kajur.jurusan.partials.info-item', ['label' => 'Sertifikasi', 'value' => 'BNSP / LSP'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        <?php echo $__env->make('kajur.jurusan.partials.info-item', ['label' => 'Prakerin', 'value' => 'Di Industri'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    <?php endif; ?>
                </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden" x-data="{ open: false }">
            <button type="button" @click="open = !open" class="w-full px-6 py-4 flex items-center justify-between bg-gradient-to-r from-pink-50 to-white hover:from-pink-100 transition">
                <div class="flex items-center gap-3">
                    ...
                    <div class="text-left">
                        ...
                        <p class="text-sm text-slate-500">Foto dan deskripsi kegiatan (<?php echo e($jurusan->kegiatan->count()); ?> kegiatan)</p>
                    </div>
                </div>
                <svg :class="{ 'rotate-180': open }" class="w-5 h-5 text-slate-400 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
            ...
            <div x-show="open" x-collapse class="p-6 border-t border-slate-100">
                <div id="kegiatan-container" class="space-y-4">
                    <?php if($jurusan->kegiatan->count() > 0): ?>
                        <?php $__currentLoopData = $jurusan->kegiatan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $kegiatan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php echo $__env->make('kajur.jurusan.partials.kegiatan-item', [
                            'index' => $index,
                            'kegiatan' => $kegiatan,
        ...
        <div class="sticky bottom-0 bg-slate-50 border-t border-slate-200 p-4 -mx-4 sm:mx-0 sm:rounded-2xl sm:border">
            <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                <a href="<?php echo e(route('kajur.dashboard')); ?>" class="w-full sm:w-auto flex items-center justify-center gap-2 px-6 py-3 bg-white border border-slate-300 text-slate-700 font-medium rounded-xl hover:bg-slate-50 transition">
...
// Kegiatan Functions
let kegiatanIndex = <?php echo e($jurusan->kegiatan->count() > 0 ? $jurusan->kegiatan->count() : 1); ?>;
...
function deleteKegiatanGambar(gambarId) {
    ...
    fetch(`<?php echo e(url('kajur/jurusan/kegiatan-gambar')); ?>/${gambarId}`, {
        method: 'DELETE',
        headers: {
...
<?php echo $__env->make('layouts.kajur', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\eka\.gemini\antigravity\scratch\smk-alstar\resources\views\kajur\jurusan\edit.blade.php ENDPATH**/ ?>