...
<?php $__env->startSection('title', 'Edit Hero Section - Admin Panel'); ?>

<?php $__env->startSection('content'); ?>
    
    <div class="mb-6">
        <div class="flex items-center gap-2 mb-2">
            <a href="<?php echo e(route('admin.hero.index')); ?>" class="text-slate-500 hover:text-slate-700">
    ...
    <form action="<?php echo e(route('admin.hero.update', $hero)); ?>" method="POST" enctype="multipart/form-data" class="max-w-4xl">
        <?php echo csrf_field(); ?>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="space-y-4">
                ...
                <div class="bg-white rounded-xl border border-slate-200 p-4">
                    ...
                    <input type="text" name="badge_text" value="<?php echo e(old('badge_text', $hero->badge_text)); ?>" required
                ...
                <div class="bg-white rounded-xl border border-slate-200 p-4 space-y-3">
                    ...
                    <div>
                        ...
                        <input type="text" name="title_line1" value="<?php echo e(old('title_line1', $hero->title_line1)); ?>" required
                               class="w-full px-3 py-2 text-sm border border-slate-300 rounded-md focus:outline-none focus:border-[#4276A3] focus:ring-1 focus:ring-[#4276A3]">
                    </div>
                    
                    <div>
                        <label class="block text-xs font-medium text-slate-600 mb-1">Highlight <span class="text-[#991B1B]">*</span></label>
                        <input type="text" name="title_highlight" value="<?php echo e(old('title_highlight', $hero->title_highlight)); ?>" required
                               class="w-full px-3 py-2 text-sm border border-slate-300 rounded-md focus:outline-none focus:border-[#4276A3] focus:ring-1 focus:ring-[#4276A3]">
                    ...
                    <div>
                        ...
                        <input type="text" name="title_line2" value="<?php echo e(old('title_line2', $hero->title_line2)); ?>" required
                               class="w-full px-3 py-2 text-sm border border-slate-300 rounded-md focus:outline-none focus:border-[#4276A3] focus:ring-1 focus:ring-[#4276A3]">
                ...
                <div class="bg-white rounded-xl border border-slate-200 p-4">
                    ...
                    <textarea name="description" rows="3" required
                              class="w-full px-3 py-2 text-sm border border-slate-300 rounded-md focus:outline-none focus:border-[#4276A3] focus:ring-1 focus:ring-[#4276A3]"><?php echo e(old('description', $hero->description)); ?></textarea>
                </div>
            </div>
            ...
            <div class="space-y-4">
                ...
                <div class="bg-white rounded-xl border border-slate-200 p-4 space-y-3">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 gap-2">
                            <input type="text" name="button_primary_text" value="<?php echo e(old('button_primary_text', $hero->button_primary_text)); ?>" required placeholder="Teks"
                                   class="w-full px-3 py-2 text-sm border border-slate-300 rounded-md focus:outline-none focus:border-[#4276A3] focus:ring-1 focus:ring-[#4276A3]">
                            <input type="text" name="button_primary_url" value="<?php echo e(old('button_primary_url', $hero->button_primary_url)); ?>" required placeholder="URL"
                                   class="w-full px-3 py-2 text-sm border border-slate-300 rounded-md focus:outline-none focus:border-[#4276A3] focus:ring-1 focus:ring-[#4276A3]">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 gap-2">
                            <input type="text" name="button_secondary_text" value="<?php echo e(old('button_secondary_text', $hero->button_secondary_text)); ?>" required placeholder="Teks"
                                   class="w-full px-3 py-2 text-sm border border-slate-300 rounded-md focus:outline-none focus:border-[#4276A3] focus:ring-1 focus:ring-[#4276A3]">
                            <input type="text" name="button_secondary_url" value="<?php echo e(old('button_secondary_url', $hero->button_secondary_url)); ?>" required placeholder="URL"
                                   class="w-full px-3 py-2 text-sm border border-slate-300 rounded-md focus:outline-none focus:border-[#4276A3] focus:ring-1 focus:ring-[#4276A3]">
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl border border-slate-200 p-4">
                    ...
                    <div class="mb-3">
                        <img src="<?php echo e(asset($hero->hero_image)); ?>" alt="Current Hero" class="w-full h-32 object-cover rounded-lg">
                ...
                <div class="bg-white rounded-xl border border-slate-200 p-4">
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" name="is_active" value="1" <?php echo e(old('is_active', $hero->is_active) ? 'checked' : ''); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\eka\.gemini\antigravity\scratch\smk-alstar\resources\views/admin/hero/edit.blade.php ENDPATH**/ ?>