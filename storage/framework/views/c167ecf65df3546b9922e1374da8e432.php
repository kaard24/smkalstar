...
<?php $__env->startSection('title', isset($prestasi) ? 'Edit Prestasi' : 'Tambah Prestasi' . ' - Admin Panel'); ?>

<?php $__env->startSection('content'); ?>
<div class="max-w-2xl mx-auto">
    <div class="mb-8">
        <a href="<?php echo e(route('admin.prestasi.index')); ?>" class="inline-flex items-center text-sm text-slate-500 hover:text-[#4276A3] mb-4">
            <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path>
            </svg>
            Kembali
        </a>
        <h1 class="text-2xl font-bold text-slate-800"><?php echo e(isset($prestasi) ? 'Edit Prestasi' : 'Tambah Prestasi Baru'); ?></h1>
    </div>
    ...
    <form action="<?php echo e(isset($prestasi) ? route('admin.prestasi.update', $prestasi) : route('admin.prestasi.store')); ?>" 
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
            <div class="px-6 py-4 border-b border-slate-200 bg-slate-50">
                <h2 class="font-semibold text-slate-800">Informasi Prestasi</h2>
            </div>
            <div class="p-6 space-y-6">
                <div>
                    <label for="judul" class="block text-sm font-medium text-slate-700 mb-2">Judul Prestasi <span class="text-[#991B1B]">*</span></label>
                    <input type="text" id="judul" name="judul" value="<?php echo e(old('judul', $prestasi->judul ?? '')); ?>" required
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <select id="tingkat" name="tingkat" required
                            ...
                            <option value="Sekolah" <?php echo e(old('tingkat', $prestasi->tingkat ?? '') == 'Sekolah' ? 'selected' : ''); ?>>Sekolah</option>
                            <option value="Kecamatan" <?php echo e(old('tingkat', $prestasi->tingkat ?? '') == 'Kecamatan' ? 'selected' : ''); ?>>Kecamatan</option>
                            <option value="Kabupaten" <?php echo e(old('tingkat', $prestasi->tingkat ?? '') == 'Kabupaten' ? 'selected' : ''); ?>>Kabupaten/Kota</option>
                            <option value="Provinsi" <?php echo e(old('tingkat', $prestasi->tingkat ?? '') == 'Provinsi' ? 'selected' : ''); ?>>Provinsi</option>
                            <option value="Nasional" <?php echo e(old('tingkat', $prestasi->tingkat ?? '') == 'Nasional' ? 'selected' : ''); ?>>Nasional</option>
                            <option value="Internasional" <?php echo e(old('tingkat', $prestasi->tingkat ?? '') == 'Internasional' ? 'selected' : ''); ?>>Internasional</option>
                        </select>
                    </div>
                    <div>
                        <label for="tahun" class="block text-sm font-medium text-gray-700 mb-2">Tahun <span class="text-red-500">*</span></label>
                        <input type="number" id="tahun" name="tahun" value="<?php echo e(old('tahun', $prestasi->tahun ?? date('Y'))); ?>" required min="2000" max="2100"
                            class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-primary focus:border-primary transition"
                ...
                <div>
                    ...
                    <textarea id="deskripsi" name="deskripsi" rows="3"
                        class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-primary focus:border-primary transition"
                        placeholder="Deskripsi singkat mengenai prestasi ini"><?php echo e(old('deskripsi', $prestasi->deskripsi ?? '')); ?></textarea>
                </div>

                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Galeri Dokumentsi</label>
                    <?php if(isset($prestasi) && !empty($prestasi->gambar_urls)): ?>
                    <div class="grid grid-cols-2 md:grid-cols-3 gap-4 mb-4">
                        <?php $__currentLoopData = $prestasi->gambar_urls; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="relative group" id="gambar-<?php echo e($index); ?>">
                            <img src="<?php echo e($url); ?>" alt="<?php echo e($prestasi->judul); ?> <?php echo e($index + 1); ?>" class="w-full h-32 object-cover rounded-lg border" loading="lazy" decoding="async">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="number" id="urutan" name="urutan" value="<?php echo e(old('urutan', $prestasi->urutan ?? 0)); ?>"
                            class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-primary focus:border-primary transition">
                    </div>
                    <div class="flex items-center pt-8">
                        <label class="flex items-center cursor-pointer">
                            <input type="checkbox" name="aktif" value="1" <?php echo e(old('aktif', $prestasi->aktif ?? true) ? 'checked' : ''); ?>
        ...
        <div class="flex justify-end gap-4">
            <a href="<?php echo e(route('admin.prestasi.index')); ?>" class="btn btn-secondary btn-lg">
                Batal
            </a>
            <button type="submit" class="btn btn-primary btn-lg shadow-sm hover:shadow-md">
                ...
                <?php echo e(isset($prestasi) ? 'Simpan Perubahan' : 'Tambah Prestasi'); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\eka\.gemini\antigravity\scratch\smk-alstar\resources\views/admin/prestasi/form.blade.php ENDPATH**/ ?>