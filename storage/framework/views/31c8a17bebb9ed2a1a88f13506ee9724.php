<?php $__env->startSection('title', 'Edit Berita - Admin Panel'); ?>
...
<div class="max-w-3xl mx-auto">
    ...
    <form action="<?php echo e(route('admin.berita.update', $berita->id)); ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-6">
            ...
            <input type="text" id="judul" name="judul" value="<?php echo e(old('judul', $berita->judul)); ?>" required
        ...
        <div class="mb-6">
            ...
            <textarea id="isi" name="isi" rows="12" required
                      ...
                      placeholder="Tulis isi berita di sini..."><?php echo e(old('isi', $berita->isi)); ?></textarea>
            <p class="text-xs text-slate-500 mt-1.5">Gunakan enter untuk membuat paragraf baru.</p>
        </div>

        
        <?php if(!empty($berita->gambar) && count($berita->gambar) > 0): ?>
        <div class="mb-6">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 gap-3">
                ...
                <div class="relative group border border-slate-200 rounded-lg overflow-hidden">
                    <img src="<?php echo e($url); ?>" alt="Gambar <?php echo e($index + 1); ?>" class="w-full h-28 object-cover" loading="lazy" decoding="async">
                    <label class="absolute inset-0 bg-black/50 flex flex-col items-center justify-center cursor-pointer opacity-0 group-hover:opacity-100 transition cursor-pointer">
                        <input type="checkbox" name="hapus_gambar[]" value="<?php echo e($index); ?>" class="w-4 h-4 rounded border-2 border-white cursor-pointer">
        ...
        <div class="mb-8">
            ...
            <input type="datetime-local" id="published_at" name="published_at" 
                   value="<?php echo e(old('published_at', $berita->published_at ? $berita->published_at->format('Y-m-d\TH:i') : '')); ?>"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\eka\.gemini\antigravity\scratch\smk-alstar\resources\views\admin\berita\edit.blade.php ENDPATH**/ ?>