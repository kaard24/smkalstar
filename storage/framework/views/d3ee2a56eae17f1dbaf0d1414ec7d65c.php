...
<?php $__env->startSection('title', 'Status Kelulusan - Admin Panel'); ?>
                ...
                <tr class="hover:bg-slate-50 transition">
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="flex items-center">
                            <div>
                                ...
                                <div class="text-sm text-gray-500"><?php echo e($item->jurusan->kode); ?> - <?php echo e($item->calonSiswa->nisn); ?></div>
                            </div>
                        </div>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                        <span class="text-sm font-bold text-slate-800 bg-slate-100 px-2 py-1 rounded"><?php echo e($item->tes->nilai_btq ?? '-'); ?></span>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                        <span class="text-sm font-bold text-slate-800 bg-slate-100 px-2 py-1 rounded"><?php echo e($item->tes->nilai_minat_bakat ?? '-'); ?></span>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                        <span class="text-sm font-bold text-gray-900 bg-gray-100 px-2 py-1 rounded"><?php echo e($item->tes->nilai_kejuruan ?? '-'); ?></span>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                        <?php if($item->tes && $item->tes->status_kelulusan == 'Lulus'): ?>
                            <span class="px-3 py-1 bg-[#4276A3]/10 text-[#4276A3] rounded-full text-xs font-bold">LULUS</span>
                        <?php elseif($item->tes && $item->tes->status_kelulusan == 'Tidak Lulus'): ?>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                        <div class="flex justify-center gap-2">
                            <a href="<?php echo e(route('admin.input_nilai', $item->id)); ?>" class="btn-icon btn-icon-edit btn-icon-sm" title="Edit Nilai">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"></path></svg>
                            </a>
                            <form action="<?php echo e(route('admin.kelulusan.notify', $item->id)); ?>" method="POST" class="inline">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\eka\.gemini\antigravity\scratch\smk-alstar\resources\views\admin\kelulusan.blade.php ENDPATH**/ ?>