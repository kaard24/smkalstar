    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-6 max-w-4xl">
        ...
        <div class="bg-white rounded-xl border-2 border-dashed border-slate-300 p-6 mb-6 hover:border-blue-400 transition-colors"
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="relative group <?php echo e($isUploaded ? 'bg-emerald-50 border-emerald-200' : 'bg-slate-50 border-slate-200'); ?> border-2 border-dashed rounded-xl p-4 transition-all hover:shadow-md"
                    ...
                    <div class="text-center">
                        ...
                        <div class="w-20 h-20 mx-auto rounded-xl overflow-hidden mb-3 shadow-md relative group-hover:shadow-lg transition-shadow cursor-pointer"
                             onclick="event.stopPropagation(); openPreviewModal('<?php echo e($fileUrl); ?>', '<?php echo e($nama); ?>', 'image')">
                            <img src="<?php echo e($fileUrl); ?>" alt="<?php echo e($nama); ?>" class="w-full h-full object-cover hover:scale-110 transition-transform duration-300">
                        ...
                        <div class="w-14 h-14 mx-auto bg-emerald-500 rounded-xl flex items-center justify-center mb-3 cursor-pointer hover:bg-emerald-600 transition-colors"
                             onclick="event.stopPropagation(); openPreviewModal('<?php echo e($fileUrl); ?>', '<?php echo e($nama); ?>', 'pdf')">
                            <svg class="w-7 h-7 text-white" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M7 3C5.895 3 5 3.895 5 5v14c0 1.105.895 2 2 2h10c1.105 0 2-.895 2-2V9l-6-6H7zm6 1.5L17.5 9H13V4.5z"/>
                            </svg>
                        </div>
                        <?php endif; ?>
                        <h4 class="font-semibold text-slate-800 text-sm mb-1"><?php echo e($nama); ?></h4>
                        <p class="text-xs text-emerald-600 font-medium"><?php echo e($fileSize ?? 'Tersimpan'); ?></p>
                        
                        <!-- Hover Actions -->
                        <div class="absolute top-2 right-2 flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                            <button type="button"
                               onclick="event.stopPropagation(); openPreviewModal('<?php echo e($fileUrl); ?>', '<?php echo e($nama); ?>', '<?php echo e($isImage ? 'image' : 'pdf'); ?>')"
                            ...
                            <form action="<?php echo e(route('spmb.berkas.destroy', $berkasItem)); ?>" method="POST" 
                    ...
                    <div class="text-center py-4">
                        ...
                        <h4 class="font-semibold text-slate-700 text-sm mb-1"><?php echo e($nama); ?></h4>
            ...
            <div class="bg-white rounded-xl border <?php echo e($isUploaded ? 'border-emerald-200' : 'border-slate-200'); ?> p-4 sm:p-5">
                <div class="flex flex-col sm:flex-row sm:items-center gap-4">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <?php if($berkasItem): ?>
                                <div class="mt-2 flex items-center gap-2 text-sm text-slate-600">
                                    ...
                                    <span class="text-xs text-emerald-600 font-medium"><?php echo e($berkasItem->getFileSize()); ?></span>
                    ...
                    <div class="flex items-center gap-2 sm:flex-shrink-0">
                        <?php if($berkasItem): ?>
                            <a href="<?php echo e(route('spmb.berkas.download', $berkasItem)); ?>" 
        ...
        <?php if($progress['is_complete']): ?>
            <div class="mt-6 bg-emerald-50 border border-emerald-200 rounded-xl p-5">
                <div class="flex flex-col sm:flex-row sm:items-center gap-4">
                    ...
                    <a href="<?php echo e(route('spmb.status')); ?>" class="inline-flex items-center gap-2 px-5 py-2.5 bg-white text-emerald-600 rounded-lg font-medium hover:bg-emerald-100 transition-colors">
                        Lihat Status
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="absolute inset-0 flex items-center justify-center p-4">
        <div class="bg-white rounded-xl shadow-xl max-w-md w-full relative">
            ...
            <div class="p-6">
                ...
                <form action="<?php echo e(route('spmb.berkas.upload')); ?>" method="POST" enctype="multipart/form-data" id="uploadForm">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\user\.gemini\antigravity\scratch\smkalstar\smkalstar\resources\views/spmb/berkas.blade.php ENDPATH**/ ?>