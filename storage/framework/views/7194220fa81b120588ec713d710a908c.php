        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="max-w-4xl mx-auto">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-8">
                    ...
                    <form action="<?php echo e(route('berita.komentar', $berita->slug)); ?>" method="POST" class="space-y-4" id="commentForm">
                        <?php echo csrf_field(); ?>
                        ...
                        <div>
                            ...
                            <input type="text" id="username" name="username" required 
                                ...
                                class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-primary focus:border-primary transition <?php $__errorArgs = ['username'];
...
unset($__errorArgs, $__bag); ?>"
                        ...
                        <div>
                            ...
                            <textarea id="komentar" name="komentar" rows="3" required 
                                ...
                                class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-primary focus:border-primary transition <?php $__errorArgs = ['komentar'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\eka\.gemini\antigravity\scratch\smk-alstar\resources\views\berita\show.blade.php ENDPATH**/ ?>