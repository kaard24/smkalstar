...
<?php $__env->startSection('content'); ?>
    ...
    <div class="grid md:grid-cols-4 gap-4 mb-6">
        ...
        <a href="<?php echo e(route('admin.pendaftar.index')); ?>" class="card p-4 hover:border-primary transition">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xl font-bold text-gray-900"><?php echo e($totalPendaftar); ?></p>
                </div>
            </div>
        </a>

        
        <a href="<?php echo e(route('admin.pendaftar.index')); ?>?status=lengkap" class="card p-4 hover:border-primary transition">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xl font-bold text-gray-900"><?php echo e($dataLengkap); ?></p>
                </div>
            </div>
        </a>
        ...
        <a href="<?php echo e(route('admin.pendaftar.index')); ?>" class="card p-4 hover:border-primary transition">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xl font-bold text-gray-900"><?php echo e($berkasLengkap); ?></p>
                </div>
            </div>
        </a>

        
        <a href="<?php echo e(route('admin.pendaftar.index')); ?>" class="card p-4 hover:border-primary transition border-green-200">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xl font-bold text-green-700"><?php echo e($siapTes); ?></p>
                </div>
            </div>
        </a>
    </div>
    ...
    <div class="card p-5 mb-6">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
            <a href="<?php echo e(route('admin.pendaftar.index')); ?>" class="flex flex-col items-center gap-2 p-4 border border-gray-200 rounded-lg hover:border-primary hover:bg-gray-50 transition text-center">
            ...
            <a href="<?php echo e(route('admin.jurusan.index')); ?>" class="flex flex-col items-center gap-2 p-4 border border-gray-200 rounded-lg hover:border-primary hover:bg-gray-50 transition text-center">
            ...
            <a href="<?php echo e(route('admin.fasilitas.index')); ?>" class="flex flex-col items-center gap-2 p-4 border border-gray-200 rounded-lg hover:border-primary hover:bg-gray-50 transition text-center">
            ...
            <a href="<?php echo e(route('admin.berita.index')); ?>" class="flex flex-col items-center gap-2 p-4 border border-gray-200 rounded-lg hover:border-primary hover:bg-gray-50 transition text-center">
            ...
            <a href="<?php echo e(route('admin.ekstrakurikuler.index')); ?>" class="flex flex-col items-center gap-2 p-4 border border-gray-200 rounded-lg hover:border-primary hover:bg-gray-50 transition text-center">
            ...
            <a href="<?php echo e(route('admin.prestasi.index')); ?>" class="flex flex-col items-center gap-2 p-4 border border-gray-200 rounded-lg hover:border-primary hover:bg-gray-50 transition text-center">
            ...
            <a href="<?php echo e(route('admin.galeri.index')); ?>" class="flex flex-col items-center gap-2 p-4 border border-gray-200 rounded-lg hover:border-primary hover:bg-gray-50 transition text-center">
            ...
            <a href="<?php echo e(route('admin.profil-sekolah.sejarah')); ?>" class="flex flex-col items-center gap-2 p-4 border border-gray-200 rounded-lg hover:border-primary hover:bg-gray-50 transition text-center">
