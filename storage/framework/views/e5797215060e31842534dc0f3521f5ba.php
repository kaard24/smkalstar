        ...
        <form action="<?php echo e(route('admin.pendaftar.index')); ?>" method="GET">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 mb-3">
                ...
                <div>
                    ...
                    <input type="text" name="asal_sekolah" id="asal_sekolah" value="<?php echo e(request('asal_sekolah')); ?>" placeholder="Nama sekolah..." class="form-input w-full" list="sekolah-list">
                    <datalist id="sekolah-list">
                        <?php $__currentLoopData = $asalSekolahList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sekolah): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($sekolah); ?>">
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </datalist>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-3 mb-3">
                ...
                <div>
                    ...
                    <select name="berkas" id="berkas" class="form-input w-full">
                        <option value="">Semua</option>
                        <option value="belum" <?php echo e(request('berkas') == 'belum' ? 'selected' : ''); ?>>Belum Upload</option>
                        <option value="sebagian" <?php echo e(request('berkas') == 'sebagian' ? 'selected' : ''); ?>>Sebagian</option>
                        <option value="lengkap" <?php echo e(request('berkas') == 'lengkap' ? 'selected' : ''); ?>>Lengkap</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select name="kelulusan" id="kelulusan" class="form-input w-full">
                        <option value="">Semua</option>
                        <option value="pending" <?php echo e(request('kelulusan') == 'pending' ? 'selected' : ''); ?>>Pending</option>
                        <option value="lulus" <?php echo e(request('kelulusan') == 'lulus' ? 'selected' : ''); ?>>Lulus</option>
                        <option value="tidak_lulus" <?php echo e(request('kelulusan') == 'tidak_lulus' ? 'selected' : ''); ?>>Tidak Lulus</option>
                    </select>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-3 mb-4">
                ...
                <div>
                    ...
                    <input type="date" name="tgl_dari" id="tgl_dari" value="<?php echo e(request('tgl_dari')); ?>" class="form-input w-full">
                </div>

                
                <div>
                    <label for="tgl_sampai" class="block text-xs font-medium text-slate-600 mb-1">Tanggal Daftar Sampai</label>
                    <input type="date" name="tgl_sampai" id="tgl_sampai" value="<?php echo e(request('tgl_sampai')); ?>" class="form-input w-full">
                </div>
            ...
            <div class="flex flex-wrap gap-2 items-center pt-3 border-t border-slate-200">
                ...
                <div class="flex flex-wrap gap-1 ml-auto">
                    ...
                    <?php if(request('status')): ?>
                        <?php $statusLabels = ['baru' => 'Baru', 'proses_data' => 'Proses Data', 'proses_berkas' => 'Proses Berkas', 'lengkap' => 'Lengkap', 'lulus' => 'Lulus']; ?>
                        <span class="text-xs bg-slate-100 text-slate-600 px-2 py-1 rounded"><?php echo e($statusLabels[request('status')] ?? request('status')); ?></span>
                    <?php endif; ?>
                    <?php if(request('berkas')): ?>
                        <?php $berkasLabels = ['belum' => 'Belum Upload', 'sebagian' => 'Sebagian', 'lengkap' => 'Berkas Lengkap']; ?>
                        <span class="text-xs bg-slate-100 text-slate-600 px-2 py-1 rounded"><?php echo e($berkasLabels[request('berkas')]); ?></span>
                    <?php endif; ?>
                    <?php if(request('kelulusan')): ?>
                        <?php $lulusLabels = ['pending' => 'Pending', 'lulus' => 'Lulus', 'tidak_lulus' => 'Tidak Lulus']; ?>
                        <span class="text-xs bg-slate-100 text-slate-600 px-2 py-1 rounded"><?php echo e($lulusLabels[request('kelulusan')]); ?></span>
                    <?php endif; ?>
                    <?php if(request('tgl_dari') || request('tgl_sampai')): ?>
                        <span class="text-xs bg-slate-100 text-slate-600 px-2 py-1 rounded"><?php echo e(request('tgl_dari')); ?> - <?php echo e(request('tgl_sampai')); ?></span>
                    <?php endif; ?>
                </div>
                <?php endif; ?>
            </div>
        ...
        <div class="overflow-x-auto">
            <table class="data-table">
                ...
                <tbody>
                    ...
                    ?>
                    <tr class="hover:bg-slate-50 transition-colors" data-id="<?php echo e($siswa->id); ?>">
                        ...
                        <td class="text-center text-slate-500 cursor-pointer" onclick="window.location='<?php echo e(route('admin.pendaftar.show', $siswa->id)); ?>'"><?php echo e($nomor); ?></td>
                        <td class="cursor-pointer" onclick="window.location='<?php echo e(route('admin.pendaftar.show', $siswa->id)); ?>'">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\user\.gemini\antigravity\scratch\smkalstar\smkalstar\resources\views/admin/pendaftar.blade.php ENDPATH**/ ?>