<?php $__env->startSection('title', 'Daftar Pendaftar - SPMB Admin'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="mb-6 bg-white rounded-xl shadow-sm border border-gray-200 p-4">
        <form action="<?php echo e(route('admin.pendaftar.index')); ?>" method="GET" class="flex flex-wrap gap-4 items-end">
            <!-- Search Input -->
            ...
            <div class="flex gap-2">
                ...
                <?php if(request('search') || request('jurusan') || request('status')): ?>
                <a href="<?php echo e(route('admin.pendaftar.index')); ?>" class="px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition flex items-center gap-2 font-medium">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <table class="w-full text-left">
            ...
            <tbody class="divide-y divide-gray-100">
                <?php $__empty_1 = true; $__currentLoopData = $pendaftar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $siswa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr class="hover:bg-gray-50 transition">
                    <td class="px-6 py-4">
                        <div class="font-medium text-gray-900"><?php echo e($siswa->nama); ?></div>
                        <div class="text-sm text-gray-500"><?php echo e($siswa->asal_sekolah ?? '-'); ?></div>
                    </td>
                    <td class="px-6 py-4 text-gray-600 font-mono text-sm"><?php echo e($siswa->nisn); ?></td>
                    <td class="px-6 py-4">
                        <?php if($siswa->pendaftaran && $siswa->pendaftaran->jurusan): ?>
                            <span class="px-3 py-1 bg-green-100 text-green-700 rounded-full text-xs font-bold"><?php echo e($siswa->pendaftaran->jurusan->kode); ?></span>
                        <?php else: ?>
                    ...
                    <td class="px-6 py-4">
                        ...
                        ?>
                        <?php if($hasPendaftaran && $isComplete): ?>
                    ...
                    <td class="px-6 py-4">
                        <div class="flex gap-2">
                            <a href="<?php echo e(route('admin.pendaftar.show', $siswa->id)); ?>" class="flex items-center px-3 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 text-sm font-medium transition">
                                <svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                                Lihat
                            </a>
                            <a href="<?php echo e(route('admin.pendaftar.edit', $siswa->id)); ?>" class="flex items-center px-3 py-2 bg-blue-50 text-blue-600 rounded-lg hover:bg-blue-100 text-sm font-medium transition">
                                <svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg>
                                Edit
                            </a>
                            <form action="<?php echo e(route('admin.pendaftar.destroy', $siswa->id)); ?>" method="POST" onsubmit="return confirm('Yakin ingin menghapus data calon siswa ini?')">
                                <?php echo csrf_field(); ?>
