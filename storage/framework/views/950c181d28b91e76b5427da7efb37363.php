...
<?php $__env->startSection('content'); ?>
    ...
    ?>
    <div class="relative <?php echo e($bgClass); ?> py-16 md:py-24 border-b border-blue-100 overflow-hidden" style="<?php echo e($bgStyle); ?>">
        <!-- Decorative Elements -->
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            ...
            ?>
            <div class="inline-flex items-center gap-2 bg-gradient-to-r <?php echo e($badgeClass); ?> text-white px-5 py-2 rounded-full text-sm font-bold mb-6 shadow-lg shadow-blue-200">
            ...
            <h1 class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-gray-900 mb-4 font-heading">
                <?php echo e($judul1); ?> <br>
                <span class="text-transparent bg-clip-text bg-gradient-to-r <?php echo e($badgeClass); ?>"><?php echo e($judul2); ?></span>
            </h1>
            <p class="text-gray-600 text-sm sm:text-base md:text-xl max-w-3xl mx-auto leading-relaxed mb-8"><?php echo e($deskripsi); ?></p>
            
            <!-- Countdown/Quick Info -->
            <?php if($tampilkanGelombang): ?>
            <div class="flex flex-wrap justify-center gap-4 md:gap-6">
                <?php $__currentLoopData = $gelombang->take($jumlahGelombang); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                    $isAktif = $g->is_aktif;
                ...
                <div class="lg:col-span-2 space-y-16">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 gap-3 sm:gap-6">
                            <?php $__empty_1 = true; $__currentLoopData = $jurusan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $j): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                ...
                                <a href="<?php echo e(url('/jurusan/' . strtolower($j->kode))); ?>" class="flex flex-col border <?php echo e($j->warna_border); ?> rounded-2xl sm:rounded-3xl bg-white hover:shadow-lg transition duration-300 group overflow-hidden cursor-pointer">
                                    
                                    <div class="relative h-32 sm:h-48 bg-gray-50 overflow-hidden flex items-center justify-center p-2">
                                        <img src="<?php echo e($j->gambar_url); ?>" alt="<?php echo e($j->nama); ?>" class="w-full h-full object-contain scale-125 group-hover:scale-[1.35] transition duration-300">
                                    </div>
                                    
                                    <div class="p-2.5 sm:p-3 flex items-center gap-2 sm:gap-3">
                                        <div class="w-8 h-8 sm:w-10 sm:h-10 rounded-full <?php echo e($j->warna_bg); ?> flex items-center justify-center overflow-hidden flex-shrink-0 ring-2 ring-white shadow-sm <?php echo e($j->warna_hover); ?> transition">
                                            <img src="<?php echo e($j->logo_url); ?>" alt="Logo <?php echo e($j->nama); ?>" class="w-full h-full object-cover">
                                        </div>
                                        <h3 class="font-bold text-gray-900 text-xs sm:text-sm group-hover:<?php echo e($j->warna_text); ?> transition leading-tight"><?php echo e($j->nama); ?></h3>
                                    </div>
                                </a>
                    ...
                    <div>
                        ...
                        <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
                            <div class="p-4 sm:p-6 md:p-8 grid grid-cols-2 gap-3 sm:gap-4">
                                ...
                                ?>
                                <div class="flex flex-col justify-between gap-3 p-3 sm:p-4 rounded-2xl <?php echo e($isBerlangsung ? 'bg-sky-50/50 border border-sky-100' : ($isSelesai ? 'bg-gray-50 border border-gray-100' : 'border border-gray-100 hover:bg-gray-50 transition')); ?>">
                                    <div class="flex items-start gap-3">
                                        <div class="w-9 h-9 sm:w-12 sm:h-12 rounded-full <?php echo e($isBerlangsung ? 'bg-sky-100 text-sky-600' : ($isSelesai ? 'bg-gray-200 text-gray-500' : 'bg-gray-100 text-gray-400')); ?> flex items-center justify-center flex-shrink-0">
                                            <span class="text-sm sm:text-lg font-bold"><?php echo e($g->nomor); ?></span>
                                        </div>
                                        <div class="min-w-0">
                                            <h4 class="font-bold text-gray-900 text-sm sm:text-base leading-tight"><?php echo e($g->nama); ?></h4>
                                            <p class="text-xs sm:text-sm text-gray-600 font-medium mt-1 leading-snug"><?php echo e($g->pendaftaran_start->translatedFormat('d M Y')); ?> - <?php echo e($g->pendaftaran_end->translatedFormat('d M Y')); ?></p>
                                        </div>
                                    </div>
                                    <?php if($isBerlangsung): ?>
                                    <span class="px-2.5 sm:px-4 py-1.5 sm:py-2 bg-[#0EA5E9] text-white rounded-xl text-[10px] sm:text-xs font-bold shadow-sm self-start">SEDANG DIBUKA</span>
                                    <?php elseif($isSelesai): ?>
                                    <span class="px-2.5 sm:px-4 py-1.5 sm:py-2 bg-gray-200 text-gray-600 rounded-xl text-[10px] sm:text-xs font-bold self-start">SELESAI</span>
                                    <?php else: ?>
                                    <span class="px-2.5 sm:px-4 py-1.5 sm:py-2 bg-gray-100 text-gray-500 rounded-xl text-[10px] sm:text-xs font-bold border border-gray-200 self-start">AKAN DATANG</span>
                                    <?php endif; ?>
                                </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                    ...
                    <div>
                        ...
                        <div class="relative pl-6 sm:pl-10 space-y-10 before:absolute before:left-2 sm:before:left-4 before:top-2 before:bottom-2 before:w-0.5 before:bg-gradient-to-b before:from-primary before:to-slate-200">
                            ...
                            <div class="relative group">
                                ...
                                <h3 class="font-bold text-gray-900 text-base sm:text-lg mb-1 group-hover:text-primary transition"><?php echo e($item->judul); ?></h3>
