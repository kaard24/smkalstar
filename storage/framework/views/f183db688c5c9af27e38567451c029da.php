...
<?php $__env->startSection('title', 'Biaya SPMB - Admin Panel'); ?>
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-gradient-to-br from-[#0EA5E9] to-[#1E3A5F] text-white rounded-3xl p-8 shadow-xl relative overflow-hidden mb-8">
        ...
        <div class="space-y-4 mb-6 relative z-10">
            <?php $__empty_1 = true; $__currentLoopData = $biaya->where('aktif', true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="flex justify-between items-center py-2 border-b border-white/20">
                <span class="text-sky-100"><?php echo e($item->nama); ?></span>
            ...
            <table class="data-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="font-mono font-medium"><?php echo e($item->nominal_formatted); ?></td>
                        ...
                        <td>
                            <div class="flex gap-1">
                                <button onclick="editBiaya(<?php echo e($item->id); ?>, '<?php echo e(addslashes($item->nama)); ?>', <?php echo e($item->nominal); ?>, '<?php echo e(addslashes($item->keterangan ?? '')); ?>', <?php echo e($item->aktif ? 1 : 0); ?>)" class="btn-icon btn-icon-sm btn-icon-edit">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                                    </svg>
                                </button>
                                <form action="<?php echo e(route('admin.spmb.biaya.destroy', $item)); ?>" method="POST" class="inline" onsubmit="return confirm('Hapus biaya ini?')">
                                    <?php echo csrf_field(); ?>
...
<div id="modal-tambah" class="hidden fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
    <div class="bg-white rounded-xl shadow-xl max-w-lg w-full">
        ...
        <form action="<?php echo e(route('admin.spmb.biaya.store')); ?>" method="POST" class="p-6 space-y-4">
            <?php echo csrf_field(); ?>
            <div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\eka\.gemini\antigravity\scratch\smk-alstar\resources\views/admin/spmb/biaya/index.blade.php ENDPATH**/ ?>