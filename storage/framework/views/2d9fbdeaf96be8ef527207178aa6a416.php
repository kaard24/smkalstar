                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 gap-4 mb-4">
                        ...
                        <div class="relative group" id="gambar-<?php echo e($index); ?>">
                            ...
                            <div class="absolute top-2 right-2">
                                <input type="checkbox" name="hapus_gambar[]" value="<?php echo e($index); ?>" class="w-5 h-5 text-[#991B1B] rounded border-slate-300 focus:ring-red-500" onchange="syncCheckbox(this, <?php echo e($index); ?>)">
                            </div>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\user\.gemini\antigravity\scratch\smkalstar\smkalstar\resources\views/admin/profil-sejarah.blade.php ENDPATH**/ ?>