...
<div class="max-w-4xl mx-auto">
    ...
    <form action="<?php echo e(route('admin.profil-sekolah.update-sejarah')); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <textarea id="sejarah_konten" name="sejarah_konten" rows="8" required
                        class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-primary focus:border-primary transition"><?php echo e(old('sejarah_konten', $profil->sejarah_konten)); ?></textarea>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 gap-4 mb-4">
                        ...
                        <div class="relative group">
                            <img src="<?php echo e($url); ?>" alt="Gambar Sejarah <?php echo e($index + 1); ?>" class="w-full h-32 object-cover rounded-lg border">
                            ...
                            <div class="absolute top-2 right-2">
                                <input type="checkbox" name="hapus_gambar[]" value="<?php echo e($index); ?>" class="w-5 h-5 text-red-600 rounded border-gray-300 focus:ring-red-500">
                            </div>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
        ...
        <div class="flex justify-end gap-4">
            <a href="<?php echo e(url('/profil')); ?>#sejarah" target="_blank" class="px-6 py-3 border border-gray-300 text-gray-700 rounded-xl font-semibold hover:bg-gray-50 transition">
                Lihat Halaman
            </a>
