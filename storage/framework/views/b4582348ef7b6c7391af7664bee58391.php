...
<div class="min-h-screen bg-gray-50">
    ...
    <div class="bg-sky-50 py-6 md:py-8 border-b border-sky-100">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-2">
                <div>
                    <h1 class="text-xl md:text-2xl font-bold text-gray-900">Dashboard SPMB</h1>
                    <p class="text-sm text-gray-600">Selamat datang, <?php echo e($siswa->nama ?: 'Calon Siswa'); ?>!</p>
                </div>
                <div class="flex items-center gap-2 md:gap-4">
                    <span class="bg-white px-3 py-1.5 rounded-lg text-xs md:text-sm text-gray-700 border border-sky-200 shadow-sm">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6">
                ...
                <div class="grid grid-cols-2 gap-3 md:gap-4">
                    ...
                    <div class="bg-white rounded-xl p-3 md:p-4 shadow-sm border border-gray-100">
                        <div class="flex items-center gap-2 md:gap-3">
                            <div class="w-8 h-8 md:w-10 md:h-10 rounded-lg <?php echo e($completeness['biodata'] ? 'bg-sky-100' : 'bg-gray-100'); ?> flex items-center justify-center flex-shrink-0">
                                <svg class="w-4 h-4 md:w-5 md:h-5 <?php echo e($completeness['biodata'] ? 'text-[#0EA5E9]' : 'text-gray-400'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                                </svg>
                            </div>
                            <div class="min-w-0">
                                <p class="text-xs text-gray-500">Biodata</p>
                                <p class="font-semibold text-xs md:text-sm <?php echo e($completeness['biodata'] ? 'text-[#0EA5E9]' : 'text-gray-900'); ?> truncate">
                    ...
                    <div class="bg-white rounded-xl p-3 md:p-4 shadow-sm border border-gray-100">
                        <div class="flex items-center gap-2 md:gap-3">
                            <div class="w-8 h-8 md:w-10 md:h-10 rounded-lg <?php echo e($completeness['orang_tua'] ? 'bg-sky-100' : 'bg-gray-100'); ?> flex items-center justify-center flex-shrink-0">
                                <svg class="w-4 h-4 md:w-5 md:h-5 <?php echo e($completeness['orang_tua'] ? 'text-[#0EA5E9]' : 'text-gray-400'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                </svg>
                            </div>
                            <div class="min-w-0">
                                <p class="text-xs text-gray-500">Orang Tua</p>
                                <p class="font-semibold text-xs md:text-sm <?php echo e($completeness['orang_tua'] ? 'text-[#0EA5E9]' : 'text-gray-900'); ?> truncate">
                    ...
                    <div class="bg-white rounded-xl p-3 md:p-4 shadow-sm border border-gray-100">
                        <div class="flex items-center gap-2 md:gap-3">
                            <div class="w-8 h-8 md:w-10 md:h-10 rounded-lg <?php echo e($completeness['jurusan'] ? 'bg-sky-100' : 'bg-gray-100'); ?> flex items-center justify-center flex-shrink-0">
                                <svg class="w-4 h-4 md:w-5 md:h-5 <?php echo e($completeness['jurusan'] ? 'text-[#0EA5E9]' : 'text-gray-400'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z"></path>
                                </svg>
                            </div>
                            <div class="min-w-0">
                                <p class="text-xs text-gray-500">Jurusan</p>
                                <p class="font-semibold text-xs md:text-sm <?php echo e($completeness['jurusan'] ? 'text-[#0EA5E9]' : 'text-gray-900'); ?> truncate">
                    ...
                    <div class="bg-white rounded-xl p-3 md:p-4 shadow-sm border border-gray-100">
                        <div class="flex items-center gap-2 md:gap-3">
                            <div class="w-8 h-8 md:w-10 md:h-10 rounded-lg <?php echo e($completeness['berkas'] ? 'bg-sky-100' : 'bg-yellow-100'); ?> flex items-center justify-center flex-shrink-0">
                                <svg class="w-4 h-4 md:w-5 md:h-5 <?php echo e($completeness['berkas'] ? 'text-[#0EA5E9]' : 'text-yellow-600'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                                </svg>
                            </div>
                            <div class="min-w-0">
                                <p class="text-xs text-gray-500">Berkas</p>
                                <p class="font-semibold text-xs md:text-sm <?php echo e($completeness['berkas'] ? 'text-[#0EA5E9]' : 'text-yellow-600'); ?> truncate">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div class="p-4 md:p-6">
                        <div class="space-y-3">
                            ...
                            <div class="flex items-start justify-between p-3 rounded-lg <?php echo e($item['uploaded'] ? 'bg-sky-50 border border-sky-100' : 'bg-gray-50 border border-gray-100'); ?>">
                                <div class="flex items-start gap-3">
                                    <div class="w-8 h-8 rounded-full <?php echo e($item['uploaded'] ? 'bg-[#0EA5E9]' : 'bg-gray-300'); ?> flex items-center justify-center flex-shrink-0 mt-0.5">
                                    ...
                                    <div>
                                        <span class="text-sm font-medium <?php echo e($item['uploaded'] ? 'text-sky-800' : 'text-gray-600'); ?>"><?php echo e($item['label']); ?></span>
                        ...
                        <a href="<?php echo e(route('ppdb.berkas')); ?>" class="mt-4 block w-full text-center bg-primary text-white py-2.5 rounded-lg text-sm font-medium hover:bg-[#0284C7] transition">
            ...
            <div class="space-y-4 md:space-y-6">
                            ...
                            <div class="flex gap-3">
                                <div class="flex flex-col items-center">
                                    <div class="w-7 h-7 md:w-8 md:h-8 rounded-full flex items-center justify-center flex-shrink-0
                                        <?php if($item['status'] === 'completed'): ?> bg-sky-100 text-[#0EA5E9]
                ...
                <div class="bg-gradient-to-br from-[#0EA5E9] to-[#1E3A5F] rounded-xl p-4 md:p-5 text-white">
                    ...
                    <p class="text-xs text-white/90 mb-3">Hubungi panitia SPMB jika ada kendala.</p>
                    <a href="https://wa.me/628812489572" target="_blank" class="inline-flex items-center gap-2 bg-green-600 text-white px-3 py-2 rounded-lg text-xs font-semibold hover:bg-green-700 transition shadow-sm">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\eka\.gemini\antigravity\scratch\smk-alstar\resources\views/ppdb/dashboard.blade.php ENDPATH**/ ?>