...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-slate-100 overflow-hidden mb-6">
        ...
        <?php if($currentStatus == Pembayaran::STATUS_PENDING): ?>
            ...
            <div class="flex items-start">
                ...
                <div class="flex-1">
                    ...
                    <div class="mt-3 p-3 bg-yellow-100 rounded-lg border border-yellow-200">
                        ...
                        <p class="text-sm text-yellow-700 mt-1"><?php echo e($pembayaran->catatan_admin); ?></p>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="flex items-start">
                ...
                <div class="flex-1">
                    ...
                    <div class="mt-3 p-3 bg-green-100 rounded-lg border border-green-200">
                        ...
                        <p class="text-sm text-green-700 mt-1"><?php echo e($pembayaran->catatan_admin); ?></p>
                    </div>
                    <?php endif; ?>
                    
                    <a href="<?php echo e(route('spmb.status')); ?>" class="mt-4 inline-flex items-center px-4 py-2 bg-green-600 text-white text-sm font-medium rounded-lg hover:bg-green-700">
                        ...
                        <div class="p-3 border border-slate-200 rounded-lg">
                            <div class="flex items-start gap-3">
                                <div class="w-10 h-10 bg-slate-100 rounded-lg flex items-center justify-center flex-shrink-0">
                                    <span class="text-xs font-bold text-slate-600"><?php echo e($pengaturanPembayaran->bank ? substr($pengaturanPembayaran->bank, 0, 2) : 'BN'); ?></span>
                                </div>
                                <div class="flex-1 min-w-0">
                                    <p class="font-medium text-slate-800"><?php echo e($pengaturanPembayaran->bank ?? 'Bank Transfer'); ?></p>
                                    <div class="flex items-center gap-2 mt-1">
                                        <p class="text-sm text-slate-600 font-mono bg-slate-50 px-2 py-1 rounded select-all"><?php echo e($pengaturanPembayaran->nomor_rekening ?? '-'); ?></p>
                                        <?php if($pengaturanPembayaran->nomor_rekening): ?>
                                        <button onclick="copyRekening('<?php echo e($pengaturanPembayaran->nomor_rekening); ?>', this)" 
                                    ...
                                    <p class="text-xs text-slate-500 mt-1">a.n. <?php echo e($pengaturanPembayaran->nama_penerima); ?></p>
                                </div>
                            </div>
                        </div>
                        <?php if($pengaturanPembayaran->keterangan): ?>
                        <div class="p-3 bg-yellow-50 border border-yellow-100 rounded-lg">
                            <p class="text-xs text-yellow-700"><?php echo e($pengaturanPembayaran->keterangan); ?></p>
                        </div>
                        <?php endif; ?>
                        <?php else: ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\eka\.gemini\antigravity\scratch\smk-alstar\resources\views/spmb/pembayaran.blade.php ENDPATH**/ ?>