...
<?php $__env->startSection('content'); ?>
    ...
    <div class="welcome-banner rounded-xl shadow-sm p-4 sm:p-6 mb-6 text-white relative">
        ...
        <div class="stat-card card p-5 border-l-4 border-[#4276A3]">
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-slate-800 mt-1"><?php echo e(number_format($totalPendaftar ?? 0)); ?></p>
                    <div class="flex items-center gap-1 mt-2">
                        <?php if(($totalPendaftarGrowth ?? 0) >= 0): ?>
                            <svg class="w-4 h-4 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"/>
                            </svg>
                            <span class="text-xs text-green-600 font-medium">+<?php echo e($totalPendaftarGrowth ?? 0); ?>%</span>
                        <?php else: ?>
                            <svg class="w-4 h-4 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 17h8m0 0V9m0 8l-8-8-4 4-6-6"/>
                            </svg>
                            <span class="text-xs text-red-600 font-medium"><?php echo e($totalPendaftarGrowth ?? 0); ?>%</span>
                        <?php endif; ?>
        ...
        <div class="stat-card card p-5 border-l-4 border-[#047857]">
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-slate-800 mt-1"><?php echo e(number_format($dataLengkap ?? 0)); ?></p>
                    <div class="flex items-center gap-1 mt-2">
                        <?php if(($dataLengkapGrowth ?? 0) >= 0): ?>
                            <svg class="w-4 h-4 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"/>
                            </svg>
                            <span class="text-xs text-green-600 font-medium">+<?php echo e($dataLengkapGrowth ?? 0); ?>%</span>
                        <?php else: ?>
                            <svg class="w-4 h-4 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 17h8m0 0V9m0 8l-8-8-4 4-6-6"/>
                            </svg>
                            <span class="text-xs text-red-600 font-medium"><?php echo e($dataLengkapGrowth ?? 0); ?>%</span>
                        <?php endif; ?>
                        <span class="text-xs text-slate-400">vs bulan lalu</span>
                    </div>
                </div>
        ...
        <div class="stat-card card p-5 border-l-4 border-[#B45309]">
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-slate-800 mt-1"><?php echo e(number_format($berkasLengkap ?? 0)); ?></p>
                    <div class="flex items-center gap-2 mt-2">
                        <div class="w-16 bg-slate-200 rounded-full h-1.5">
                            <div class="bg-[#B45309] h-1.5 rounded-full" style="width: <?php echo e($berkasConversionRate ?? 0); ?>%"></div>
                        </div>
                        <span class="text-xs text-slate-500"><?php echo e($berkasConversionRate ?? 0); ?>%</span>
                    </div>
                </div>
        ...
        <div class="stat-card card p-5 border-l-4 border-green-500">
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-slate-800 mt-1"><?php echo e(number_format($sudahLulus ?? 0)); ?></p>
                    <div class="flex items-center gap-1 mt-2">
                        <?php if(($sudahLulusGrowth ?? 0) >= 0): ?>
                            <svg class="w-4 h-4 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"/>
                            </svg>
                            <span class="text-xs text-green-600 font-medium">+<?php echo e($sudahLulusGrowth ?? 0); ?>%</span>
                        <?php else: ?>
                            <svg class="w-4 h-4 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 17h8m0 0V9m0 8l-8-8-4 4-6-6"/>
                            </svg>
                            <span class="text-xs text-red-600 font-medium"><?php echo e($sudahLulusGrowth ?? 0); ?>%</span>
                        <?php endif; ?>
                        <span class="text-xs text-slate-400">vs bulan lalu</span>
                    </div>
                </div>
    ...
    <div class="mb-6">
        ...
        <div class="card p-5">
            ...
            <div class="space-y-2 max-h-64 overflow-y-auto">
                <?php $__empty_1 = true; $__currentLoopData = $topSekolah ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $sekolah): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="flex items-center gap-3 p-2 rounded-lg <?php echo e($index < 3 ? 'bg-slate-50' : ''); ?>">
                    <div class="w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold <?php echo e($index < 3 ? 'bg-[#4276A3] text-white' : 'bg-slate-200 text-slate-600'); ?>">
                        <?php echo e($index + 1); ?>

                    </div>
                    <div class="flex-1 min-w-0">
                        <p class="text-xs font-medium text-slate-700 truncate"><?php echo e($sekolah->asal_sekolah ?? 'Tidak Diketahui'); ?></p>
                    </div>
                    <span class="text-xs font-semibold text-[#4276A3]"><?php echo e($sekolah->total); ?></span>
                </div>
    ...
    <div class="card p-4 sm:p-6 mb-6">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
            <a href="<?php echo e(route('admin.pendaftar.index')); ?>" class="group flex flex-col items-center gap-2 sm:gap-3 p-4 sm:p-5 bg-slate-50 border border-slate-200 rounded-xl hover:border-[#4276A3] hover:shadow-sm transition text-center">
            ...
            <a href="<?php echo e(route('admin.fasilitas.index')); ?>" class="group flex flex-col items-center gap-2 sm:gap-3 p-4 sm:p-5 bg-slate-50 border border-slate-200 rounded-xl hover:border-slate-400 hover:shadow-sm transition text-center">
            ...
            <a href="<?php echo e(route('admin.berita.index')); ?>" class="group flex flex-col items-center gap-2 sm:gap-3 p-4 sm:p-5 bg-slate-50 border border-slate-200 rounded-xl hover:border-slate-400 hover:shadow-sm transition text-center">
                <div class="w-12 h-12 bg-slate-200 rounded-xl flex items-center justify-center group-hover:bg-slate-300 transition">
                    <svg class="w-6 h-6 text-slate-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="<?php echo e(route('admin.profil-sekolah.sejarah')); ?>" class="group flex flex-col items-center gap-2 sm:gap-3 p-4 sm:p-5 bg-slate-50 border border-slate-200 rounded-xl hover:border-[#4276A3] hover:shadow-sm transition text-center">
                <div class="w-12 h-12 bg-[#4276A3]/10 rounded-xl flex items-center justify-center group-hover:bg-[#4276A3]/20 transition">
                    <svg class="w-6 h-6 text-[#4276A3]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/>
                    </svg>
...
<script>
    ...
    new Chart(weeklyCtx, {
        type: 'line',
        data: {
            labels: <?php echo json_encode($weeklyData['weeks'] ?? []); ?>,
            datasets: [{
                label: 'Pendaftar',
                data: <?php echo json_encode($weeklyData['counts'] ?? []); ?>,
                borderColor: '#4276A3',
        ...
        options: {
                ...
                tooltip: {
                    callbacks: {
                        title: function(context) {
                            const labels = <?php echo json_encode($weeklyData['labels'] ?? []); ?>;
            ...
            scales: {
                y: {
                    beginAtZero: true,
                    ticks: { stepSize: 1, font: { size: isMobileChart ? 10 : 11 } },
                    grid: { color: 'rgba(0,0,0,0.05)' }
                },
                x: {
                    ticks: { font: { size: isMobileChart ? 10 : 11 } },
                    grid: { display: false }
                }
            }
        }
    ...
    new Chart(jurusanCtx, {
        type: 'doughnut',
        data: {
            labels: <?php echo json_encode($statsJurusan->pluck('nama') ?? []); ?>,
            datasets: [{
                data: <?php echo json_encode($statsJurusan->pluck('pendaftaran_count') ?? []); ?>,
                backgroundColor: [
                    '#4276A3',
                    '#047857',
                    '#B45309',
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\eka\.gemini\antigravity\scratch\smk-alstar\resources\views\admin\dashboard.blade.php ENDPATH**/ ?>