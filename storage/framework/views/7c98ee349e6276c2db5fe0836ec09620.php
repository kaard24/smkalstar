...
<div class="min-h-screen bg-gray-50 py-6 sm:py-8" x-data="{
    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <form action="<?php echo e(route('spmb.lengkapi-data.store')); ?>" method="POST" @submit.prevent="isLoading = true; $el.submit();" novalidate>
            <?php echo csrf_field(); ?>
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="text" id="nik" name="nik" maxlength="16"
                                                ...
                                                class="w-full pl-12 pr-4 py-3.5 bg-white border-2 border-gray-200 rounded-xl focus:bg-white focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all <?php $__errorArgs = ['nik'];
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="text" id="no_kk" name="no_kk" maxlength="16"
                                                ...
                                                oninput="this.value = this.value.replace(/[^0-9]/g, '')"
                                                class="w-full pl-12 pr-4 py-3.5 bg-white border-2 border-gray-200 rounded-xl focus:bg-white focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all <?php $__errorArgs = ['no_kk'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="relative">
                                        ...
                                        <select id="agama" name="agama" required
                                            class="w-full pl-12 pr-10 py-3.5 bg-white border-2 border-gray-200 rounded-xl focus:bg-white focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all appearance-none cursor-pointer <?php $__errorArgs = ['agama'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="relative">
                                        ...
                                        <textarea id="alamat" name="alamat" rows="3" required
                                            ...
                                            class="w-full pl-12 pr-4 py-3.5 bg-white border-2 border-gray-200 rounded-xl focus:bg-white focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all <?php $__errorArgs = ['alamat'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="number" id="anak_ke" name="anak_ke" min="1" max="10"
                                                value="<?php echo e(old('anak_ke', $siswa->anak_ke)); ?>" required
                                                placeholder="Contoh: 1"
                                                title="Anak ke hanya boleh diisi angka 1-10"
                                                class="w-full pl-12 pr-4 py-3.5 bg-white border-2 border-gray-200 rounded-xl focus:bg-white focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all <?php $__errorArgs = ['anak_ke'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="number" id="jumlah_saudara" name="jumlah_saudara" min="0" max="10"
                                                value="<?php echo e(old('jumlah_saudara', $siswa->jumlah_saudara)); ?>" required
                                                placeholder="Contoh: 2"
                                                title="Jumlah saudara hanya boleh diisi angka 0-10"
                                                class="w-full pl-12 pr-4 py-3.5 bg-white border-2 border-gray-200 rounded-xl focus:bg-white focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all <?php $__errorArgs = ['jumlah_saudara'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                                ...
                                <div class="md:col-span-2 space-y-2">
                                    ...
                                    <div class="relative">
                                        ...
                                        <textarea id="alamat_sekolah" name="alamat_sekolah" rows="3" required
                                            ...
                                            oninput="this.value = this.value.replace(/[^a-zA-Z0-9\s.,\-\/\(\)]/g, '')"
                                            class="w-full pl-12 pr-4 py-3.5 bg-white border-2 border-gray-200 rounded-xl focus:bg-white focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all <?php $__errorArgs = ['alamat_sekolah'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" id="npsn" name="npsn" maxlength="8"
                                            value="<?php echo e(old('npsn', $siswa->npsn_sekolah)); ?>" required
                                            placeholder="8 digit NPSN"
                                            pattern="[0-9]{8}"
                                            title="NPSN harus 8 digit angka"
                                            oninput="this.value = this.value.replace(/[^0-9]/g, '')"
                                            class="w-full pl-12 pr-4 py-3.5 bg-white border-2 border-gray-200 rounded-xl focus:bg-white focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all <?php $__errorArgs = ['npsn'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="number" id="tinggi_badan" name="tinggi_badan" min="100" max="200"
                                                value="<?php echo e(old('tinggi_badan', $siswa->tinggi_badan)); ?>" required
                                                placeholder="Contoh: 165"
                                                title="Tinggi badan harus antara 100-200 cm"
                                                class="w-full pl-12 pr-4 py-3.5 bg-white border-2 border-gray-200 rounded-xl focus:bg-white focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all <?php $__errorArgs = ['tinggi_badan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="number" id="berat_badan" name="berat_badan" min="20" max="200"
                                                value="<?php echo e(old('berat_badan', $siswa->berat_badan)); ?>" required
                                                placeholder="Contoh: 55"
                                                title="Berat badan harus antara 20-200 kg"
                                                class="w-full pl-12 pr-4 py-3.5 bg-white border-2 border-gray-200 rounded-xl focus:bg-white focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all <?php $__errorArgs = ['berat_badan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="relative max-w-md">
                                        ...
                                        <select id="golongan_darah" name="golongan_darah"
                                            class="w-full pl-12 pr-10 py-3.5 bg-white border-2 border-gray-200 rounded-xl focus:bg-white focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all appearance-none cursor-pointer <?php $__errorArgs = ['golongan_darah'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                            ...
                                            <option value="Tidak Tahu" <?php echo e(old('golongan_darah', $siswa->golongan_darah) === 'Tidak Tahu' ? 'selected' : ''); ?>>Tidak Tahu</option>
                                        </select>
                                        <div class="absolute inset-y-0 right-0 pr-4 flex items-center pointer-events-none">
                                            <svg class="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    ...
                                    <textarea id="riwayat_penyakit" name="riwayat_penyakit" rows="2"
                                        ...
                                        oninput="this.value = this.value.replace(/[^a-zA-Z0-9\s,\.\-\/\(\)]/g, '')"
                                        class="w-full pl-12 pr-4 py-3.5 bg-white border-2 border-gray-200 rounded-xl focus:bg-white focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all <?php $__errorArgs = ['riwayat_penyakit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('riwayat_penyakit', $siswa->riwayat_penyakit)); ?></textarea>
                                </div>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="relative">
                                        ...
                                        <textarea id="minat_bakat" name="minat_bakat" rows="4"
                                            ...
                                            class="w-full pl-12 pr-4 py-3.5 bg-white border-2 border-gray-200 rounded-xl focus:bg-white focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all <?php $__errorArgs = ['minat_bakat'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('minat_bakat', $siswa->minat_bakat)); ?></textarea>
                                    </div>
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="text" id="nama_ayah" name="nama_ayah" maxlength="100"
                                                ...
                                                oninput="this.value = this.value.replace(/[^a-zA-Z\s\.\']/g, '')"
                                                class="w-full pl-12 pr-4 py-3.5 bg-white border-2 border-gray-200 rounded-xl focus:bg-white focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all <?php $__errorArgs = ['nama_ayah'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="text" id="nik_ayah" name="nik_ayah" maxlength="16"
                                                ...
                                                oninput="this.value = this.value.replace(/[^0-9]/g, '')"
                                                x-bind:required="jenis === 'orang_tua'"
                                                class="w-full pl-12 pr-4 py-3.5 bg-white border-2 border-gray-200 rounded-xl focus:bg-white focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all <?php $__errorArgs = ['nik_ayah'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="text" id="pekerjaan_ayah" name="pekerjaan_ayah" maxlength="100"
                                                ...
                                                oninput="this.value = this.value.replace(/[^a-zA-Z0-9\s,\.\-\/\&]/g, '')"
                                                class="w-full pl-12 pr-4 py-3.5 bg-white border-2 border-gray-200 rounded-xl focus:bg-white focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all <?php $__errorArgs = ['pekerjaan_ayah'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="relative">
                                            ...
                                            <select id="pendidikan_ayah" name="pendidikan_ayah" 
                                                x-bind:required="jenis === 'orang_tua'"
                                                class="w-full pl-12 pr-10 py-3.5 bg-white border-2 border-gray-200 rounded-xl focus:bg-white focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all appearance-none cursor-pointer <?php $__errorArgs = ['pendidikan_ayah'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                                ...
                                                <option value="Tidak Sekolah" <?php echo e(old('pendidikan_ayah', $siswa->orangTua?->pendidikan_ayah) === 'Tidak Sekolah' ? 'selected' : ''); ?>>Tidak Sekolah</option>
                                                <option value="SD" <?php echo e(old('pendidikan_ayah', $siswa->orangTua?->pendidikan_ayah) === 'SD' ? 'selected' : ''); ?>>SD</option>
                                                <option value="SMP" <?php echo e(old('pendidikan_ayah', $siswa->orangTua?->pendidikan_ayah) === 'SMP' ? 'selected' : ''); ?>>SMP</option>
                                                <option value="SMA" <?php echo e(old('pendidikan_ayah', $siswa->orangTua?->pendidikan_ayah) === 'SMA' ? 'selected' : ''); ?>>SMA/SMK</option>
                                                <option value="D1" <?php echo e(old('pendidikan_ayah', $siswa->orangTua?->pendidikan_ayah) === 'D1' ? 'selected' : ''); ?>>D1</option>
                                                <option value="D2" <?php echo e(old('pendidikan_ayah', $siswa->orangTua?->pendidikan_ayah) === 'D2' ? 'selected' : ''); ?>>D2</option>
                                                <option value="D3" <?php echo e(old('pendidikan_ayah', $siswa->orangTua?->pendidikan_ayah) === 'D3' ? 'selected' : ''); ?>>D3</option>
                                                <option value="S1" <?php echo e(old('pendidikan_ayah', $siswa->orangTua?->pendidikan_ayah) === 'S1' ? 'selected' : ''); ?>>S1</option>
                                                <option value="S2" <?php echo e(old('pendidikan_ayah', $siswa->orangTua?->pendidikan_ayah) === 'S2' ? 'selected' : ''); ?>>S2</option>
                                                <option value="S3" <?php echo e(old('pendidikan_ayah', $siswa->orangTua?->pendidikan_ayah) === 'S3' ? 'selected' : ''); ?>>S3</option>
                                            </select>
                                            <div class="absolute inset-y-0 right-0 pr-4 flex items-center pointer-events-none">
                                                <svg class="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="relative">
                                            ...
                                            <select id="penghasilan_ayah" name="penghasilan_ayah" 
                                                x-bind:required="jenis === 'orang_tua'"
                                                class="w-full pl-12 pr-10 py-3.5 bg-white border-2 border-gray-200 rounded-xl focus:bg-white focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all appearance-none cursor-pointer <?php $__errorArgs = ['penghasilan_ayah'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                                ...
                                                <option value="<1jt" <?php echo e(old('penghasilan_ayah', $siswa->orangTua?->penghasilan_ayah) === '<1jt' ? 'selected' : ''); ?>>Kurang dari Rp 1.000.000</option>
                                                <option value="1jt-3jt" <?php echo e(old('penghasilan_ayah', $siswa->orangTua?->penghasilan_ayah) === '1jt-3jt' ? 'selected' : ''); ?>>Rp 1.000.000 - Rp 3.000.000</option>
                                                <option value="3jt-5jt" <?php echo e(old('penghasilan_ayah', $siswa->orangTua?->penghasilan_ayah) === '3jt-5jt' ? 'selected' : ''); ?>>Rp 3.000.000 - Rp 5.000.000</option>
                                                <option value="5jt-10jt" <?php echo e(old('penghasilan_ayah', $siswa->orangTua?->penghasilan_ayah) === '5jt-10jt' ? 'selected' : ''); ?>>Rp 5.000.000 - Rp 10.000.000</option>
                                                <option value=">10jt" <?php echo e(old('penghasilan_ayah', $siswa->orangTua?->penghasilan_ayah) === '>10jt' ? 'selected' : ''); ?>>Lebih dari Rp 10.000.000</option>
                                            </select>
                                            <div class="absolute inset-y-0 right-0 pr-4 flex items-center pointer-events-none">
                                                <svg class="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="text" id="nama_ibu" name="nama_ibu" maxlength="100"
                                                ...
                                                oninput="this.value = this.value.replace(/[^a-zA-Z\s\.\']/g, '')"
                                                class="w-full pl-12 pr-4 py-3.5 bg-white border-2 border-gray-200 rounded-xl focus:bg-white focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all <?php $__errorArgs = ['nama_ibu'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="text" id="nik_ibu" name="nik_ibu" maxlength="16"
                                                ...
                                                oninput="this.value = this.value.replace(/[^0-9]/g, '')"
                                                x-bind:required="jenis === 'orang_tua'"
                                                class="w-full pl-12 pr-4 py-3.5 bg-white border-2 border-gray-200 rounded-xl focus:bg-white focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all <?php $__errorArgs = ['nik_ibu'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="text" id="pekerjaan_ibu" name="pekerjaan_ibu" maxlength="100"
                                                ...
                                                title="Pekerjaan hanya boleh mengandung huruf, angka, spasi, dan tanda baca"
                                                oninput="this.value = this.value.replace(/[^a-zA-Z0-9\s,\.\-\/\&]/g, '')"
                                                class="w-full pl-12 pr-4 py-3.5 bg-white border-2 border-gray-200 rounded-xl focus:bg-white focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all <?php $__errorArgs = ['pekerjaan_ibu'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="relative">
                                            ...
                                            <select id="pendidikan_ibu" name="pendidikan_ibu" 
                                                x-bind:required="jenis === 'orang_tua'"
                                                class="w-full pl-12 pr-10 py-3.5 bg-white border-2 border-gray-200 rounded-xl focus:bg-white focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all appearance-none cursor-pointer <?php $__errorArgs = ['pendidikan_ibu'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                                <option value="">-- Pilih Pendidikan --</option>
                                                <option value="Tidak Sekolah" <?php echo e(old('pendidikan_ibu', $siswa->orangTua?->pendidikan_ibu) === 'Tidak Sekolah' ? 'selected' : ''); ?>>Tidak Sekolah</option>
                                                <option value="SD" <?php echo e(old('pendidikan_ibu', $siswa->orangTua?->pendidikan_ibu) === 'SD' ? 'selected' : ''); ?>>SD</option>
                                                <option value="SMP" <?php echo e(old('pendidikan_ibu', $siswa->orangTua?->pendidikan_ibu) === 'SMP' ? 'selected' : ''); ?>>SMP</option>
                                                <option value="SMA" <?php echo e(old('pendidikan_ibu', $siswa->orangTua?->pendidikan_ibu) === 'SMA' ? 'selected' : ''); ?>>SMA/SMK</option>
                                                <option value="D1" <?php echo e(old('pendidikan_ibu', $siswa->orangTua?->pendidikan_ibu) === 'D1' ? 'selected' : ''); ?>>D1</option>
                                                <option value="D2" <?php echo e(old('pendidikan_ibu', $siswa->orangTua?->pendidikan_ibu) === 'D2' ? 'selected' : ''); ?>>D2</option>
                                                <option value="D3" <?php echo e(old('pendidikan_ibu', $siswa->orangTua?->pendidikan_ibu) === 'D3' ? 'selected' : ''); ?>>D3</option>
                                                <option value="S1" <?php echo e(old('pendidikan_ibu', $siswa->orangTua?->pendidikan_ibu) === 'S1' ? 'selected' : ''); ?>>S1</option>
                                                <option value="S2" <?php echo e(old('pendidikan_ibu', $siswa->orangTua?->pendidikan_ibu) === 'S2' ? 'selected' : ''); ?>>S2</option>
                                                <option value="S3" <?php echo e(old('pendidikan_ibu', $siswa->orangTua?->pendidikan_ibu) === 'S3' ? 'selected' : ''); ?>>S3</option>
                                            </select>
                                            <div class="absolute inset-y-0 right-0 pr-4 flex items-center pointer-events-none">
                                                <svg class="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="relative">
                                            ...
                                            <select id="penghasilan_ibu" name="penghasilan_ibu" 
                                                x-bind:required="jenis === 'orang_tua'"
                                                class="w-full pl-12 pr-10 py-3.5 bg-white border-2 border-gray-200 rounded-xl focus:bg-white focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all appearance-none cursor-pointer <?php $__errorArgs = ['penghasilan_ibu'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                                <option value="">-- Pilih Penghasilan --</option>
                                                <option value="<1jt" <?php echo e(old('penghasilan_ibu', $siswa->orangTua?->penghasilan_ibu) === '<1jt' ? 'selected' : ''); ?>>Kurang dari Rp 1.000.000</option>
                                                <option value="1jt-3jt" <?php echo e(old('penghasilan_ibu', $siswa->orangTua?->penghasilan_ibu) === '1jt-3jt' ? 'selected' : ''); ?>>Rp 1.000.000 - Rp 3.000.000</option>
                                                <option value="3jt-5jt" <?php echo e(old('penghasilan_ibu', $siswa->orangTua?->penghasilan_ibu) === '3jt-5jt' ? 'selected' : ''); ?>>Rp 3.000.000 - Rp 5.000.000</option>
                                                <option value="5jt-10jt" <?php echo e(old('penghasilan_ibu', $siswa->orangTua?->penghasilan_ibu) === '5jt-10jt' ? 'selected' : ''); ?>>Rp 5.000.000 - Rp 10.000.000</option>
                                                <option value=">10jt" <?php echo e(old('penghasilan_ibu', $siswa->orangTua?->penghasilan_ibu) === '>10jt' ? 'selected' : ''); ?>>Lebih dari Rp 10.000.000</option>
                                            </select>
                                            <div class="absolute inset-y-0 right-0 pr-4 flex items-center pointer-events-none">
                                                <svg class="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="text" id="nama_wali" name="nama_wali" maxlength="100"
                                                ...
                                                oninput="this.value = this.value.replace(/[^a-zA-Z\s\.\']/g, '')"
                                                class="w-full pl-12 pr-4 py-3.5 bg-white border-2 border-gray-200 rounded-xl focus:bg-white focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all <?php $__errorArgs = ['nama_wali'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="text" id="pekerjaan_wali" name="pekerjaan_wali" maxlength="100"
                                                ...
                                                title="Pekerjaan hanya boleh mengandung huruf, angka, spasi, dan tanda baca"
                                                oninput="this.value = this.value.replace(/[^a-zA-Z0-9\s,\.\-\/\&]/g, '')"
                                                class="w-full pl-12 pr-4 py-3.5 bg-white border-2 border-gray-200 rounded-xl focus:bg-white focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all <?php $__errorArgs = ['pekerjaan_wali'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="text" id="hubungan_wali" name="hubungan_wali" 
                                                ...
                                                x-bind:required="jenis === 'wali'"
                                                class="w-full pl-12 pr-4 py-3.5 bg-white border-2 border-gray-200 rounded-xl focus:bg-white focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all <?php $__errorArgs = ['hubungan_wali'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\eka\.gemini\antigravity\scratch\smk-alstar\resources\views\spmb\lengkapi-data.blade.php ENDPATH**/ ?>