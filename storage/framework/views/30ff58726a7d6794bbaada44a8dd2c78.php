...
<?php $__env->startSection('title', 'Tambah Pengaturan Pembayaran - Admin Panel'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card p-6 max-w-2xl">
        <form action="<?php echo e(route('admin.pembayaran-pengaturan.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" id="nama_penerima" name="nama_penerima" 
                           value="<?php echo e(old('nama_penerima')); ?>" required
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" id="biaya" name="biaya" 
                               value="<?php echo e(old('biaya')); ?>" required min="0"
                               placeholder="250000"
                ...
                <div>
                    ...
                    <textarea id="keterangan" name="keterangan" rows="3"
                              ...
                              class="w-full px-3 py-2 text-sm border border-slate-300 rounded-md focus:outline-none focus:border-[#4276A3] focus:ring-1 focus:ring-[#4276A3]"><?php echo e(old('keterangan')); ?></textarea>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\eka\.gemini\antigravity\scratch\smk-alstar\resources\views\admin\pembayaran-pengaturan\create.blade.php ENDPATH**/ ?>