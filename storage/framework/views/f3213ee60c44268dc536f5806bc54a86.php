...
<?php $__env->startSection('title', 'Edit Gelombang - Admin Panel'); ?>
...
<div class="max-w-3xl mx-auto">
    ...
    <div class="mb-8">
        ...
        <h1 class="text-2xl font-bold text-slate-800">Edit <?php echo e($gelombang->nama); ?></h1>
        <p class="text-slate-600">Perbarui informasi gelombang pendaftaran.</p>
    </div>
    ...
    <form action="<?php echo e(route('admin.spmb.gelombang.update', $gelombang)); ?>" method="POST" class="space-y-6">
        <?php echo csrf_field(); ?>
            ...
            <div class="p-6 space-y-4">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" id="nama" name="nama" value="<?php echo e(old('nama', $gelombang->nama)); ?>" required
...
unset($__errorArgs, $__bag); ?>"
                    ...
                    <div>
                        ...
                        <input type="number" id="nomor" name="nomor" value="<?php echo e(old('nomor', $gelombang->nomor)); ?>" required min="1"
...
unset($__errorArgs, $__bag); ?>"
                ...
                <div>
                    ...
                    <input type="text" id="tahun_ajaran" name="tahun_ajaran" value="<?php echo e(old('tahun_ajaran', $gelombang->tahun_ajaran)); ?>" required
...
unset($__errorArgs, $__bag); ?>"
                ...
                <div>
                    <label class="flex items-center cursor-pointer">
                        <input type="checkbox" name="aktif" value="1" <?php echo e(old('aktif', $gelombang->aktif) ? 'checked' : ''); ?>
            ...
            <div class="p-6 space-y-4">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="date" id="pendaftaran_start" name="pendaftaran_start" value="<?php echo e(old('pendaftaran_start', $gelombang->pendaftaran_start->format('Y-m-d'))); ?>" required
...
unset($__errorArgs, $__bag); ?>">
                    ...
                    <div>
                        ...
                        <input type="date" id="pendaftaran_end" name="pendaftaran_end" value="<?php echo e(old('pendaftaran_end', $gelombang->pendaftaran_end->format('Y-m-d'))); ?>" required
            ...
            <div class="p-6 space-y-4">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="date" id="tes_mulai" name="tes_mulai" value="<?php echo e(old('tes_mulai', $gelombang->tes_mulai->format('Y-m-d'))); ?>" required
...
unset($__errorArgs, $__bag); ?>">
                    ...
                    <div>
                        ...
                        <input type="date" id="tes_selesai" name="tes_selesai" value="<?php echo e(old('tes_selesai', $gelombang->tes_selesai->format('Y-m-d'))); ?>" required
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
            ...
            <div class="p-6">
                <div>
                    ...
                    <input type="date" id="pengumuman" name="pengumuman" value="<?php echo e(old('pengumuman', $gelombang->pengumuman->format('Y-m-d'))); ?>" required
...
unset($__errorArgs, $__bag); ?>">
                            <option value="draft" <?php echo e(old('status', $gelombang->status) == 'draft' ? 'selected' : ''); ?>>Draft</option>
                            <option value="aktif" <?php echo e(old('status', $gelombang->status) == 'aktif' ? 'selected' : ''); ?>>Aktif</option>
                            <option value="selesai" <?php echo e(old('status', $gelombang->status) == 'selesai' ? 'selected' : ''); ?>>Selesai</option>
                        </select>
                    </div>
                    <div>
                        <label for="urutan" class="form-label">Urutan Tampil</label>
                        <input type="number" id="urutan" name="urutan" value="<?php echo e(old('urutan', $gelombang->urutan)); ?>" min="0"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\eka\.gemini\antigravity\scratch\smk-alstar\resources\views\admin\spmb\gelombang\edit.blade.php ENDPATH**/ ?>