<?php $__env->startSection('title', 'Info Seragam - SMK Al-Hidayah Lestari'); ?>
        ...
        <div class="relative">
            ...
            <div class="overflow-hidden px-4 md:px-12">
                <div class="flex transition-transform duration-500 ease-out" 
                    ...
                    <div class="w-full flex-shrink-0 px-2 md:px-4">
                        <div class="bg-gradient-to-br <?php echo e($item['warna_bg']); ?> rounded-3xl p-6 md:p-10 shadow-2xl transform transition-all duration-500 hover:scale-[1.02]">
                            
                            <!-- Day Badge -->
                            <div class="flex justify-between items-start mb-6">
                                <span class="inline-flex items-center gap-2 px-4 py-2 bg-white/80 backdrop-blur rounded-full text-sm font-bold <?php echo e($item['warna_text']); ?>">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                                    </svg>
                                    Hari <?php echo e($item['hari']); ?>

                                </span>
                                <span class="text-5xl md:text-6xl"><?php echo e($item['icon']); ?></span>
                            </div>

                            <!-- Content -->
                            <div class="text-center mb-8">
                                <h2 class="text-2xl md:text-3xl font-bold <?php echo e($item['warna_text']); ?> mb-2"><?php echo e($item['nama']); ?></h2>
                                <p class="text-lg <?php echo e($item['warna_text']); ?> opacity-80 font-medium"><?php echo e($item['warna']); ?></p>
                            </div>
                            ...
                            <div class="bg-white/50 backdrop-blur rounded-2xl p-6 md:p-8 mb-6 text-center">
                                <div class="w-32 h-32 md:w-40 md:h-40 mx-auto bg-white/80 rounded-full flex items-center justify-center shadow-lg mb-4">
                                    <span class="text-6xl md:text-7xl"><?php echo e($item['icon']); ?></span>
                                </div>
                                <p class="text-gray-700 text-sm md:text-base leading-relaxed"><?php echo e($item['deskripsi']); ?></p>
                            </div>
            ...
            <div class="flex justify-center gap-2 mt-6">
                ...
                <button @click="goTo(<?php echo e($index); ?>)" 
                        ...
                        :class="currentIndex === <?php echo e($index); ?> ? 'bg-white w-8' : 'bg-white/30 hover:bg-white/50'">
                </button>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
            ...
            <div class="flex justify-center gap-2 md:gap-4 mt-6 flex-wrap">
                ...
                <button @click="goTo(<?php echo e($index); ?>)" 
                        ...
                        :class="currentIndex === <?php echo e($index); ?> ? 'bg-white text-gray-900' : 'bg-white/10 text-white/70 hover:bg-white/20'">
...
function seragamSlider() {
    return {
        currentIndex: 0,
        totalSlides: <?php echo e(count($seragam)); ?>,
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\user\.gemini\antigravity\scratch\smkalstar\smkalstar\resources\views/seragam.blade.php ENDPATH**/ ?>