    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-4 md:mb-6 bg-white rounded-xl p-4 shadow-sm border border-gray-100">
            <div class="flex items-center justify-between mb-2">
                ...
                <span class="text-sm font-bold <?php echo e($progress['is_complete'] ? 'text-green-600' : 'text-primary'); ?>">
                ...
                <div class="flex flex-col md:flex-row md:items-center justify-between gap-3 md:gap-4">
                    ...
                    <div class="flex-1">
                        <div class="flex items-center gap-2 md:gap-3 mb-1 md:mb-2">
                            <div class="w-8 h-8 md:w-10 md:h-10 <?php echo e($isUploaded ? 'bg-green-100' : 'bg-primary/10'); ?> rounded-lg flex items-center justify-center flex-shrink-0">
                                <?php if($isUploaded): ?>
                            ...
                            <div class="min-w-0">
                                ...
                                <span class="inline-block px-2 py-0.5 text-xs font-medium rounded-full <?php echo e($isUploaded ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-600'); ?>">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\user\.gemini\antigravity\scratch\smkalstar\smkalstar\resources\views/ppdb/berkas.blade.php ENDPATH**/ ?>