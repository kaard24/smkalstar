...
<?php $__env->startSection('title', 'Tambah Hero SPMB - Admin Panel'); ?>
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="mb-8">
        ...
        <h1 class="text-2xl font-bold text-slate-800">Tambah Hero / Banner</h1>
        <p class="text-slate-600">Buat konten banner baru untuk halaman SPMB.</p>
    </div>

    
    <form action="<?php echo e(route('admin.spmb.hero.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
        <?php echo csrf_field(); ?>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
            ...
            <div class="grid md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="badge_text" value="<?php echo e(old('badge_text', 'Pendaftaran Dibuka!')); ?>" 
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <select name="badge_warna" class="w-full rounded-lg border-slate-300 focus:border-blue-500 focus:ring-blue-500">
                        <option value="blue" <?php echo e(old('badge_warna') == 'blue' ? 'selected' : ''); ?>>Biru (Blue)</option>
                        <option value="green" <?php echo e(old('badge_warna') == 'green' ? 'selected' : ''); ?>>Hijau (Green)</option>
                        <option value="orange" <?php echo e(old('badge_warna') == 'orange' ? 'selected' : ''); ?>>Oranye (Orange)</option>
                        <option value="purple" <?php echo e(old('badge_warna') == 'purple' ? 'selected' : ''); ?>>Ungu (Purple)</option>
                        <option value="red" <?php echo e(old('badge_warna') == 'red' ? 'selected' : ''); ?>>Merah (Red)</option>
                        <option value="indigo" <?php echo e(old('badge_warna') == 'indigo' ? 'selected' : ''); ?>>Indigo</option>
                    </select>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" name="judul_baris1" value="<?php echo e(old('judul_baris1', 'Sistem Penerimaan')); ?>" 
                        class="w-full rounded-lg border-slate-300 focus:border-blue-500 focus:ring-blue-500"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="judul_baris2" value="<?php echo e(old('judul_baris2', 'Murid Baru 2026/2027')); ?>" 
                        class="w-full rounded-lg border-slate-300 focus:border-blue-500 focus:ring-blue-500"
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
            ...
            <div>
                <textarea name="deskripsi" rows="3" 
                    class="w-full rounded-lg border-slate-300 focus:border-blue-500 focus:ring-blue-500"
                    placeholder="Deskripsi singkat tentang SPMB..."><?php echo e(old('deskripsi', 'Informasi lengkap mengenai pendaftaran, jadwal, persyaratan, dan biaya pendidikan di SMK Al-Hidayah Lestari')); ?></textarea>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
            ...
            <div class="grid md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="tahun_ajaran" value="<?php echo e(old('tahun_ajaran', '2026/2027')); ?>" 
                        class="w-full rounded-lg border-slate-300 focus:border-blue-500 focus:ring-blue-500"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="number" name="jumlah_gelombang_tampil" value="<?php echo e(old('jumlah_gelombang_tampil', 2)); ?>" min="1" max="5"
                        class="w-full rounded-lg border-slate-300 focus:border-blue-500 focus:ring-blue-500">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mt-4 space-y-3">
                ...
                <label class="flex items-center gap-3 cursor-pointer">
                    <input type="checkbox" name="tampilkan_gelombang" value="1" <?php echo e(old('tampilkan_gelombang', true) ? 'checked' : ''); ?>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6" x-data="{ bgType: '<?php echo e(old('bg_type', 'default')); ?>' }">
            <h2 class="text-lg font-semibold text-slate-800 mb-4 flex items-center gap-2">
                <svg class="w-5 h-5 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <select name="bg_type" x-model="bgType" class="w-full rounded-lg border-slate-300 focus:border-blue-500 focus:ring-blue-500">
                        <option value="default" <?php echo e(old('bg_type') == 'default' ? 'selected' : ''); ?>>Default (Gradien Putih-Biru)</option>
                        <option value="color" <?php echo e(old('bg_type') == 'color' ? 'selected' : ''); ?>>Warna Solid</option>
                        <option value="image" <?php echo e(old('bg_type') == 'image' ? 'selected' : ''); ?>>Gambar</option>
                    </select>
                ...
                <div x-show="bgType === 'color'" x-transition>
                    ...
                    <div class="flex items-center gap-3">
                        <input type="color" name="bg_value" value="<?php echo e(old('bg_value', '#ffffff')); ?>" 
                            class="h-10 w-20 rounded border-slate-300">
                        <input type="text" name="bg_value" value="<?php echo e(old('bg_value', '#ffffff')); ?>" 
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\eka\.gemini\antigravity\scratch\smk-alstar\resources\views\admin\spmb\hero\create.blade.php ENDPATH**/ ?>