...
<?php $__env->startSection('title', 'Edit Pengaturan Pembayaran - Admin Panel'); ?>

<?php $__env->startSection('content'); ?>
    
    <div class="mb-6">
        <div class="flex items-center gap-2 text-sm text-slate-500 mb-2">
            <a href="<?php echo e(route('admin.pembayaran-pengaturan.index')); ?>" class="hover:text-[#4276A3]">Pengaturan Pembayaran</a>
    ...
    <div class="card p-6 max-w-2xl">
        <form action="<?php echo e(route('admin.pembayaran-pengaturan.update', $pengaturan)); ?>" method="POST">
            <?php echo csrf_field(); ?>
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" id="nama_penerima" name="nama_penerima" 
                           value="<?php echo e(old('nama_penerima', $pengaturan->nama_penerima)); ?>" required
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="nomor_rekening" name="nomor_rekening" 
                               value="<?php echo e(old('nomor_rekening', $pengaturan->nomor_rekening)); ?>"
                    ...
                    <div>
                        ...
                        <input type="text" id="bank" name="bank" 
                               value="<?php echo e(old('bank', $pengaturan->bank)); ?>"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" id="biaya" name="biaya" 
                               value="<?php echo e(old('biaya', $pengaturan->biaya)); ?>" required min="0"
                               placeholder="250000"
                ...
                <div>
                    ...
                    <textarea id="keterangan" name="keterangan" rows="3"
                              ...
                              class="w-full px-3 py-2 text-sm border border-slate-300 rounded-md focus:outline-none focus:border-[#4276A3] focus:ring-1 focus:ring-[#4276A3]"><?php echo e(old('keterangan', $pengaturan->keterangan)); ?></textarea>
                ...
                <div class="p-3 bg-slate-50 rounded-lg border border-slate-200">
                    <label class="flex items-start gap-3 cursor-pointer">
                        <input type="checkbox" name="is_active" value="1" <?php echo e(old('is_active', $pengaturan->is_active) ? 'checked' : ''); ?>
                ...
                <div class="p-3 bg-blue-50 rounded-lg border border-blue-100">
                    <div class="flex gap-2">
                        ...
                        <div class="text-xs text-slate-600">
                            ...
                            <p>Dibuat oleh: <?php echo e($pengaturan->createdBy?->nama ?? '-'); ?> pada <?php echo e($pengaturan->created_at->format('d/m/Y H:i')); ?></p>
                            <p>Terakhir update: <?php echo e($pengaturan->updatedBy?->nama ?? '-'); ?> pada <?php echo e($pengaturan->updated_at->format('d/m/Y H:i')); ?></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-6 flex justify-end gap-2 pt-4 border-t border-slate-200">
                <a href="<?php echo e(route('admin.pembayaran-pengaturan.index')); ?>" class="btn btn-secondary">
                    Batal
                </a>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\eka\.gemini\antigravity\scratch\smk-alstar\resources\views\admin\pembayaran-pengaturan\edit.blade.php ENDPATH**/ ?>