...
<?php $__env->startSection('title', 'Edit Sejarah - Admin Panel'); ?>

<?php $__env->startSection('content'); ?>
<div class="max-w-4xl mx-auto">
    <div class="mb-8">
        <h1 class="text-2xl font-bold text-slate-800">Edit Sejarah Sekolah</h1>
        <p class="text-slate-600">Kelola konten sejarah sekolah yang ditampilkan ke publik.</p>
    </div>
    ...
    <form action="<?php echo e(route('admin.profil-sekolah.update-sejarah')); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
        <?php echo csrf_field(); ?>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-100 overflow-hidden">
            ...
            <div class="p-6 space-y-6">
                <div>
                    ...
                    <input type="text" id="sejarah_judul" name="sejarah_judul" value="<?php echo e(old('sejarah_judul', $profil->sejarah_judul)); ?>" required
                ...
                <div>
                    ...
                    <textarea id="sejarah_konten" name="sejarah_konten" rows="8" required
                        class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-[#4276A3] focus:border-[#4276A3] transition"><?php echo e(old('sejarah_konten', $profil->sejarah_konten)); ?></textarea>
                ...
                <div>
                    ...
                    <?php if(!empty($profil->sejarah_gambar) && count($profil->sejarah_gambar_urls) > 0): ?>
                    <div class="grid grid-cols-2 md:grid-cols-3 gap-4 mb-4">
                        <?php $__currentLoopData = $profil->sejarah_gambar_urls; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="relative group">
                            <img src="<?php echo e($url); ?>" alt="Gambar Sejarah <?php echo e($index + 1); ?>" class="w-full h-32 object-cover rounded-lg border" loading="lazy" decoding="async">
                            <label class="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center cursor-pointer rounded-lg">
                                <input type="checkbox" name="hapus_gambar[]" value="<?php echo e($index); ?>" class="peer sr-only">
                            ...
                            <div class="absolute top-2 right-2">
                                <input type="checkbox" name="hapus_gambar[]" value="<?php echo e($index); ?>" class="w-5 h-5 text-[#991B1B] rounded border-slate-300 focus:ring-red-500">
                            </div>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
        ...
        <div class="flex justify-end gap-4">
            <a href="<?php echo e(url('/profil')); ?>#sejarah" target="_blank" class="btn btn-outline-secondary btn-lg">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\eka\.gemini\antigravity\scratch\smk-alstar\resources\views/admin/profil-sejarah.blade.php ENDPATH**/ ?>