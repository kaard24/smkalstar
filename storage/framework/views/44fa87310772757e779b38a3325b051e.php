...
<?php $__env->startSection('title', 'Tambah Program Keahlian - Admin Panel'); ?>
...
<div class="max-w-4xl mx-auto">
    ...
    <form action="<?php echo e(route('admin.jurusan.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
        <?php echo csrf_field(); ?>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
            ...
            <div>
                <textarea name="deskripsi" rows="3" 
                    class="w-full rounded-lg border-slate-300 focus:border-blue-500 focus:ring-blue-500"
                    placeholder="Deskripsi singkat tentang jurusan (tampil di hero & list)..."><?php echo e(old('deskripsi')); ?></textarea>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
            ...
            <div>
                <textarea name="deskripsi_lengkap" rows="6" 
                    class="w-full rounded-lg border-slate-300 focus:border-blue-500 focus:ring-blue-500"
                    placeholder="Deskripsi lengkap tentang jurusan (tampil di halaman detail)..."><?php echo e(old('deskripsi_lengkap')); ?></textarea>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\eka\.gemini\antigravity\scratch\smk-alstar\resources\views\admin\jurusan\create.blade.php ENDPATH**/ ?>