        ...
        <div class="container mx-auto px-4">
            <div class="flex justify-between items-center h-16">
                ...
                <nav class="hidden lg:flex items-center gap-1">
                    ...
                    <!-- More Menu Dropdown -->
                    <div class="relative" x-data="{ open: false }" :class="{'bg-[#4276A3]/20 rounded-lg border-l-2 border-[#4276A3]': <?php echo e(request()->is('admin/struktur-organisasi*') || request()->is('admin/fasilitas*') || request()->is('admin/ekstrakurikuler*') || request()->is('admin/prestasi*') || request()->is('admin/galeri*') || request()->is('admin/profil-sekolah*') ? 'true' : 'false'); ?>">
                        <button @click="open = !open" 
                                class="nav-item flex items-center gap-1 <?php echo e(request()->is('admin/struktur-organisasi*') || request()->is('admin/fasilitas*') || request()->is('admin/ekstrakurikuler*') || request()->is('admin/prestasi*') || request()->is('admin/galeri*') || request()->is('admin/profil-sekolah*') ? 'text-white' : 'text-slate-300 hover:bg-white/5 hover:text-white'); ?>">
                            <span>Lainnya</span>
