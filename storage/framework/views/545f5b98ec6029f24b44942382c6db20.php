            ...
            <div class="space-y-3 text-sm">
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div>
                        ...
                        <span class="font-medium text-slate-800"><?php echo e($siswa->tinggi_badan ?? '-'); ?></span>
                    </div>
                    <div>
                        <span class="block text-xs text-slate-500">Berat (kg)</span>
                        <span class="font-medium text-slate-800"><?php echo e($siswa->berat_badan ?? '-'); ?></span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card p-4">
                ...
                <div class="space-y-3 text-sm">
                    ...
                    <div>
                        ...
                        <span class="font-medium text-[#4276A3]"><?php echo e($siswa->pendaftaran->jurusan2->nama ?? '-'); ?></span>
                    </div>
                    <div>
            ...
            <div class="card p-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                    ...
                    <div>
                        ...
                        <span class="font-medium text-slate-800"><?php echo e($pembayaran?->created_at?->format('d M Y') ?? '-'); ?></span>
                    </div>
                </div>
                ...
                <div class="mt-3 pt-3 border-t border-slate-100">
                    <div class="flex items-center justify-between mb-2">
                        ...
                        <?php if($pembayaran->isVerified()): ?>
                        <span class="text-xs text-slate-500">Diverifikasi: <?php echo e($pembayaran->verified_at?->format('d M Y H:i')); ?></span>
                        <?php endif; ?>
                    </div>
