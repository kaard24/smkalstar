                    ...
                    <tr class="hover:bg-slate-50/50 transition-colors">
                        <td class="px-4 py-3">
                            <div class="flex items-start gap-3">
                                ...
                                <img src="<?php echo e($item->gambar_utama); ?>" alt="" class="w-14 h-14 object-cover rounded-md border border-slate-200 flex-shrink-0" loading="lazy" decoding="async">
                                <?php else: ?>
                                ...
                                <?php endif; ?>
                                <div class="min-w-0">
                                    <h4 class="text-sm font-medium text-slate-800 truncate" title="<?php echo e($item->judul); ?>"><?php echo e(Str::limit($item->judul, 50)); ?></h4>
                                    <p class="text-xs text-slate-500 mt-0.5 line-clamp-2"><?php echo e(Str::limit(strip_tags($item->isi), 90)); ?></p>
                                </div>
                            </div>
                        </td>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\eka\.gemini\antigravity\scratch\smk-alstar\resources\views/admin/berita/index.blade.php ENDPATH**/ ?>