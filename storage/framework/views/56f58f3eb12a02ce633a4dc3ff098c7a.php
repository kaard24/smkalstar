...
<?php $__env->startSection('title', 'Edit Program Keahlian - Admin Panel'); ?>

<?php $__env->startSection('content'); ?>
<div class="max-w-4xl mx-auto">
    
    <div class="mb-8">
        <a href="<?php echo e(route('admin.jurusan.index')); ?>" class="text-slate-500 hover:text-slate-700 flex items-center gap-1 mb-4">
        ...
        <p class="text-slate-600">Ubah data jurusan <?php echo e($jurusan->nama); ?>.</p>
    </div>

    
    <form action="<?php echo e(route('admin.jurusan.update', $jurusan)); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
        <?php echo csrf_field(); ?>
            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-slate-300 border-dashed rounded-xl hover:border-blue-400 transition cursor-pointer relative" onclick="document.getElementById('logo').click()">
                        <div class="space-y-1 text-center <?php echo e($jurusan->logo_url ? 'hidden' : ''); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-slate-300 border-dashed rounded-xl hover:border-blue-400 transition cursor-pointer relative" onclick="document.getElementById('gambar').click()">
                        <div class="space-y-1 text-center <?php echo e($jurusan->gambar_url ? 'hidden' : ''); ?>">
                            <svg class="mx-auto h-12 w-12 text-slate-400" stroke="currentColor" fill="none" viewBox="0 0 48 48">
                                <path d="M28 8H12a4 4 0 00-4 4v20m32-12v8m0 0v8a4 4 0 01-4 4H12a4 4 0 01-4-4v-4m32-4l-3.172-3.172a4 4 0 00-5.656 0L28 28M8 32l9.172-9.172a4 4 0 015.656 0L28 28m0 0l4 4m4-24h8m-4-4v8m-12 4h.02" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                            <div class="flex text-sm text-slate-600 justify-center">
                ...
                <?php if($jurusan->kompetensiItems->count() > 0): ?>
                    ...
                    <div class="detail-item-kompetensi border border-slate-200 rounded-lg p-3">
                        <div class="flex justify-between items-start mb-2">
                            <input type="text" name="kompetensi_judul[]" value="<?php echo e($item->judul); ?>"
                        ...
                        <textarea name="kompetensi_deskripsi[]" rows="2" 
                            ...
                            placeholder="Deskripsi kompetensi (opsional)..."><?php echo e($item->deskripsi); ?></textarea>
                    </div>
            ...
            <div id="mapel-container" class="space-y-3">
                <?php if($jurusan->mapelItems->count() > 0): ?>
                    ...
                    <div class="detail-item-mapel border border-slate-200 rounded-lg p-3">
                        <div class="flex justify-between items-start mb-2">
                            <input type="text" name="mapel_judul[]" value="<?php echo e($item->judul); ?>"
                                class="flex-1 rounded-lg border-slate-300 focus:border-blue-500 focus:ring-blue-500 text-sm font-medium"
                        ...
                        <textarea name="mapel_deskripsi[]" rows="2" 
                            class="w-full rounded-lg border-slate-300 focus:border-blue-500 focus:ring-blue-500 text-sm"
                            placeholder="Deskripsi mata pelajaran (opsional)..."><?php echo e($item->deskripsi); ?></textarea>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php else: ?>
            ...
            <div id="info-program-container" class="space-y-3">
                <?php if($jurusan->infoProgram->count() > 0): ?>
                    ...
                    <div class="flex gap-3 info-program-item">
                        <div class="flex-1">
                            <input type="text" name="info_label[]" value="<?php echo e($info->label); ?>" 
                                class="w-full rounded-lg border-slate-300 focus:border-blue-500 focus:ring-blue-500 text-sm"
                                placeholder="Label (contoh: Durasi)">
                        </div>
                        <div class="flex-1">
                            <input type="text" name="info_value[]" value="<?php echo e($info->value); ?>" 
                                class="w-full rounded-lg border-slate-300 focus:border-blue-500 focus:ring-blue-500 text-sm"
            ...
            <div id="karir-container" class="space-y-3">
                <?php if($jurusan->karirItems->count() > 0): ?>
                    ...
                    <div class="detail-item-karir border border-slate-200 rounded-lg p-3">
                        <div class="flex justify-between items-start mb-2">
                            <input type="text" name="karir_judul[]" value="<?php echo e($item->judul); ?>"
                                class="flex-1 rounded-lg border-slate-300 focus:border-blue-500 focus:ring-blue-500 text-sm font-medium"
                        ...
                        <textarea name="karir_deskripsi[]" rows="2" 
                            class="w-full rounded-lg border-slate-300 focus:border-blue-500 focus:ring-blue-500 text-sm"
                            placeholder="Deskripsi karir (opsional)..."><?php echo e($item->deskripsi); ?></textarea>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php else: ?>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
            ...
            <div id="kegiatan-container" class="space-y-4">
                <?php if($jurusan->kegiatan->count() > 0): ?>
                    ...
                    <div class="kegiatan-item border border-slate-200 rounded-xl p-4" data-index="<?php echo e($index); ?>">
                        <input type="hidden" name="kegiatan_id[]" value="<?php echo e($kegiatan->id); ?>">
                        <div class="flex justify-between items-start mb-3">
                            <input type="text" name="kegiatan_judul[]" value="<?php echo e($kegiatan->judul); ?>"
                        ...
                        <textarea name="kegiatan_deskripsi[]" rows="2" 
                            ...
                            placeholder="Deskripsi kegiatan (opsional)..."><?php echo e($kegiatan->deskripsi); ?></textarea>
                        
                        
                        <div class="mb-2">
                            <label class="block text-xs font-medium text-slate-600 mb-2">Gambar Kegiatan (bisa lebih dari satu)</label>
                            <div class="flex flex-wrap gap-2 mb-2">
                                <?php $__currentLoopData = $kegiatan->gambar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gambar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="relative group" id="kegiatan-gambar-<?php echo e($gambar->id); ?>">
                                    <img src="<?php echo e($gambar->gambar_url); ?>" class="w-20 h-20 object-cover rounded-lg border border-slate-200">
                                    <button type="button" onclick="deleteKegiatanGambar(<?php echo e($gambar->id); ?>)" 
                            ...
                            <div class="flex items-center gap-2">
                                <label class="flex items-center gap-2 px-4 py-2 bg-slate-100 hover:bg-slate-200 rounded-lg cursor-pointer transition text-sm text-slate-700">
                                    ...
                                    Tambah Gambar
                                    <input type="file" name="kegiatan_gambar_<?php echo e($index); ?>[]" multiple accept="image/*" class="hidden" onchange="previewKegiatanGambar(this, <?php echo e($index); ?>)">
                                </label>
                                <span class="text-xs text-slate-500">PNG, JPG, WEBP up to 2MB per gambar</span>
                            </div>
                            <div id="preview-kegiatan-<?php echo e($index); ?>" class="flex flex-wrap gap-2 mt-2"></div>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php else: ?>
...
function deleteKegiatanGambar(gambarId) {
    ...
    fetch(`<?php echo e(url('admin/jurusan/kegiatan-gambar')); ?>/${gambarId}`, {
        method: 'DELETE',
        headers: {
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\eka\.gemini\antigravity\scratch\smk-alstar\resources\views\admin\jurusan\edit.blade.php ENDPATH**/ ?>