        ...
        <div class="flex justify-between items-center h-14 md:h-16">
            ...
            <nav class="hidden md:flex space-x-1 items-center">
                ...
                <div class="pl-2 border-l border-gray-200 flex items-center ml-2">
                    <a href="<?php echo e(url('/ppdb/info')); ?>" class="px-3 py-2 text-primary font-semibold hover:text-secondary transition rounded-md hover:bg-sky-50 text-sm tracking-wide">Info SPMB</a>
                </div>
            </nav>
            ...
            <div class="hidden md:flex items-center space-x-2">
                <?php if(auth()->guard('ppdb')->check()): ?>
                    <div class="relative" x-data="{ open: false }" @click.away="open = false">
                        <button @click="open = !open" class="flex items-center gap-2 text-gray-700 hover:text-primary transition focus:outline-none px-2 py-1 rounded-lg hover:bg-gray-50" aria-haspopup="true" :aria-expanded="open.toString()" aria-label="Menu pengguna <?php echo e(auth('ppdb')->user()->nama ?: 'Siswa'); ?>">
            ...
            <div class="md:hidden flex items-center">
                <button type="button" class="p-2 rounded-lg text-gray-500 hover:text-gray-700 hover:bg-gray-100 transition" onclick="document.getElementById('mobile-menu').classList.toggle('hidden')" aria-label="Toggle menu navigasi" aria-expanded="false" aria-controls="mobile-menu">
    ...
    <div class="hidden md:hidden bg-white border-t border-gray-100" id="mobile-menu">
        <div class="px-4 py-3">
            ...
            <div class="grid grid-cols-3 gap-2">
                ...
                <a href="<?php echo e(url('/jurusan')); ?>" class="flex flex-col items-center justify-center p-3 rounded-lg text-xs font-medium <?php echo e(request()->is('jurusan') ? 'bg-primary text-white' : 'text-gray-700 hover:bg-gray-50'); ?>">
                ...
                <a href="<?php echo e(url('/ppdb/info')); ?>" class="flex flex-col items-center justify-center p-3 rounded-lg text-xs font-bold <?php echo e(request()->is('ppdb*') ? 'bg-primary text-white' : 'text-primary bg-sky-50'); ?>">
            ...
            <?php if(auth()->guard('ppdb')->check()): ?>
                <div class="border-t border-gray-200 pt-3 mt-3">
                    <div class="flex items-center gap-3 mb-2">
                        ...
                        <span class="text-sm font-medium text-gray-700"><?php echo e(auth('ppdb')->user()->nama ?: 'Siswa'); ?></span>
                    </div>
                    <div class="grid grid-cols-2 gap-2">
                        <a href="<?php echo e(route('ppdb.dashboard')); ?>" class="flex items-center justify-center gap-2 px-3 py-2 rounded-lg text-xs font-medium <?php echo e(request()->routeIs('ppdb.dashboard') ? 'bg-primary text-white' : 'text-gray-700 hover:bg-gray-50 border border-gray-200'); ?>">
            ...
            <?php else: ?>
                <div class="border-t border-gray-200 pt-3 mt-3 grid grid-cols-2 gap-2">
                    ...
                    <a href="<?php echo e(url('/ppdb/register')); ?>" class="flex items-center justify-center px-3 py-2 rounded-lg text-xs font-bold text-white bg-primary hover:bg-secondary">
                        Daftar
                    </a>
                </div>
            <?php endif; ?>
