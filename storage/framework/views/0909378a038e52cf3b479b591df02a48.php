<header class="bg-white sticky top-0 z-50 safe-area-inset-top">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-14 lg:h-16">
            <!-- Logo -->
            <a href="<?php echo e(url('/')); ?>" class="flex items-center gap-2 min-w-0 max-w-[calc(100%-3.5rem)] lg:max-w-none">
                <img class="h-8 w-8 lg:h-9 lg:w-9 rounded-full object-cover flex-shrink-0" src="<?php echo e(asset('images/logo.webp')); ?>" alt="Logo SMK Al-Hidayah Lestari" loading="lazy" decoding="async">
