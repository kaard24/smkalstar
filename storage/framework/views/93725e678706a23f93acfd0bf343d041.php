...
<?php $__env->startSection('title', 'Syarat dan Ketentuan - SMK Al-Hidayah Lestari'); ?>
    ...
    <section class="py-12 md:py-16 bg-white">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div class="prose prose-gray max-w-none">
                <p class="text-gray-600 mb-6">Terakhir diperbarui: <?php echo e(date('d F Y')); ?></p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\eka\.gemini\antigravity\scratch\smk-alstar\resources\views\legal\terms.blade.php ENDPATH**/ ?>