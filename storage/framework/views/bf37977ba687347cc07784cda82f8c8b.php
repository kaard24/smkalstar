        ...
        <div class="container relative z-20 mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
            <div class="max-w-3xl text-white">
                ...
                <div class="flex flex-col sm:flex-row gap-3">
                    <a href="<?php echo e(url('/ppdb/register')); ?>" class="bg-primary hover:bg-primary-dark text-white font-semibold px-6 py-3 md:px-8 md:py-4 rounded-xl shadow-lg hover:shadow-green-500/30 transition-all transform hover:-translate-y-1 text-center flex items-center justify-center gap-2 group text-sm md:text-base">
                        Daftar Sekarang
    ...
    <section class="py-12 md:py-20 lg:py-32 bg-gray-900 relative overflow-hidden">
        ...
        <div class="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-3 md:gap-5 justify-center">
                <a href="<?php echo e(url('/ppdb/register')); ?>" class="bg-primary hover:bg-primary-dark text-white font-bold px-8 py-3 md:px-10 md:py-5 rounded-xl shadow-lg shadow-green-900/20 transition transform hover:-translate-y-1 text-sm md:text-base">
                    Daftar Sekarang
                </a>
