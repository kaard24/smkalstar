...
<?php $__env->startSection('title', 'Tambah Foto Galeri - Admin Panel'); ?>
...
<div class="max-w-2xl mx-auto">
    ...
    <form action="<?php echo e(route('admin.galeri.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
        <?php echo csrf_field(); ?>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
            ...
            <div class="p-6 space-y-4">
                ...
                <div>
                    ...
                    <input type="text" id="keterangan" name="keterangan" value="<?php echo e(old('keterangan')); ?>"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\eka\.gemini\antigravity\scratch\smk-alstar\resources\views\admin\galeri\create.blade.php ENDPATH**/ ?>