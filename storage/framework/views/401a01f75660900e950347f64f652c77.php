...
<div class="max-w-4xl mx-auto">
    ...
    <div class="mb-6">
        <a href="<?php echo e(route('admin.berita.index')); ?>" class="inline-flex items-center gap-2 text-slate-600 hover:text-[#4276A3] font-semibold text-lg">
    ...
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-slate-800 mb-2">Tambah Berita Baru</h1>
        <p class="text-lg text-slate-600">Buat artikel berita untuk ditampilkan di website sekolah</p>
    </div>
    ...
    <form action="<?php echo e(route('admin.berita.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
        <?php echo csrf_field(); ?>
        ...
        <div class="bg-white rounded-xl card-solid overflow-hidden">
            ...
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <p class="text-base text-slate-500 mt-2">Tips: Gunakan judul yang jelas dan menarik pembaca</p>
                </div>
                ...
                <div>
                    ...
                    <textarea id="isi" name="isi" rows="12" required
                              ...
                              placeholder="Tulis isi berita lengkap di sini..."><?php echo e(old('isi')); ?></textarea>
                ...
                <div>
                    <label for="gambar" class="block text-lg font-bold text-slate-800 mb-3">
                        Gambar Berita <span class="text-slate-500 font-normal">(Opsional)</span>
                    </label>
                    <div class="border-2 border-dashed border-slate-300 rounded-xl p-6 bg-slate-50">
                        ...
                        <p class="text-base text-slate-500 mt-3">
                ...
                <div>
                    <label for="published_at" class="block text-lg font-bold text-slate-800 mb-3">
                        Tanggal Publish <span class="text-slate-500 font-normal">(Opsional)</span>
                    </label>
                    <input type="datetime-local" id="published_at" name="published_at" 
                           value="<?php echo e(old('published_at', now()->format('Y-m-d\TH:i'))); ?>"
                           class="w-full px-4 input-large border-2 border-slate-300 rounded-xl focus:ring-2 focus:ring-[#4276A3] focus:border-[#4276A3]">
                    <p class="text-base text-slate-500 mt-2">Jika dikosongkan, berita akan dipublikasikan sekarang</p>
                </div>
            </div>
        </div>
