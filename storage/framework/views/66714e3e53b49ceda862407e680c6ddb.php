        ...
        <table class="min-w-full divide-y divide-slate-200">
            ...
            <tbody class="bg-white divide-y divide-slate-200">
                ...
                <tr class="hover:bg-slate-50">
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-500"><?php echo e($item->urutan); ?></td>
                    <td class="px-6 py-4 whitespace-nowrap">
                        <?php if($item->gambar_url): ?>
                        <img src="<?php echo e($item->gambar_url); ?>" alt="<?php echo e($item->nama); ?>" class="w-16 h-12 object-cover rounded" loading="lazy" decoding="async">
                        <?php else: ?>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-slate-800"><?php echo e($item->kode); ?></td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-800"><?php echo e($item->nama); ?></td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-500"><?php echo e($item->kategori ?? '-'); ?></td>
                    <td class="px-6 py-4 whitespace-nowrap">
                        <?php if($item->aktif): ?>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <div class="flex items-center justify-end gap-2">
                            <a href="<?php echo e(route('admin.jurusan.edit', $item)); ?>" class="btn btn-sm btn-warning">
