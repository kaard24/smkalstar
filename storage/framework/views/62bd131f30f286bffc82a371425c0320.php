<?php $__env->startSection('title', 'Login SPMB - SMK Al-Hidayah Lestari'); ?>
    ...
    <div class="max-w-md w-full">
        ...
        <div class="text-center mb-8">
            <div class="flex justify-center mb-4">
                <img src="<?php echo e(asset('images/logo.jpg')); ?>" alt="Logo SMK Al-Hidayah Lestari" class="w-24 h-24 object-contain">
            </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
            ...
            <!-- Login Form -->
            <form action="<?php echo e(route('login.submit')); ?>" method="POST" class="space-y-5" id="loginForm">
                <?php echo csrf_field(); ?>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input 
                            ...
                            maxlength="10"
                            required
                            class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-primary focus:border-primary transition <?php $__errorArgs = ['nisn'];
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input 
                            ...
                            required
                            class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-primary focus:border-primary transition <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="text-center">
                <p class="text-gray-600 text-sm">
                    Belum punya akun?
                    <a href="<?php echo e(route('register')); ?>" class="text-primary font-semibold hover:underline">Daftar Sekarang</a>
                </p>
            </div>
        </div>
        ...
        <div class="text-center mt-6">
            <a href="<?php echo e(url('/')); ?>" class="text-gray-500 hover:text-primary transition text-sm">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\user\.gemini\antigravity\scratch\smkalstar\smkalstar\resources\views/auth/login.blade.php ENDPATH**/ ?>