        ...
        <div class="bg-white rounded-xl border border-slate-200 p-5">
            ...
            <div class="relative">
                ...
                <div class="space-y-4">
                    ...
                    <!-- Step 6: Pembayaran -->
                    <div class="relative flex gap-4">
                        <div class="w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 z-10 <?php echo e($pembayaranComplete ? 'bg-blue-500' : ($biodataComplete && $orangTuaComplete && $jurusanComplete ? 'bg-blue-100 border-2 border-blue-500' : 'bg-slate-200')); ?>">
                            <?php if($pembayaranComplete): ?>
                                <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7"/>
                                </svg>
                            <?php elseif($biodataComplete && $orangTuaComplete && $jurusanComplete): ?>
                        ...
                        <div class="flex-1 pt-1">
                            <div class="flex items-center justify-between mb-1">
                                <h4 class="font-medium <?php echo e($pembayaranComplete ? 'text-slate-800' : ($biodataComplete && $orangTuaComplete && $jurusanComplete ? 'text-blue-600' : 'text-slate-600')); ?>">Pembayaran</h4>
                                <?php if($pembayaranComplete): ?>
                                    <span class="text-xs text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded">Selesai</span>
                                <?php elseif($pembayaran && $pembayaran->isPending()): ?>
                                    <span class="text-xs text-amber-600 bg-amber-50 px-2 py-0.5 rounded">Menunggu Verifikasi</span>
                                <?php elseif($pembayaran && $pembayaran->isRejected()): ?>
                                    <span class="text-xs text-red-600 bg-red-50 px-2 py-0.5 rounded">Ditolak</span>
                                <?php elseif($biodataComplete && $orangTuaComplete && $jurusanComplete): ?>
                                    <a href="<?php echo e(route('spmb.pembayaran')); ?>" class="text-xs text-white bg-blue-500 hover:bg-blue-600 px-3 py-1 rounded transition-colors">Bayar</a>
                                <?php else: ?>
                            ...
                            <?php if($pembayaran && $pembayaran->isRejected() && $pembayaran->catatan_admin): ?>
                                <p class="text-xs text-red-600 mt-1">Alasan: <?php echo e($pembayaran->catatan_admin); ?></p>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="relative flex gap-4">
                        <div class="w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 z-10 <?php echo e($wawancaraComplete ? 'bg-blue-500' : ($pembayaranComplete ? 'bg-blue-100 border-2 border-blue-500' : 'bg-slate-200')); ?>">
                            <?php if($wawancaraComplete): ?>
                                <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7"/>
                                </svg>
                            <?php elseif($pembayaranComplete): ?>
                                <span class="w-2 h-2 bg-blue-500 rounded-full"></span>
                            <?php else: ?>
                        ...
                        <div class="flex-1 pt-1">
                            <div class="flex items-center justify-between mb-1">
                                <h4 class="font-medium <?php echo e($wawancaraComplete ? 'text-slate-800' : ($pembayaranComplete ? 'text-blue-600' : 'text-slate-600')); ?>">Tes & Wawancara</h4>
                                <?php if($wawancaraComplete): ?>
                                    <span class="text-xs text-blue-600 bg-blue-50 px-2 py-0.5 rounded">Selesai</span>
                                <?php elseif($pembayaranComplete): ?>
        ...
        <?php elseif(!$biodataComplete || !$orangTuaComplete || !$jurusanComplete): ?>
            ...
            <div class="mt-6 bg-amber-50 border border-amber-200 rounded-xl p-5">
                <div class="flex flex-col sm:flex-row sm:items-center gap-4">
                    ...
                    <a href="<?php echo e(route('spmb.lengkapi-data')); ?>" class="inline-flex items-center gap-2 px-5 py-2.5 bg-amber-500 text-white rounded-lg font-medium hover:bg-amber-600 transition-colors">
                        Lengkapi Data
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"/>
                        </svg>
        ...
        <?php elseif(!$pembayaranComplete): ?>
            ...
            <div class="mt-6 bg-blue-50 border border-blue-200 rounded-xl p-5">
                <div class="flex flex-col sm:flex-row sm:items-center gap-4">
                    ...
                    <a href="<?php echo e(route('spmb.pembayaran')); ?>" class="inline-flex items-center gap-2 px-5 py-2.5 bg-blue-500 text-white rounded-lg font-medium hover:bg-blue-600 transition-colors">
                        Bayar Sekarang
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"/>
                        </svg>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\eka\.gemini\antigravity\scratch\smk-alstar\resources\views/spmb/status.blade.php ENDPATH**/ ?>