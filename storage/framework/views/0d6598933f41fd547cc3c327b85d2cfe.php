...
<?php $__env->startSection('content'); ?>
    ...
    <div class="grid md:grid-cols-4 gap-5 mb-8">
        ...
        <a href="<?php echo e(route('admin.pendaftar.index')); ?>" class="stat-card card p-5 hover:border-[#4276A3] transition group">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-slate-800"><?php echo e($totalPendaftar ?? 0); ?></p>
                </div>
            </div>
        </a>

        
        <a href="<?php echo e(route('admin.pendaftar.index')); ?>?status=lengkap" class="stat-card card p-5 hover:border-[#047857] transition group" style="border-left-color: #047857;">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-slate-800"><?php echo e($dataLengkap ?? 0); ?></p>
                </div>
            </div>
        </a>

        
        <a href="<?php echo e(route('admin.pendaftar.index')); ?>" class="stat-card card p-5 hover:border-[#B45309] transition group" style="border-left-color: #B45309;">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-slate-800"><?php echo e($berkasLengkap ?? 0); ?></p>
                </div>
            </div>
        </a>
        ...
        <a href="<?php echo e(route('admin.pendaftar.index')); ?>" class="stat-card card p-5 hover:border-[#4276A3] transition group">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-slate-800"><?php echo e($siapTes ?? 0); ?></p>
                </div>
            </div>
        </a>
    </div>
    ...
    <div class="card p-6 mb-8">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <a href="<?php echo e(route('admin.jurusan.index')); ?>" class="group flex flex-col items-center gap-3 p-5 bg-slate-50 border border-slate-200 rounded-xl hover:border-slate-400 hover:shadow-sm transition text-center">
            ...
            <a href="<?php echo e(route('admin.ekstrakurikuler.index')); ?>" class="group flex flex-col items-center gap-3 p-5 bg-slate-50 border border-slate-200 rounded-xl hover:border-slate-400 hover:shadow-sm transition text-center">
                <div class="w-12 h-12 bg-slate-200 rounded-xl flex items-center justify-center group-hover:bg-slate-300 transition">
                    <svg class="w-6 h-6 text-slate-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="<?php echo e(route('admin.prestasi.index')); ?>" class="group flex flex-col items-center gap-3 p-5 bg-slate-50 border border-slate-200 rounded-xl hover:border-slate-400 hover:shadow-sm transition text-center">
                <div class="w-12 h-12 bg-slate-200 rounded-xl flex items-center justify-center group-hover:bg-slate-300 transition">
                    <svg class="w-6 h-6 text-slate-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="<?php echo e(route('admin.galeri.index')); ?>" class="group flex flex-col items-center gap-3 p-5 bg-slate-50 border border-slate-200 rounded-xl hover:border-slate-400 hover:shadow-sm transition text-center">
                <div class="w-12 h-12 bg-slate-200 rounded-xl flex items-center justify-center group-hover:bg-slate-300 transition">
                    <svg class="w-6 h-6 text-slate-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                    </svg>
