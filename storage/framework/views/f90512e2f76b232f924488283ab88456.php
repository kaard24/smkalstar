...
<?php $__env->startSection('title', 'Alur Pendaftaran - Admin Panel'); ?>
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-8 mb-8">
        ...
        <div class="relative pl-8 space-y-8 before:absolute before:left-3 before:top-2 before:bottom-2 before:w-0.5 before:bg-gradient-to-b before:from-primary before:to-slate-200">
            <?php $__empty_1 = true; $__currentLoopData = $alur; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="relative group">
                <span class="absolute -left-[29px] top-0 w-6 h-6 rounded-full <?php echo e($item->aktif ? 'bg-primary' : 'bg-slate-300'); ?> border-4 border-white shadow flex items-center justify-center text-white text-xs font-bold z-10">
                    <?php echo e($item->nomor); ?>

                </span>
                <div class="flex items-start justify-between">
                    <div>
                        <h3 class="font-bold text-slate-800 <?php echo e($item->aktif ? '' : 'line-through text-slate-400'); ?>"><?php echo e($item->judul); ?></h3>
                        <p class="text-slate-600 text-sm mt-1 <?php echo e($item->aktif ? '' : 'text-slate-400'); ?>"><?php echo e($item->deskripsi); ?></p>
                    </div>
                    <div class="flex gap-2">
                        <button onclick="editAlur(<?php echo e($item->id); ?>, '<?php echo e($item->nomor); ?>', '<?php echo e(addslashes($item->judul)); ?>', '<?php echo e(addslashes($item->deskripsi)); ?>', <?php echo e($item->aktif ? 1 : 0); ?>)" class="btn-icon btn-icon-edit" title="Edit">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                            </svg>
                        </button>
                        <form action="<?php echo e(route('admin.spmb.alur.destroy', $item)); ?>" method="POST" class="inline" onsubmit="return confirm('Hapus tahapan ini?')">
                            <?php echo csrf_field(); ?>
        ...
        <div class="overflow-x-auto">
            <table class="data-table">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $alur; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td class="text-center font-bold"><?php echo e($item->nomor); ?></td>
                        <td class="font-medium"><?php echo e($item->judul); ?></td>
                        <td class="text-sm text-slate-600 max-w-xs truncate"><?php echo e($item->deskripsi); ?></td>
                        <td>
                        ...
                        <td>
                            <div class="flex gap-1">
                                <button onclick="editAlur(<?php echo e($item->id); ?>, '<?php echo e($item->nomor); ?>', '<?php echo e(addslashes($item->judul)); ?>', '<?php echo e(addslashes($item->deskripsi)); ?>', <?php echo e($item->aktif ? 1 : 0); ?>)" class="btn-icon btn-icon-sm btn-icon-edit">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                                    </svg>
                                </button>
...
<div id="modal-tambah" class="hidden fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
    <div class="bg-white rounded-xl shadow-xl max-w-lg w-full max-h-[90vh] overflow-y-auto">
        ...
        <form action="<?php echo e(route('admin.spmb.alur.store')); ?>" method="POST" class="p-6 space-y-4">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\eka\.gemini\antigravity\scratch\smk-alstar\resources\views\admin\spmb\alur\index.blade.php ENDPATH**/ ?>