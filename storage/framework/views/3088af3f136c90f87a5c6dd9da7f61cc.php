...
<div class="max-w-4xl mx-auto">
    <div class="mb-8">
        <h1 class="text-2xl font-bold text-gray-900">Edit Visi & Misi</h1>
        <p class="text-gray-600">Kelola visi dan misi sekolah yang ditampilkan ke publik.</p>
    </div>
    ...
    <form action="<?php echo e(route('admin.profil-sekolah.update-visi-misi')); ?>" method="POST" class="space-y-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div class="p-6">
                <textarea id="visi" name="visi" rows="3" required
                    class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-primary focus:border-primary transition"><?php echo e(old('visi', $profil->visi)); ?></textarea>
            </div>
        </div>
        ...
        <div class="flex justify-end gap-4">
            <a href="<?php echo e(url('/profil')); ?>#visi-misi" target="_blank" class="px-6 py-3 border border-gray-300 text-gray-700 rounded-xl font-semibold hover:bg-gray-50 transition">
                Lihat Halaman
            </a>
