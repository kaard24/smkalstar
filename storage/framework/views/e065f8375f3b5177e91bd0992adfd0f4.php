...
<?php $__env->startSection('title', 'Verifikasi Pembayaran - Admin'); ?>
...
<div class="p-6">
        ...
        <div class="bg-white rounded-xl border border-slate-200 p-4">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xl font-bold text-slate-800"><?php echo e($stats['total']); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl border border-slate-200 p-4">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xl font-bold text-amber-600"><?php echo e($stats['pending']); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl border border-slate-200 p-4">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xl font-bold text-emerald-600"><?php echo e($stats['verified']); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl border border-slate-200 p-4">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xl font-bold text-red-600"><?php echo e($stats['rejected']); ?></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl border border-slate-200 p-4 mb-6">
        <form action="<?php echo e(route('admin.pembayaran.index')); ?>" method="GET" class="flex flex-wrap items-end gap-4">
            ...
            <div class="flex gap-2">
                ...
                <a href="<?php echo e(route('admin.pembayaran.index')); ?>" class="px-4 py-2 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-lg font-medium transition-colors">
                    Reset
                </a>
            </div>
        </form>
    ...
    <div class="bg-white rounded-xl border border-slate-200 overflow-hidden">
        <div class="overflow-x-auto">
            <table class="w-full">
                ...
                <tbody class="divide-y divide-slate-200">
                    <?php $__empty_1 = true; $__currentLoopData = $pembayaranList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $pembayaran): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-slate-50">
                        <td class="px-4 py-3 text-sm text-slate-600"><?php echo e($pembayaranList->firstItem() + $index); ?></td>
                        <td class="px-4 py-3 text-sm font-medium text-slate-800"><?php echo e($pembayaran->calonSiswa->nisn); ?></td>
                        <td class="px-4 py-3 text-sm text-slate-800"><?php echo e($pembayaran->calonSiswa->nama); ?></td>
                        <td class="px-4 py-3 text-sm text-slate-600"><?php echo e($pembayaran->calonSiswa->pendaftaran?->jurusan?->nama ?? '-'); ?></td>
                        <td class="px-4 py-3 text-sm font-medium text-slate-800"><?php echo e($pembayaran->jumlah_formatted); ?></td>
                        <td class="px-4 py-3">
                            <?php
                                $statusColors = [
                            ...
                            ?>
                            <span class="inline-flex px-2 py-1 text-xs font-medium rounded-full <?php echo e($statusColors[$pembayaran->status]); ?>">
                                <?php echo e($pembayaran->status_label); ?>

                            </span>
                        </td>
                        <td class="px-4 py-3 text-sm text-slate-600"><?php echo e($pembayaran->created_at->format('d M Y H:i')); ?></td>
                        <td class="px-4 py-3">
                            <div class="flex items-center gap-2">
                                <a href="<?php echo e(route('admin.pembayaran.show', $pembayaran)); ?>" 
                                    class="px-3 py-1.5 bg-blue-100 hover:bg-blue-200 text-blue-700 rounded-lg text-sm font-medium transition-colors">
                                    Detail
                                </a>
                                
                                <?php if($pembayaran->isPending()): ?>
                                <form action="<?php echo e(route('admin.pembayaran.verify', $pembayaran)); ?>" method="POST" class="inline">
                                    <?php echo csrf_field(); ?>
        ...
        <!-- Pagination -->
        <?php if($pembayaranList->hasPages()): ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\eka\.gemini\antigravity\scratch\smk-alstar\resources\views\admin\pembayaran\index.blade.php ENDPATH**/ ?>