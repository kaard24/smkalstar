...
<?php $__env->startSection('content'); ?>
    ...
    <div class="mb-4">
        <a href="<?php echo e(route('admin.pendaftar.index')); ?>" class="inline-flex items-center gap-1.5 text-sm text-slate-500 hover:text-[#4276A3] transition">
                    ...
                    <div class="space-y-3">
                        ...
                        <div>
                            ...
                            <textarea name="nilai_minat_bakat" rows="3"
                                   ...
                                   class="w-full px-3 py-2 text-sm border border-slate-300 rounded-md focus:outline-none focus:border-[#4276A3] focus:ring-1 focus:ring-[#4276A3]"><?php echo e(old('nilai_minat_bakat', $siswa->pendaftaran?->tes?->nilai_minat_bakat)); ?></textarea>
