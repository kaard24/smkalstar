                ...
                <div class="card p-4">
                    ...
                    <div id="form-orang-tua" class="space-y-3">
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            ...
                            <div>
                                <label class="block text-xs font-medium text-slate-600 mb-1">Pekerjaan <span class="text-[#991B1B]">*</span></label>
            ...
            <div class="card p-4">
                ...
                <div class="space-y-3">
                    <?php $__currentLoopData = $berkasList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        ?>
                        <div class="p-3 border rounded-lg <?php echo e($hasFile ? 'border-[#4276A3]/20 bg-blue-50' : 'border-slate-200 bg-slate-50'); ?>">
                            <div class="flex items-center justify-between mb-2">
                                <span class="text-xs font-medium <?php echo e($hasFile ? 'text-blue-800' : 'text-slate-600'); ?>"><?php echo e($label); ?></span>
                                <?php if($hasFile): ?>
                ...
                <div class="mt-4 pt-4 border-t border-slate-100">
                    <div class="flex items-center justify-between mb-2">
                        ...
                        <span class="text-xs font-semibold <?php echo e($progress['is_complete'] ? 'text-[#4276A3]' : 'text-slate-600'); ?>"><?php echo e($progress['uploaded']); ?>/<?php echo e($progress['total']); ?></span>
                    </div>
                    <div class="w-full bg-slate-200 rounded-full h-2">
                        <div class="bg-primary h-2 rounded-full transition-all" style="width: <?php echo e($progress['percentage']); ?>%"></div>
                    </div>
                </div>
            </div>
        </div>
